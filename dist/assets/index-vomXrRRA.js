const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-tosq9C12.js","assets/react-vendor-DTkXckhQ.js","assets/icons-vKdVo13Z.js","assets/VoteWidget-DYVBshn_.js","assets/WhatsNew-m7KttjXe.js","assets/DiffPage-Dg_MA39R.js","assets/LiquidGlassShowcase-DtqxVB7O.js","assets/PrintSheet-Cm0ZLn5Z.js","assets/RolePage-CellgX4b.js","assets/FavStar-CtZZEen8.js","assets/LawPage-BBsnKZGd.js","assets/purify.es-DnfDK_hS.js","assets/VuPage-C_Gc-B2s.js","assets/HomePage-D-2dfWQu.js","assets/ForumPage-C55IloMx.js","assets/forumStore-CpozitpQ.js","assets/forumRemote-dOcLfMe-.js","assets/ForumSubnav-CcojcipK.js","assets/ForumSearch-BFeQ0Fti.js","assets/ProfilePage-Buf7op25.js","assets/ForumMembers-BrK6oaGW.js","assets/SectionPage-D-Ud4XJN.js","assets/MarkdownEditor-SHeMhw1S.js","assets/TopicPage2-CdFUYgCz.js","assets/ReactionBar-C2qbkfkr.js","assets/seo-CUoHaANs.js","assets/TagPage-DWQQjXw6.js","assets/QuestionsPage-DP-0ei2i.js","assets/AdminPanel3-BSHjUF49.js","assets/SettingsPage-B16hl-Jy.js","assets/FavoritesPage-DLioVVZZ.js","assets/ForumFeedsPage-CWj15PHd.js"])))=>i.map(i=>d[i]);
import{r as Q,a as kt,u as St,L as _,R as u,b as se,B as Nt,c as Et,d as y}from"./react-vendor-DTkXckhQ.js";import{A as _t,E as It,I as pe,Q as zt,B as Z,S as fe,U as ge,a as be,X as Ce,b as xe,c as ye,L as Te,M as Se,F as Pt,d as At,C as Lt,e as Rt,f as Mt,g as Ct}from"./icons-vKdVo13Z.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();var Oe={exports:{}},re={};/**
 * @license React
...
![Территория красной зоны воинской части](${L}img/red-zone.png)
Территория КПП-1
![Территория КПП-1](${L}img/cpp.png)
Территория КПП-2
![Территория КПП-2](${L}img/cpp2.png)
...
![Территория военного грузового поезда](${L}img/poezd.jpg)
...
Служебные территории:
Правительство
![Правительство2](${L}img/pravo2.png)
![Правительство](${L}img/pravo.png)
...
`,Xt=[{id:"gov",title:"Внутренний устав Правительства",text:Ht,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],De="ui:density",Fe="ui:font",Qt="ui:features",Be="ui:shadow",Ve="ui:radius",Ue="ui:glass",qe="ui:readw",Ke="ui:anim";function T(e){try{return typeof window<"u"?window.localStorage.getItem(e):null}catch{return null}}function B(e,n){try{typeof window<"u"&&window.localStorage.setItem(e,n)}catch{}}function Zt(e){document.documentElement.style.setProperty("--density",e==="compact"?"0.85":"1"),B(De,e)}function en(){return T(De)==="compact"?"compact":"standard"}function tn(e){const n=Math.max(.9,Math.min(1.3,e)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),B(Fe,String(n))}function nn(){const e=T(Fe),n=parseFloat(e||"1");return isFinite(n)&&n>.6&&n<2?n:1}function sn(e,n=!0){const s=rn();return e in s?!!s[e]:n}function rn(){try{const e=T(Qt);return e?JSON.parse(e):{}}catch{return{}}}function an(e){let n="none";e==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),e==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),B(Be,e)}function on(){const e=T(Be);return e==="none"||e==="soft"||e==="strong"?e:"soft"}function cn(e){let n=8,s=16,r=20;e==="subtle"&&(n=6,s=10,r=14),e==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),B(Ve,e)}function ln(){const e=T(Ve);return e==="subtle"||e==="rounded"?e:"standard"}function dn(e){const n=Math.max(0,Math.min(16,Math.round(e)));document.documentElement.style.setProperty("--glass-blur",n+"px"),B(Ue,String(n))}function un(){const e=T(Ue),n=parseInt(e||"6",10);return isFinite(n)?n:6}function mn(e){const n=Math.max(60,Math.min(96,Math.round(e)));document.documentElement.style.setProperty("--reading-w",n+"ch"),B(qe,String(n))}function pn(){const e=T(qe),n=parseInt(e||"78",10);return isFinite(n)?n:78}function hn(){try{Zt(en()),tn(nn()),an(on()),cn(ln()),dn(un()),mn(pn()),fn(gn())}catch{}}function fn(e){document.documentElement.classList.toggle("anim-off",!e),B(Ke,e?"1":"0")}function gn(){try{return T(Ke)!=="0"}catch{return!0}}const We={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},S={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function Ge(...e){return e.filter(Boolean).join(" ")}function Ye(){const[e,n]=u.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return u.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),e}function Je(e,n){u.useEffect(()=>{const s=e.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,a=72,i=18;const o=()=>{r=0;const m=e.current;m&&(m.style.setProperty("--lg-x",`${a}%`),m.style.setProperty("--lg-y",`${i}%`))},c=m=>{const b=e.current;if(!b)return;const f=b.getBoundingClientRect(),I=(m.clientX-f.left)/f.width*100,N=(m.clientY-f.top)/f.height*100;a=Math.max(0,Math.min(100,I)),i=Math.max(0,Math.min(100,N)),r||(r=window.requestAnimationFrame(o))},l=()=>{a=72,i=18,r||(r=window.requestAnimationFrame(o))};return s.addEventListener("pointermove",c,{passive:!0}),s.addEventListener("pointerdown",c,{passive:!0}),s.addEventListener("pointerenter",c,{passive:!0}),s.addEventListener("pointerleave",l),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",c),s.removeEventListener("pointerdown",c),s.removeEventListener("pointerenter",c),s.removeEventListener("pointerleave",l)}},[e,n])}function Ie(e){if(!e)return[255,255,255];const n=e.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function X(e){return`${e[0]} ${e[1]} ${e[2]}`}function le(e,n,s){return Math.round(e+(n-e)*s)}function ze(e,n){return[le(e[0],n>=0?255:0,Math.abs(n)),le(e[1],n>=0?255:0,Math.abs(n)),le(e[2],n>=0?255:0,Math.abs(n))]}function bn(e,n,s){const r=e?We[e]:n??S.tint,a=s??S.accent,i=Ie(r),o=Ie(a),c=ze(o,.25),l=ze(o,-.55);return{tintRgb:X(i),accentRgb:X(o),accentSoftRgb:X(c),accentDeepRgb:X(l)}}function He(e,n){const s={...e??{}},{tintRgb:r,accentRgb:a,accentSoftRgb:i,accentDeepRgb:o}=bn(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=a,s["--lg-accent-soft"]=i,s["--lg-accent-deep"]=o,s}const Xe=u.forwardRef((e,n)=>{const{blur:s=S.blur,tint:r=S.tint,opacity:a=S.opacity,gloss:i=S.gloss,border:o=S.border,glints:c=S.glints,interactive:l=S.interactive,animate:m=S.animate,elevation:b=S.elevation,tone:f,accent:I=S.accent,className:N,style:M,children:P,...A}=e,h=Ye(),k=l&&!h,d=u.useRef(null),x=u.useCallback(g=>{d.current=g,typeof n=="function"?n(g):n&&(n.current=g),g&&(g.style.setProperty("--lg-x","72%"),g.style.setProperty("--lg-y","18%"))},[n]);Je(d,k);const E=u.useMemo(()=>He(M,{blur:s,tint:r,opacity:a,gloss:i,border:o,elevation:b,glints:c,tone:f,accent:I}),[M,s,r,a,i,o,b,c,f,I]),p={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*b}px ${50*b}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return t.jsxs("div",{ref:x,className:Ge("liquid-glass",N),"data-animate":m?"true":"false","data-interactive":k?"true":"false",style:{...p,...E},...A,children:[t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),c&&t.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[t.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),t.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),k&&t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),t.jsx("div",{style:{position:"relative",zIndex:10},children:P}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:o,pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Xe.displayName="LiquidGlass";const Qe=u.forwardRef((e,n)=>{const{className:s,style:r,children:a,type:i,blur:o,tint:c,opacity:l,gloss:m,border:b,glints:f,interactive:I,animate:N,elevation:M,tone:P,accent:A=S.accent,...h}=e,k=o??S.blur,d=P?We[P]:c??S.tint,x=l??.16,E=m??.9,p=b??.6,g=f??!1,je=I??!0,V=M??1,$=Ye(),z=je&&!$,D=u.useRef(null),ie=u.useCallback(j=>{D.current=j,typeof n=="function"?n(j):n&&(n.current=j),j&&(j.style.setProperty("--lg-x","70%"),j.style.setProperty("--lg-y","16%"))},[n]);Je(D,z);const C=u.useMemo(()=>He(r,{blur:k,tint:d,opacity:x,gloss:E,border:p,glints:g,elevation:V,tone:P,accent:A}),[r,k,d,x,E,p,g,V,P,A]),J={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*V}px ${18*V}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return t.jsxs("button",{ref:ie,type:i??"button",className:Ge("liquid-glass liquid-glass__button",s),style:{...J,...C},...h,onMouseDown:j=>{j.currentTarget.style.transform="scale(0.985)"},onMouseUp:j=>{j.currentTarget.style.transform=""},onMouseLeave:j=>{j.currentTarget.style.transform=""},children:[t.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[t.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),t.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),t.jsx("span",{style:{position:"relative",zIndex:1},children:a}),t.jsx("style",{children:`
      ...
      `})]})});Qe.displayName="LiquidGlass.Button";const ae=Xe;ae.Button=Qe;const Ze="theme",et="accent",tt="accent_custom",nt="bg",xn="bg_custom",st="ui:style-mode",de="ui:liquid:prev-theme",rt="ui:liquid:tone";function O(e){try{return typeof window<"u"?window.localStorage.getItem(e):null}catch{return null}}function F(e,n){try{typeof window<"u"&&window.localStorage.setItem(e,n)}catch{}}function yn(e){try{typeof window<"u"&&window.localStorage.removeItem(e)}catch{}}const at={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var Re,Me;const ue=((Me=(Re=import.meta)==null?void 0:Re.env)==null?void 0:Me.BASE_URL)??"/",W=e=>{const n=e.replace(/^\/+/,"");return(ue.endsWith("/")?ue:ue+"/")+n},ot={bg1:W("img/bg1.png"),bg2:W("img/bg2.png"),bg3:W("img/bg3.png"),bg4:W("img/bg4.png"),bg5:W("img/bg5.png")};function it(){const e=O(Ze);return e==="light"||e==="dark"?e:null}function vn(){const e=O(et);return e?e==="custom"?"custom":e in at?e:null:null}function wn(){return O(tt)}function ct(){const e=O(nt);return e&&(e==="none"||e==="custom"||e in ot)?e:null}function jn(){return O(xn)}function lt(){const e=O(st);return e==="classic"||e==="liquid"?e:null}function kn(){return(O(rt)||"dark")==="light"?"light":"dark"}function Sn(e){F(rt,e);const n=document.documentElement;if(n.classList.toggle("liquid-light",e==="light"),n.classList.toggle("liquid-dark",e!=="light"),n.classList.contains("theme-liquid"))try{ve(e==="light"?"light":"dark")}catch{}}function dt(e){const n=document.documentElement;if(n.classList.toggle("theme-liquid",e==="liquid"),n.dataset.styleMode=e,e==="liquid"){try{const s=it()??(ut()?"dark":"light");F(de,s);const r=kn();Sn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=O(de);(s==="light"||s==="dark")&&ve(s),yn(de)}catch{}try{const s=ct()??"none";pt(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:e}))}catch{}F(st,e)}function ut(){try{return typeof window<"u"&&!!window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}catch{return!1}}function ve(e){const n=document.documentElement;e==="dark"?n.classList.add("dark"):n.classList.remove("dark"),F(Ze,e);const s=e==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function mt(e){if(e==="custom"){const n=wn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=En(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=at[e];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}F(et,e)}function ps(e){F(tt,ht(e)),mt("custom")}function pt(e){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(e==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(e==="custom"){const a=jn();a?(n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const a=ot[e];n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}F(nt,e)}function Nn(){const n=it()??(ut()?"dark":"light");ve(n);const s=vn()??"indigo";mt(s);const r=ct()??"none";pt(r);const a=lt()??"classic";dt(a)}function ht(e){let n=e.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],a=n[3];n=`#${s}${s}${r}${r}${a}${a}`}return n}function En(e,n){const s=ht(e).slice(1),r=parseInt(s,16);let a=r>>16&255,i=r>>8&255,o=r&255;a=Math.max(0,Math.min(255,Math.round(a+255*n))),i=Math.max(0,Math.min(255,Math.round(i+255*n))),o=Math.max(0,Math.min(255,Math.round(o+255*n)));const c=l=>l.toString(16).padStart(2,"0");return`#${c(a)}${c(i)}${c(o)}`}function Pe(){if(typeof document<"u"){const e=document.documentElement.dataset.styleMode;if(e==="classic"||e==="liquid")return e}try{return lt()??"classic"}catch{return"classic"}}function oe(){const[e,n]=u.useState(()=>Pe());u.useEffect(()=>{const r=()=>{const o=Pe();n(c=>c===o?c:o)},a=o=>{const c=o.detail;c==="classic"||c==="liquid"?n(c):r()};window.addEventListener("stylemodechange",a);const i=new MutationObserver(r);return i.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",a),i.disconnect()}},[]);const s=u.useCallback(r=>{dt(r),n(r)},[]);return[e,s]}function R(e){return`${"/".replace(/\/$/,"")}${e}`}function _n(){if(!sn("cmd_palette",!0))return null;const[n]=oe(),[s,r]=u.useState(!1),[a,i]=u.useState(""),[o,c]=u.useState(0),[l,m]=u.useState(()=>localStorage.getItem("cp_filter")||"all");u.useEffect(()=>{try{localStorage.setItem("cp_filter",l)}catch{}},[l]);const[b,f]=u.useState(null);u.useEffect(()=>{(async()=>{try{const E=(await(await v(()=>import("./forumRemote-dOcLfMe-.js"),[])).listSections()).find(p=>String(p.title||"").toLowerCase()==="workshop");f((E==null?void 0:E.id)||null)}catch{}})()},[]);const N=u.useMemo(()=>{const d=[];d.push({kind:"page",id:"forum",title:"�����",subtitle:"���������",url:R("/forum")}),d.push({kind:"page",id:"favorites",title:"���������",subtitle:"��������",url:R("/favorites")}),d.push({kind:"page",id:"settings",title:"���������",subtitle:"��������",url:R("/settings")});for(const p of Jt)d.push({kind:"role",id:p.id,title:p.role,subtitle:"������",url:R(`/roles/${p.id}`)});for(const p of _e)d.push({kind:"law",id:p.slug,title:p.title,subtitle:"�����",url:R(`/laws/${p.slug}`)});for(const p of Xt)d.push({kind:"vu",id:p.id,title:p.title,subtitle:"��",url:R(`/vu/${p.id}`)});const x=a.trim().toLowerCase();return x&&d.push(...P(x).slice(0,60)),x?(l==="all"?d:d.filter(p=>p.kind===l)).map(p=>({r:p,score:M(`${p.title} ${p.subtitle||""}`.toLowerCase(),x)+(p.__boost||0)})).filter(p=>p.score>0).sort((p,g)=>g.score-p.score).slice(0,30).map(p=>p.r):d.slice(0,20)},[a,l]);function M(d,x){return x.split(/\s+/).filter(Boolean).reduce((p,g)=>p+(d.includes(g)?1:0),0)}function P(d){const x=[],E=g=>g.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const g of _e){const V=(g.content||"").replace(/\r\n?/g,`
`).split(`
`);let $="",z="";const D=new Set;for(const ie of V){const C=ie.trim(),J=/^(#{2,6})\s*(.+)$/.exec(C);if(J){$=J[2].trim(),z=E($)||"";const j=$.toLowerCase();if(z&&j.includes(d)){const q=`${g.slug}#${z}`;if(!D.has(q)){const H={kind:"law",id:q,title:`${g.title} � ${$}`,subtitle:"���������",url:R(`/laws/${g.slug}?q=${encodeURIComponent(d)}#${z}`)};H.__boost=j.startsWith(d)?8:6,x.push(H),D.add(q)}}continue}if(C&&C.toLowerCase().includes(d)){const j=z?`${g.slug}#${z}`:g.slug;if(!D.has(j)){const q=C.length>140?C.slice(0,137)+"�":C,H=z?`${g.title} � ${$}`:g.title,jt=R(z?`/laws/${g.slug}?q=${encodeURIComponent(d)}#${z}`:`/laws/${g.slug}?q=${encodeURIComponent(d)}`),ke={kind:"law",id:j,title:H,subtitle:q||"��������",url:jt};ke.__boost=5,x.push(ke),D.add(j)}}}}const p=new Set;return x.filter(g=>p.has(g.id)?!1:(p.add(g.id),!0))}function A(d){r(!1);try{window.location.href=d}catch{location.assign(d)}}function h(d){N.length&&(d.key==="ArrowDown"&&(d.preventDefault(),c(x=>Math.min(x+1,N.length-1))),d.key==="ArrowUp"&&(d.preventDefault(),c(x=>Math.max(x-1,0))),d.key==="Enter"&&(d.preventDefault(),A(N[o].url)))}const k=({children:d})=>n==="liquid"?t.jsx(ae,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:d}):t.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:d});return t.jsx(t.Fragment,{children:s?t.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"�����",children:t.jsxs(k,{children:[t.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[t.jsx(be,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),t.jsx("input",{autoFocus:!0,value:a,onChange:d=>{i(d.target.value),c(0)},onKeyDown:h,placeholder:"�����: �����, ����, ��...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),t.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"�������",children:t.jsx(Ce,{className:"h-4 w-4"})})]}),t.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"���"},{k:"role",label:"����"},{k:"law",label:"������"},{k:"vu",label:"��"}].map(d=>t.jsx("button",{onClick:()=>{m(d.k),c(0)},className:`chip ${l===d.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:d.label},d.k))}),t.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!N.length&&t.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"������ �� �������"}),N.map((d,x)=>t.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${x===o?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>c(x),onClick:()=>A(d.url),children:[t.jsxs("span",{className:"inline-flex items-center gap-2",children:[d.kind==="law"&&t.jsx(Z,{className:"h-4 w-4"}),d.kind==="role"&&t.jsx(ge,{className:"h-4 w-4"}),d.kind==="vu"&&t.jsx(fe,{className:"h-4 w-4"}),d.kind==="page"&&(d.id==="settings"?t.jsx(xe,{className:"h-4 w-4"}):t.jsx(ye,{className:"h-4 w-4"})),t.jsx("span",{className:"font-medium",children:d.title})]}),d.subtitle&&t.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:d.subtitle})]},`${d.kind}:${d.id}`))]})]})}):null})}const U={},In=(U==null?void 0:U.VITE_API_BASE)||(U==null?void 0:U.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function zn(){try{const e="anon_uid";let n=localStorage.getItem(e);return n||(n=crypto.randomUUID(),localStorage.setItem(e,n)),n}catch{return"na"}}function Pn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:zn()}}function An(e,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:e,...Pn(),data:n}),r=`${In}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,a))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const me={};function Ln(){try{const n=new URL(window.location.href),s=n.searchParams.get("api");if(s){localStorage.setItem("forum:api_base",s);try{n.searchParams.delete("api"),history.replaceState({},"",n.toString())}catch{}}const r=localStorage.getItem("forum:api_base");if(r)return r}catch{}const e=me==null?void 0:me.VITE_API_BASE;return e||""}const Rn=Ln(),Y="forum:token",ee="forum:session";function ft(e,n=!0){(n?localStorage:sessionStorage).setItem(Y,e)}function gt(){return localStorage.getItem(Y)??sessionStorage.getItem(Y)}function te(){try{localStorage.removeItem(Y),sessionStorage.removeItem(Y),localStorage.removeItem(ee),sessionStorage.removeItem(ee)}finally{window.dispatchEvent(new Event("forum:session"))}}function we(e){try{const n={until:e||null,setAt:new Date().toISOString()};localStorage.setItem("forum:ban_lock",JSON.stringify(n))}catch{}}async function w(e,n={}){const s=gt(),r={"Content-Type":"application/json",...n.headers||{}};s&&(r.Authorization=`Bearer ${s}`);const a=await fetch(`${Rn}${e}`,{...n,headers:r}),i=await a.text();let o={};try{o=i?JSON.parse(i):{}}catch{o={error:i||a.statusText}}if(!a.ok){try{(a.status===401||a.status===403)&&(typeof(o==null?void 0:o.error)=="string"&&/ban/i.test(o.error)&&we(null),te())}catch{}throw new Error((o==null?void 0:o.error)||`${a.status} ${a.statusText}`)}return o}async function hs(e){const n=JSON.stringify({username:e.username,email:e.email,password:e.password||"1234",inviteCode:e.inviteCode||"",captchaToken:e.captchaToken||void 0}),{token:s,user:r}=await w("/register",{method:"POST",body:n});ft(s,e.remember!==!1);const a={userId:r.id,remember:e.remember!==!1,lastLogin:new Date().toISOString()};localStorage.setItem(ee,JSON.stringify(a)),window.dispatchEvent(new Event("forum:session"));const i=r;try{if(i!=null&&i.bannedUntil&&new Date(i.bannedUntil).getTime()>Date.now())throw we(i.bannedUntil),te(),new Error("banned")}catch{}return i}async function fs(e){const n=JSON.stringify({usernameOrEmail:e.usernameOrEmail,password:e.password||"1234",otp:e.otp||void 0,captchaToken:e.captchaToken||void 0}),{token:s,user:r}=await w("/login",{method:"POST",body:n});ft(s,e.remember!==!1);const a={userId:r.id,remember:e.remember!==!1,lastLogin:new Date().toISOString()};return localStorage.setItem(ee,JSON.stringify(a)),window.dispatchEvent(new Event("forum:session")),r}async function Mn(){if(!gt())return null;try{const{user:n}=await w("/me"),s=n;return s!=null&&s.bannedUntil&&new Date(s.bannedUntil).getTime()>Date.now()?(we(s.bannedUntil),te(),null):s}catch{return te(),null}}async function gs(){const{users:e}=await w("/users");return e}async function bs(e,n){const{user:s}=await w(`/users/${e}/role`,{method:"PATCH",body:JSON.stringify({role:n})});return s}async function xs(){const{invites:e}=await w("/invites");return e}async function ys(e=5,n){const{invites:s}=await w("/invites",{method:"POST",body:JSON.stringify({count:e,note:n})});return s}async function vs(e,n){const s=JSON.stringify(n?{until:n}:{days:7}),{user:r}=await w("/users/"+encodeURIComponent(e)+"/ban",{method:"POST",body:s});return r}async function ws(e){const{user:n}=await w("/users/"+encodeURIComponent(e)+"/unban",{method:"POST"});return n}async function js(e,n){const s=JSON.stringify(n?{until:n}:{minutes:60}),{user:r}=await w("/users/"+encodeURIComponent(e)+"/mute",{method:"POST",body:s});return r}async function ks(e){const{user:n}=await w("/users/"+encodeURIComponent(e)+"/unmute",{method:"POST"});return n}async function Ss(e){await w(`/invites/${encodeURIComponent(e)}`,{method:"DELETE"})}async function Ns(){const{settings:e}=await w("/settings");return e}async function Es(e){const{settings:n}=await w("/settings",{method:"PATCH",body:JSON.stringify(e)});return n}async function _s(e){try{const n=await w(`/profiles/by-username/${encodeURIComponent(e)}`);return{user:n.user,profile:n.profile||null,stats:n.stats||null}}catch{return null}}async function Is(e){const{profile:n}=await w("/profiles/me",{method:"PATCH",body:JSON.stringify(e)});return n}async function zs(e){try{const{profile:n}=await w(`/profiles/${encodeURIComponent(e)}`);return n}catch{return null}}async function Ps(e,n){const s={labels:Array.isArray(n)?n:[]},{profile:r}=await w(`/profiles/${encodeURIComponent(e)}/labels`,{method:"PATCH",body:JSON.stringify(s)});return r}async function As(e,n=30){const{user:s}=await w(`/users/${encodeURIComponent(e)}/vip`,{method:"POST",body:JSON.stringify({days:n})});return s}async function Ls(e){const{user:n}=await w(`/users/${encodeURIComponent(e)}/unvip`,{method:"POST"});return n}async function Rs(){const{members:e}=await w("/members");return e}const bt="forum:lastActive:";function Cn(e){try{localStorage.setItem(bt+e,new Date().toISOString())}catch{}}function Ms(e){try{return localStorage.getItem(bt+e)}catch{return null}}function Cs(e){if(!e)return"";const n=new Date(e);if(Number.isNaN(n.getTime()))return"";try{const s=new Intl.RelativeTimeFormat("ru",{numeric:"auto"}),r=n.getTime()-Date.now(),a=1e3,i=60*a,o=60*i,c=24*o,l=30*c,m=365*c;return Math.abs(r)<i?s.format(Math.round(r/a),"second"):Math.abs(r)<o?s.format(Math.round(r/i),"minute"):Math.abs(r)<c?s.format(Math.round(r/o),"hour"):Math.abs(r)<l?s.format(Math.round(r/c),"day"):Math.abs(r)<m?s.format(Math.round(r/l),"month"):s.format(Math.round(r/m),"year")}catch{return n.toLocaleString()}}const Ae="recent:items";function Tn(e,n){try{const s=localStorage.getItem(Ae),r=s?JSON.parse(s):[],a={url:e,title:n,ts:Date.now()};if(r.length&&r[0].url===e)return;const i=r.filter(l=>l.url!==e);i.unshift(a);const o=[],c=new Set;for(const l of i)c.has(l.url)||(c.add(l.url),o.push(l));for(;o.length>15;)o.pop();localStorage.setItem(Ae,JSON.stringify(o))}catch{}}const ne="forum:session";function Ts(){try{const e=sessionStorage.getItem(ne)??localStorage.getItem(ne);return e?JSON.parse(e):null}catch{return null}}function xt(){const e=()=>{try{const r=sessionStorage.getItem(ne)??localStorage.getItem(ne);return r?JSON.parse(r):null}catch{return null}},[n,s]=Q.useState(e());return Q.useEffect(()=>{const r=()=>s(e());return window.addEventListener("storage",r),window.addEventListener("forum:session",r),window.addEventListener("forum:changed",r),()=>{window.removeEventListener("storage",r),window.removeEventListener("forum:session",r),window.removeEventListener("forum:changed",r)}},[]),n}const yt=[{key:"forum",type:"route",label:"Форум",icon:t.jsx(Se,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:t.jsx(ge,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:t.jsx(Pt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:t.jsx(At,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:t.jsx(Lt,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:t.jsx(Se,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:t.jsx(Rt,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:t.jsx(Z,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:t.jsx(fe,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:t.jsx(Z,{className:"h-4 w-4"}),id:"laws"}];function On(){const[e,n]=u.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=se(),[r]=oe(),i=!xt(),o=u.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),c=u.useMemo(()=>{const k=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),d=(s.hash||"").replace(/^#/,"").toLowerCase();return k||d||""},[s.search,s.hash]),l=u.useCallback(h=>c===h,[c]);u.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&e){const k=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=k}}},[e]),u.useEffect(()=>{function h(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",h),()=>window.removeEventListener("resize",h)},[]),u.useEffect(()=>{const h=document.documentElement;e?h.classList.add("has-sidebar"):h.classList.remove("has-sidebar")},[e]);const m=u.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),b=m?"⌘ K":"Ctrl K",f=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",I=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",N=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",M=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",P=h=>{const k=`?tab=${encodeURIComponent(h)}`;return o?{pathname:"/",search:k}:{pathname:"/",search:k,hash:`#${h}`}},A=t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"mb-4 flex items-center justify-start",children:t.jsx(_,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),t.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:t.jsxs("ul",{className:"flex flex-col gap-1",children:[yt.map(h=>{const k=h.type==="route"?s.pathname===h.to:l(h.id),d=h.type==="route"?h.to:P(h.id);return t.jsx("li",{children:t.jsxs(_,{to:d,className:[f,k?I:""].filter(Boolean).join(" "),"aria-current":k?"page":void 0,"aria-label":h.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[h.icon,t.jsx("span",{className:"truncate",children:h.label}),h.key==="forum"&&i&&t.jsx(Te,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},h.key)}),t.jsx("li",{children:t.jsxs(_,{to:"/about",className:f,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[t.jsx(pe,{className:"h-4 w-4"}),t.jsx("span",{className:"truncate",children:"О нас"})]})})]})}),t.jsxs("div",{className:N,children:["Подсказка: нажмите ",t.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:b}),", чтобы открыть быстрый поиск"]})]});return t.jsxs(t.Fragment,{children:[t.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(h=>!h),"aria-label":"Меню","aria-expanded":e,"aria-controls":"app-sidebar",children:"Меню"}),t.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:M,children:r==="liquid"?t.jsx(ae,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:A}):A})]})}const $n={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},vt={entities:$n};function Dn(e){var s;return((s=vt.entities)==null?void 0:s[e])||null}function Os(e,n=30){const s=Dn(e);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function $s(e,n){const s=e.split(/\r?\n/),r=n.split(/\r?\n/),a=s.length,i=r.length,o=Array.from({length:a+1},()=>Array(i+1).fill(0));for(let b=a-1;b>=0;b--)for(let f=i-1;f>=0;f--)o[b][f]=s[b]===r[f]?o[b+1][f+1]+1:Math.max(o[b+1][f],o[b][f+1]);const c=[];let l=0,m=0;for(;l<a&&m<i;)s[l]===r[m]?(c.push(G(s[l])),l++,m++):o[l+1][m]>=o[l][m+1]?(c.push(`<del>${G(s[l])}</del>`),l++):(c.push(`<ins>${G(r[m])}</ins>`),m++);for(;l<a;)c.push(`<del>${G(s[l++])}</del>`);for(;m<i;)c.push(`<ins>${G(r[m++])}</ins>`);return c.join(`
`)}function G(e){return e.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function Fn(){var s;const e=[],n=vt.entities||{};for(const[r,a]of Object.entries(n)){const i=(s=a.changelog)==null?void 0:s[0];i&&e.push({id:r,version:i.version,date:i.date,summary:i.summary,details:i.details})}return e.sort((r,a)=>r.date<a.date?1:-1),e}function Bn(){const[e]=oe(),n=se(),s=u.useMemo(()=>{try{const c=Fn()[0];if(!c)return!1;const l=new Date(c.date+"T00:00:00Z");return(Date.now()-l.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const c=window.openCommandPalette;if(typeof c=="function")try{c();return}catch{}const l=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!l,metaKey:l}))}const a="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",i=e==="liquid"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",o=t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[t.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var c;return(c=window.openMobileMenu)==null?void 0:c.call(window)},"aria-label":"Меню",children:t.jsx(Mt,{className:"h-4 w-4"})}),t.jsx(Ct,{className:"h-6 w-6 shrink-0"}),t.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),t.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[t.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[t.jsx(be,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),t.jsxs(_,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[t.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&t.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),t.jsxs(_,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[t.jsx(ye,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),t.jsxs(_,{to:"/settings",className:"btn","aria-label":"Настройки",children:[t.jsx(xe,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]})]})]});return n.pathname.startsWith("/forum")?null:t.jsx("div",{className:i,children:e==="liquid"?t.jsx(ae,{className:`${a} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:o}):t.jsx("div",{className:a,children:o})})}function Vn(){const[e,n]=u.useState(!1),s=se(),a=!xt();u.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),u.useEffect(()=>{if(!e)return;const l=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=l}},[e]);const i=u.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),o=l=>{const m=new URLSearchParams(s.search||"");m.set("tab",l);const b=`?${m.toString()}`;return i?{pathname:"/",search:b}:{pathname:"/",search:b,hash:`#${l}`}};function c(){const l=window.openCommandPalette;if(typeof l=="function")try{l()}catch{}n(!1)}return e?t.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[t.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),t.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[t.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[t.jsxs("button",{className:"btn btn-secondary",onClick:c,"aria-label":"РџРѕРёСЃРє",children:[t.jsx(be,{className:"h-4 w-4"})," ",t.jsx("span",{children:"РџРѕРёСЃРє"})]}),t.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),t.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:t.jsx(Ce,{className:"h-4 w-4"})})]}),t.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[t.jsx("ul",{className:"grid gap-2",children:yt.map(l=>{const m=l.type==="route"?l.to:o(l.id);return t.jsx("li",{children:t.jsxs(_,{to:m,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[l.icon,t.jsx("span",{className:"truncate",children:l.label}),l.key==="forum"&&a&&t.jsx(Te,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},l.key)})}),t.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[t.jsxs(_,{to:"/favorites",className:"btn btn-secondary",children:[t.jsx(ye,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),t.jsxs(_,{to:"/settings",className:"btn btn-secondary",children:[t.jsx(xe,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}function Un(){const[e,n]=u.useState(()=>{try{return localStorage.getItem("site:closure_notice_v1")!=="1"}catch{return!0}});return u.useEffect(()=>{if(!e)return;const s=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=s}},[e]),e?t.jsxs("div",{className:"fixed inset-0 z-[120] flex items-start justify-center p-4",children:[t.jsx("div",{className:"absolute inset-0 bg-black/10 backdrop-blur-[2px]","aria-hidden":!0}),t.jsxs("div",{className:"relative z-10 w-[min(720px,96vw)] rounded-2xl border border-white/10 bg-white/80 p-5 text-zinc-900 shadow-xl dark:border-zinc-800 dark:bg-zinc-900/85 dark:text-zinc-100",children:[t.jsx("div",{className:"mb-2 text-xs uppercase tracking-[0.28em] text-zinc-500 dark:text-zinc-400",children:"Важное объявление"}),t.jsx("h2",{className:"mb-2 text-2xl font-bold",children:"Проект закрыт"}),t.jsx("p",{className:"mb-3 text-sm opacity-90",children:"Разработка и поддержка проекта прекращены. Форум остаётся открытым для всех желающих: можно читать и участвовать в обсуждениях в рамках действующих правил."}),t.jsxs("ul",{className:"mb-4 ml-4 list-disc text-sm opacity-90",children:[t.jsx("li",{children:"Если вы готовы продолжить и дорабатывать форум — напишите Екатерине."}),t.jsx("li",{children:"Автор больше не имеет отношения к проекту; на сайте остаётся только одно упоминание его ника."})]}),t.jsx("div",{className:"flex flex-wrap gap-2",children:t.jsx("button",{type:"button",className:"btn btn-primary",onClick:()=>{try{localStorage.setItem("site:closure_notice_v1","1")}catch{}n(!1)},children:"Понятно"})})]})]}):null}const qn=u.lazy(()=>v(()=>import("./GovCheatsheetSky-tosq9C12.js"),__vite__mapDeps([0,1,2,3]))),Kn=u.lazy(()=>v(()=>import("./WhatsNew-m7KttjXe.js"),__vite__mapDeps([4,2,1]))),Wn=u.lazy(()=>v(()=>import("./DiffPage-Dg_MA39R.js"),__vite__mapDeps([5,1,2]))),Gn=u.lazy(()=>v(()=>import("./LiquidGlassShowcase-DtqxVB7O.js"),__vite__mapDeps([6,1,2]))),Yn=u.lazy(()=>v(()=>import("./PrintSheet-Cm0ZLn5Z.js"),__vite__mapDeps([7,1,2]))),Jn=u.lazy(()=>v(()=>import("./RolePage-CellgX4b.js"),__vite__mapDeps([8,1,3,2,9]))),Hn=u.lazy(()=>v(()=>import("./LawPage-BBsnKZGd.js"),__vite__mapDeps([10,1,9,2,11]))),Xn=u.lazy(()=>v(()=>import("./VuPage-C_Gc-B2s.js"),__vite__mapDeps([12,1,2]))),Qn=u.lazy(()=>v(()=>import("./HomePage-D-2dfWQu.js"),__vite__mapDeps([13,1,2]))),Zn=u.lazy(()=>v(()=>import("./ForumPage-C55IloMx.js"),__vite__mapDeps([14,1,15,16,17,2,18]))),Le=u.lazy(()=>v(()=>import("./ProfilePage-Buf7op25.js"),__vite__mapDeps([19,1,15,2]))),es=u.lazy(()=>v(()=>import("./ForumMembers-BrK6oaGW.js"),__vite__mapDeps([20,1,17,16,2,15]))),ts=u.lazy(()=>v(()=>import("./SectionPage-D-Ud4XJN.js"),__vite__mapDeps([21,1,16,17,2,22,11,9]))),ns=u.lazy(()=>v(()=>import("./TopicPage2-CdFUYgCz.js"),__vite__mapDeps([23,1,16,22,11,2,24,25]))),ss=u.lazy(()=>v(()=>import("./TagPage-DWQQjXw6.js"),__vite__mapDeps([26,1,16,17,2]))),rs=u.lazy(()=>v(()=>import("./QuestionsPage-DP-0ei2i.js"),__vite__mapDeps([27,1,16,22,11,2,24]))),as=u.lazy(()=>v(()=>import("./AdminPanel3-BSHjUF49.js"),__vite__mapDeps([28,1,16,2]))),os=u.lazy(()=>v(()=>import("./SettingsPage-B16hl-Jy.js"),__vite__mapDeps([29,1,2]))),is=u.lazy(()=>v(()=>import("./FavoritesPage-DLioVVZZ.js"),__vite__mapDeps([30,1,9,2])));function cs(){const e=se();return Q.useEffect(()=>{An("page_view");try{Tn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}(async()=>{try{const n=await Mn();n&&Cn(n.id)}catch{}})()},[e.pathname,e.search,e.hash]),null}function ls(){const[e]=oe();return t.jsxs("div",{className:"min-h-dvh w-full",children:[e==="liquid"&&t.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[t.jsx("div",{className:"absolute inset-0",style:{background:"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),t.jsx("div",{className:"absolute inset-0",style:{opacity:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),t.jsxs(Nt,{basename:"/",children:[t.jsx(_n,{}),t.jsx(On,{}),t.jsx(Bn,{}),t.jsx(Vn,{}),t.jsx(Un,{}),t.jsx(cs,{}),t.jsx(u.Suspense,{fallback:t.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Р—Р°РіСЂСѓР·РєР°вЂ¦"}),children:t.jsxs(Et,{children:[t.jsx(y,{path:"/",element:t.jsx(qn,{})}),t.jsx(y,{path:"/home",element:t.jsx(Qn,{})}),t.jsx(y,{path:"/forum/*",element:t.jsx(Zn,{})}),t.jsx(y,{path:"/forum/section/:id",element:t.jsx(ts,{})}),t.jsx(y,{path:"/forum/topic/:id",element:t.jsx(ns,{})}),t.jsx(y,{path:"/forum/questions",element:t.jsx(rs,{})}),t.jsx(y,{path:"/forum/members",element:t.jsx(es,{})}),t.jsx(y,{path:"/forum/profile/:username",element:t.jsx(Le,{})}),t.jsx(y,{path:"/u/:username",element:t.jsx(Le,{})}),t.jsx(y,{path:"/forum/tag/:tag",element:t.jsx(ss,{})}),t.jsx(y,{path:"/forum/admin",element:t.jsx(as,{})}),t.jsx(y,{path:"/whats-new",element:t.jsx(Kn,{})}),t.jsx(y,{path:"/diff/:id",element:t.jsx(Wn,{})}),t.jsx(y,{path:"/print",element:t.jsx(Yn,{})}),t.jsx(y,{path:"/roles/:id",element:t.jsx(Jn,{})}),t.jsx(y,{path:"/laws/:slug",element:t.jsx(Hn,{})}),t.jsx(y,{path:"/vu/:id",element:t.jsx(Xn,{})}),t.jsx(y,{path:"/recorders/:id",element:t.jsx(Wt,{})}),t.jsx(y,{path:"/about",element:t.jsx(Yt,{})}),t.jsx(y,{path:"/style/liquid",element:t.jsx(Gn,{})}),t.jsx(y,{path:"/settings",element:t.jsx(os,{})}),t.jsx(y,{path:"/favorites",element:t.jsx(is,{})}),t.jsx(y,{path:"/forum/feeds",element:t.jsx(ds,{})})]})})]})]})}const ds=u.lazy(()=>v(()=>import("./ForumFeedsPage-CWj15PHd.js"),__vite__mapDeps([31,1,17,16,2,18,25])));(function(){try{const n="app:version",s=localStorage.getItem(n),r="1760817542655";if(s&&s!==r){"caches"in window?caches.keys().then(a=>Promise.all(a.map(i=>caches.delete(i)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();Nn();hn();function wt(){const e=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${e}px`)}wt();window.addEventListener("resize",wt,{passive:!0});he.createRoot(document.getElementById("root")).render(t.jsx(u.StrictMode,{children:t.jsx(ls,{})}));export{Zt as $,As as A,Ls as B,Gt as C,ys as D,Ss as E,js as F,ks as G,vs as H,ws as I,vn as J,lt as K,ae as L,en as M,nn as N,on as O,ln as P,un as Q,gn as R,kn as S,at as T,ve as U,ut as V,dt as W,fn as X,Sn as Y,mt as Z,ps as _,Jt as a,an as a0,cn as a1,tn as a2,dn as a3,Mn as b,_s as c,$s as d,te as e,fs as f,Dn as g,hs as h,Os as i,t as j,Rs as k,_e as l,Cs as m,Is as n,Ms as o,Ts as p,gs as q,qt as r,xs as s,zs as t,oe as u,Xt as v,Ns as w,Es as x,bs as y,Ps as z};
