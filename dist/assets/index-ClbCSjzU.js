const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-uKe1wqrE.js","assets/react-vendor-DplbGVpw.js","assets/icons-BSwHFIJz.js","assets/VoteWidget-DIdbCGRe.js","assets/ContextText-DqVbPvO2.js","assets/WhatsNew-B-izOvMc.js","assets/DiffPage-3NJrc5Jd.js","assets/PrintSheet-CWH_Ojqb.js","assets/RolePage-DlagEECf.js","assets/FavStar-4bf3_FFk.js","assets/LawPage-Bzj7c6Yv.js","assets/VuPage-D9kE_5bk.js","assets/SettingsPage-DV_SDP_z.js","assets/FavoritesPage-Bk9tKjLi.js"])))=>i.map(i=>d[i]);
import{r as J,a as ze,R as m,u as q,L as R,B as Se,b as Ie,c as y}from"./react-vendor-DplbGVpw.js";import{S as Z,X as Ee,B,U as Q,a as ee,b as te,c as ne,F as Ne,L as _e,C as Ce,M as se,d as Ae,e as $e}from"./icons-BSwHFIJz.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const i of c.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerPolicy&&(c.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?c.credentials="include":a.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(a){if(a.ep)return;a.ep=!0;const c=o(a);fetch(a.href,c)}})();var oe={exports:{}},T={};/**
 * @license React
...
`,Ve=[{id:"gov",title:"Внутренний устав Правительства",text:Me,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
наказывается выговором`}],re="ui:density",ie="ui:font",Ue="ui:features",ce="ui:shadow",le="ui:radius",de="ui:glass",ue="ui:readw";function Ye(e){document.documentElement.style.setProperty("--density",e==="compact"?"0.85":"1"),localStorage.setItem(re,e)}function We(){return localStorage.getItem(re)==="compact"?"compact":"standard"}function Ge(e){const t=Math.max(.9,Math.min(1.3,e)),o=16*t;document.documentElement.style.setProperty("--font-size",`${o}px`),localStorage.setItem(ie,String(t))}function He(){const e=parseFloat(localStorage.getItem(ie)||"1");return isFinite(e)&&e>.6&&e<2?e:1}function Xe(e,t=!0){const o=Je();return e in o?!!o[e]:t}function Je(){try{const e=localStorage.getItem(Ue);return e?JSON.parse(e):{}}catch{return{}}}function qe(e){let t="none";e==="soft"&&(t="0 10px 30px -12px rgba(0,0,0,0.25)"),e==="strong"&&(t="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",t),localStorage.setItem(ce,e)}function Ze(){const e=localStorage.getItem(ce);return e==="none"||e==="soft"||e==="strong"?e:"soft"}function Qe(e){let t=8,o=16,s=20;e==="subtle"&&(t=6,o=10,s=14),e==="rounded"&&(t=12,o=18,s=24),document.documentElement.style.setProperty("--radius-lg",t+"px"),document.documentElement.style.setProperty("--radius-2xl",o+"px"),document.documentElement.style.setProperty("--radius-3xl",s+"px"),localStorage.setItem(le,e)}function et(){const e=localStorage.getItem(le);return e==="subtle"||e==="rounded"?e:"standard"}function tt(e){const t=Math.max(0,Math.min(16,Math.round(e)));document.documentElement.style.setProperty("--glass-blur",t+"px"),localStorage.setItem(de,String(t))}function nt(){const e=parseInt(localStorage.getItem(de)||"6",10);return isFinite(e)?e:6}function st(e){const t=Math.max(60,Math.min(96,Math.round(e)));document.documentElement.style.setProperty("--reading-w",t+"ch"),localStorage.setItem(ue,String(t))}function ot(){const e=parseInt(localStorage.getItem(ue)||"78",10);return isFinite(e)?e:78}function at(){try{Ye(We()),Ge(He()),qe(Ze()),Qe(et()),tt(nt()),st(ot())}catch{}}function k(e){return`${"/".replace(/\/$/,"")}${e}`}function rt(){if(!Xe("cmd_palette",!0))return null;const[t,o]=m.useState(!1),[s,a]=m.useState(""),[c,i]=m.useState(0),[d,l]=m.useState(()=>localStorage.getItem("cp_filter")||"all");m.useEffect(()=>{try{localStorage.setItem("cp_filter",d)}catch{}},[d]),m.useEffect(()=>{function r(p){(p.ctrlKey||p.metaKey)&&p.key.toLowerCase()==="k"&&(p.preventDefault(),o(!0),a(""),i(0)),t&&p.key==="Escape"&&o(!1)}return window.addEventListener("keydown",r),window.openCommandPalette=()=>{o(!0),a(""),i(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",r)}},[t]);const g=m.useMemo(()=>{const r=[];r.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Сервис",url:k("/favorites")}),r.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Сервис",url:k("/settings")});for(const u of Ke)r.push({kind:"role",id:u.id,title:u.role,subtitle:"Роль",url:k(`/roles/${u.id}`)});for(const u of G)r.push({kind:"law",id:u.slug,title:u.title,subtitle:"Закон",url:k(`/laws/${u.slug}`)});for(const u of Ve)r.push({kind:"vu",id:u.id,title:u.title,subtitle:"ВУ",url:k(`/vu/${u.id}`)});const p=s.trim().toLowerCase();return p&&r.push(...z(p).slice(0,60)),p?(d==="all"?r:r.filter(u=>u.kind===d)).map(u=>({r:u,score:h(`${u.title} ${u.subtitle||""}`.toLowerCase(),p)+(u.__boost||0)})).filter(u=>u.score>0).sort((u,I)=>I.score-u.score).slice(0,30).map(u=>u.r):r.slice(0,20)},[s,d]);function h(r,p){return p.split(/\s+/).filter(Boolean).reduce((u,I)=>u+(r.includes(I)?1:0),0)}function z(r){const p=[],P=b=>b.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80),u=(()=>{const b=r.match(/\bст(атья|\.)?\s*(\d{1,3})\b/i);return b?b[2]:null})();for(const b of G){const ke=(b.content||"").replace(/\r\n?/g,`
`).split(`
`);let C="",x="";const D=new Set;for(const je of ke){const E=je.trim(),M=/^(#{2,6})\s*(.+)$/.exec(E);if(M){C=M[2].trim(),x=P(C)||"";const j=C.toLowerCase();if(x&&(j.includes(r)||u&&j.match(new RegExp(`(^|s)ст(атья|.)?s*${u}\b`)))){const A=`${b.slug}#${x}`;if(!D.has(A)){const L={kind:"law",id:A,title:`${b.title} — ${C}`,subtitle:"Раздел закона",url:k(`/laws/${b.slug}?q=${encodeURIComponent(r)}#${x}`)};L.__boost=j.startsWith(r)?8:6,p.push(L),D.add(A)}}continue}if(E&&E.toLowerCase().includes(r)){const j=x?`${b.slug}#${x}`:b.slug;if(!D.has(j)){const V=E.length>140?E.slice(0,137)+"…":E,A=x?`${b.title} — ${C}`:b.title,L=k(x?`/laws/${b.slug}?q=${encodeURIComponent(r)}#${x}`:`/laws/${b.slug}?q=${encodeURIComponent(r)}`),U={kind:"law",id:j,title:A,subtitle:V||"Совпадение в тексте",url:L};U.__boost=5,p.push(U),D.add(j)}}}}const I=new Set;return p.filter(b=>I.has(b.id)?!1:(I.add(b.id),!0))}function S(r){o(!1);try{window.location.href=r}catch{location.assign(r)}}function _(r){g.length&&(r.key==="ArrowDown"&&(r.preventDefault(),i(p=>Math.min(p+1,g.length-1))),r.key==="ArrowUp"&&(r.preventDefault(),i(p=>Math.max(p-1,0))),r.key==="Enter"&&(r.preventDefault(),S(g[c].url)))}return n.jsx(n.Fragment,{children:t?n.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Палитра команд",children:n.jsxs("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:[n.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[n.jsx(Z,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),n.jsx("input",{autoFocus:!0,value:s,onChange:r=>{a(r.target.value),i(0)},onKeyDown:_,placeholder:"Роль, закон, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),n.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>o(!1),"aria-label":"Закрыть палитру",children:n.jsx(Ee,{className:"h-4 w-4"})})]}),n.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(r=>n.jsx("button",{onClick:()=>{l(r.k),i(0)},className:`chip ${d===r.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:r.label},r.k))}),n.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!g.length&&n.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),g.map((r,p)=>n.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${p===c?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>i(p),onClick:()=>S(r.url),children:[n.jsxs("span",{className:"inline-flex items-center gap-2",children:[r.kind==="law"&&n.jsx(B,{className:"h-4 w-4"}),r.kind==="role"&&n.jsx(Q,{className:"h-4 w-4"}),r.kind==="vu"&&n.jsx(ee,{className:"h-4 w-4"}),r.kind==="page"&&(r.id==="settings"?n.jsx(te,{className:"h-4 w-4"}):n.jsx(ne,{className:"h-4 w-4"})),n.jsx("span",{className:"font-medium",children:r.title})]}),r.subtitle&&n.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:r.subtitle})]},`${r.kind}:${r.id}`))]})]})}):null})}const N={},it=(N==null?void 0:N.VITE_API_BASE)||(N==null?void 0:N.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function ct(){try{const e="anon_uid";let t=localStorage.getItem(e);return t||(t=crypto.randomUUID(),localStorage.setItem(e,t)),t}catch{return"na"}}function lt(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:ct()}}function dt(e,t){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const o=JSON.stringify({event:e,...lt(),data:t}),s=`${it}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([o],{type:"application/json"});if(navigator.sendBeacon(s,a))return}catch{}try{fetch(s,{method:"POST",headers:{"content-type":"application/json"},body:o})}catch{}}const H="recent:items";function ut(e,t){try{const o=localStorage.getItem(H),s=o?JSON.parse(o):[],a={url:e,title:t,ts:Date.now()};if(s.length&&s[0].url===e)return;const c=s.filter(l=>l.url!==e);c.unshift(a);const i=[],d=new Set;for(const l of c)d.has(l.url)||(d.add(l.url),i.push(l));for(;i.length>15;)i.pop();localStorage.setItem(H,JSON.stringify(i))}catch{}}function w(e){return`${"/".replace(/\/$/,"")}${e}`}const mt=[{label:"Роли",icon:n.jsx(Q,{className:"h-4 w-4"}),to:w("/#roles")},{label:"Доклады",icon:n.jsx(Ne,{className:"h-4 w-4"}),to:w("/#reports")},{label:"Посты",icon:n.jsx(_e,{className:"h-4 w-4"}),to:w("/#posts")},{label:"Процедуры",icon:n.jsx(Ce,{className:"h-4 w-4"}),to:w("/#procedures")},{label:"Взаимодействие",icon:n.jsx(se,{className:"h-4 w-4"}),to:w("/#interactions")},{label:"Лекции",icon:n.jsx(B,{className:"h-4 w-4"}),to:w("/#lectures")},{label:"ВУ",icon:n.jsx(ee,{className:"h-4 w-4"}),to:w("/#vu")},{label:"Законы",icon:n.jsx(B,{className:"h-4 w-4"}),to:w("/#laws")}];function pt(){const[e,t]=m.useState(()=>window.innerWidth>=1024),o=q();return m.useEffect(()=>{function s(){t(window.innerWidth>=1024)}return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[]),m.useEffect(()=>{const s=document.documentElement;e?s.classList.add("has-sidebar"):s.classList.remove("has-sidebar")},[e]),n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>t(s=>!s),"aria-label":"\\u041E\\u0442\\u043A\\u0440\\u044B\\u0442\\u044C \\u043C\\u0435\\u043D\\u044E",children:"\\u041C\\u0435\\u043D\\u044E"}),n.jsxs("aside",{"aria-label":"\\u041D\\u0430\\u0432\\u0438\\u0433\\u0430\\u0446\\u0438\\u044F",className:`app-sidebar fixed inset-y-0 left-0 z-40 w-[240px] transform border-r border-zinc-200 bg-white/80 px-3 py-4 text-sm shadow-sm backdrop-blur transition-transform duration-200 ease-out dark:border-zinc-800 dark:bg-zinc-900/70 ${e?"translate-x-0":"-translate-x-full lg:translate-x-0"}`,children:[n.jsxs("div",{className:"mb-3 flex items-center justify-between",children:[n.jsx(R,{to:w("/"),className:"font-semibold no-underline hover:underline",children:"\\u0413\\u043B\\u0430\\u0432\\u043D\\u0430\\u044F"}),n.jsx("span",{className:"hidden rounded border border-zinc-300 px-1.5 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300 lg:inline",children:navigator.platform.includes("Mac")?"Cmd K":"Ctrl K"})]}),n.jsx("nav",{className:"grid gap-1",children:mt.map(s=>{const a=(o.hash||"").toLowerCase()===(s.to.replace(/^.*#/,"#")||"").toLowerCase();return n.jsxs("a",{href:s.to,className:`flex items-center gap-2 rounded-lg px-2 py-1.5 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800 ${a?"bg-zinc-100 dark:bg-zinc-800":""}`,onClick:c=>{try{c.preventDefault();const i=(s.to||"").replace(/^.*#/,"#")||"#";location.hash!==i?location.hash=i.replace(/^#/,""):window.dispatchEvent(new HashChangeEvent("hashchange"))}catch{}window.innerWidth<1024&&t(!1)},children:[s.icon,n.jsx("span",{children:s.label})]},s.label)})}),n.jsx("div",{className:"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",children:"Р СњР В°Р В¶Р СР С‘РЎвЂљР Вµ Ctrl + K Р Т‘Р В»РЎРЏ Р С—Р С•Р С‘РЎРѓР С”Р В°"})]})]})}const ht={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},me={entities:ht};function gt(e){var o;return((o=me.entities)==null?void 0:o[e])||null}function Vt(e,t=30){const o=gt(e);if(!(o!=null&&o.updated_at))return{recent:!1};const s=new Date(o.updated_at+"T00:00:00Z");return{recent:(Date.now()-s.getTime())/(1e3*60*60*24)<=t,date:o.updated_at}}function Ut(e,t){const o=e.split(/\r?\n/),s=t.split(/\r?\n/),a=o.length,c=s.length,i=Array.from({length:a+1},()=>Array(c+1).fill(0));for(let g=a-1;g>=0;g--)for(let h=c-1;h>=0;h--)i[g][h]=o[g]===s[h]?i[g+1][h+1]+1:Math.max(i[g+1][h],i[g][h+1]);const d=[];let l=0,f=0;for(;l<a&&f<c;)o[l]===s[f]?(d.push($(o[l])),l++,f++):i[l+1][f]>=i[l][f+1]?(d.push(`<del>${$(o[l])}</del>`),l++):(d.push(`<ins>${$(s[f])}</ins>`),f++);for(;l<a;)d.push(`<del>${$(o[l++])}</del>`);for(;f<c;)d.push(`<ins>${$(s[f++])}</ins>`);return d.join(`
`)}function $(e){return e.replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}function ft(){var o;const e=[],t=me.entities||{};for(const[s,a]of Object.entries(t)){const c=(o=a.changelog)==null?void 0:o[0];c&&e.push({id:s,version:c.version,date:c.date,summary:c.summary,details:c.details})}return e.sort((s,a)=>s.date<a.date?1:-1),e}function bt(){const e=m.useMemo(()=>{try{const o=ft()[0];if(!o)return!1;const s=new Date(o.date+"T00:00:00Z");return(Date.now()-s.getTime())/864e5<=14}catch{return!1}},[]);function t(){const o=window.openCommandPalette;if(typeof o=="function")try{o();return}catch{}const s=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!s,metaKey:s}))}return n.jsx("div",{className:"sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",children:n.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-1 sm:gap-3 px-4 py-3",children:[n.jsxs("div",{className:"flex items-center gap-3",children:[n.jsx(Ae,{className:"h-6 w-6"}),n.jsx("div",{className:"text-base sm:text-lg font-bold truncate leading-tight",children:"Правительство — Памятка (SKY)"})]}),n.jsxs("div",{className:"flex items-center gap-1 sm:gap-2",children:[n.jsxs("button",{className:"btn btn-secondary",onClick:t,children:[n.jsx(Z,{className:"h-4 w-4"})," Поиск"]}),n.jsxs(R,{to:"/whats-new",className:"btn",children:["Что нового",e&&n.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),n.jsxs(R,{to:"/favorites",className:"btn",children:[n.jsx(ne,{className:"h-4 w-4"})," Избранное"]}),n.jsxs(R,{to:"/settings",className:"btn",children:[n.jsx(te,{className:"h-4 w-4"})," Настройки"]}),n.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn",children:[n.jsx(se,{className:"h-4 w-4"})," Фидбек"]})]})]})})}const O={},xt=(O==null?void 0:O.VITE_NOTIF_URL)||void 0||"/api/notifications",X="notif:lastSeen";function yt(){const[e,t]=m.useState(!1),[o,s]=m.useState([]),[a,c]=m.useState(0);async function i(){try{const l=await fetch(xt,{cache:"no-store"});if(!l.ok)return;const f=await l.json(),g=Array.isArray(f)?f:f.items||[];g.sort((_,r)=>new Date(r.date||0).getTime()-new Date(_.date||0).getTime()),s(g);const h=localStorage.getItem(X)||"",z=h?g.findIndex(_=>_.id===h):-1,S=z===-1?g.length:z;c(Math.max(0,S))}catch{}}m.useEffect(()=>{i()},[]);function d(){if(t(l=>!l),!e&&o.length)try{localStorage.setItem(X,o[0].id),c(0)}catch{}}return n.jsxs("div",{className:"relative",children:[n.jsxs("button",{className:"btn btn-secondary relative",onClick:d,"aria-label":"Уведомления",children:[n.jsx($e,{className:"h-4 w-4"}),a>0&&n.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),e&&n.jsxs("div",{className:"absolute right-0 mt-2 w-80 rounded-2xl border border-zinc-200 bg-white p-2 text-sm shadow-soft dark:border-zinc-700 dark:bg-zinc-900",children:[n.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),o.length?n.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:o.map(l=>n.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:n.jsxs("a",{className:"block",href:l.url||"#",target:l.url?"_blank":void 0,rel:l.url?"noreferrer":void 0,children:[l.title&&n.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:l.title}),n.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:l.text}),l.date&&n.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:new Date(l.date).toLocaleString()})]})},l.id))}):n.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}const wt=m.lazy(()=>v(()=>import("./GovCheatsheetSky-uKe1wqrE.js"),__vite__mapDeps([0,1,2,3,4]))),vt=m.lazy(()=>v(()=>import("./WhatsNew-B-izOvMc.js"),__vite__mapDeps([5,1,2]))),kt=m.lazy(()=>v(()=>import("./DiffPage-3NJrc5Jd.js"),__vite__mapDeps([6,1,2]))),jt=m.lazy(()=>v(()=>import("./PrintSheet-CWH_Ojqb.js"),__vite__mapDeps([7,1,2]))),zt=m.lazy(()=>v(()=>import("./RolePage-DlagEECf.js"),__vite__mapDeps([8,1,3,2,9,4]))),St=m.lazy(()=>v(()=>import("./LawPage-Bzj7c6Yv.js"),__vite__mapDeps([10,1,9,2,4]))),It=m.lazy(()=>v(()=>import("./VuPage-D9kE_5bk.js"),__vite__mapDeps([11,1,4,2]))),Et=m.lazy(()=>v(()=>import("./SettingsPage-DV_SDP_z.js"),__vite__mapDeps([12,1,2]))),Nt=m.lazy(()=>v(()=>import("./FavoritesPage-Bk9tKjLi.js"),__vite__mapDeps([13,1,9,2,4])));function _t(){const e=q();return J.useEffect(()=>{dt("page_view");try{ut(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[e.pathname,e.search,e.hash]),null}function Ct(){return n.jsxs(Se,{basename:"/",children:[n.jsx(rt,{}),n.jsx(pt,{}),n.jsx(bt,{}),n.jsx("div",{className:"fixed right-2 top-2 z-50",children:n.jsx(yt,{})}),n.jsx(_t,{}),n.jsx(m.Suspense,{fallback:n.jsx("div",{className:"p-4 text-sm text-zinc-500",children:"Загрузка…"}),children:n.jsxs(Ie,{children:[n.jsx(y,{path:"/",element:n.jsx(wt,{})}),n.jsx(y,{path:"/whats-new",element:n.jsx(vt,{})}),n.jsx(y,{path:"/diff/:id",element:n.jsx(kt,{})}),n.jsx(y,{path:"/print",element:n.jsx(jt,{})}),n.jsx(y,{path:"/roles/:id",element:n.jsx(zt,{})}),n.jsx(y,{path:"/laws/:slug",element:n.jsx(St,{})}),n.jsx(y,{path:"/vu/:id",element:n.jsx(It,{})}),n.jsx(y,{path:"/settings",element:n.jsx(Et,{})}),n.jsx(y,{path:"/favorites",element:n.jsx(Nt,{})})]})})]})}const pe="theme",he="accent",ge="accent_custom",K="bg",fe="bg_custom",be={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}},xe={bg1:"img/bg1.png",bg2:"img/bg2.png",bg3:"img/bg3.png"};function At(){const e=localStorage.getItem(pe);return e==="light"||e==="dark"?e:null}function $t(){const e=localStorage.getItem(he);return e?e==="custom"?"custom":e in be?e:null:null}function Pt(){return localStorage.getItem(ge)}function Dt(){const e=localStorage.getItem(K);return e&&(e==="none"||e==="custom"||e in xe)?e:null}function Lt(){return localStorage.getItem(fe)}function Rt(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function Tt(e){const t=document.documentElement;e==="dark"?t.classList.add("dark"):t.classList.remove("dark"),localStorage.setItem(pe,e);const o=e==="dark"?"#0a0a0a":"#fafafa";let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.head.appendChild(s)),s.setAttribute("content",o);try{t.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function ye(e){if(e==="custom"){const t=Pt()||"#6366F1";document.documentElement.style.setProperty("--accent",t);const o=Bt(t,-.15);document.documentElement.style.setProperty("--accent-600",o)}else{const t=be[e];document.documentElement.style.setProperty("--accent",t[500]),document.documentElement.style.setProperty("--accent-600",t[600])}localStorage.setItem(he,e)}function Yt(e){localStorage.setItem(ge,ve(e)),ye("custom")}function we(e){const t=document.body;if(document.documentElement.classList.contains("dark")){t.style.backgroundImage="",t.style.backgroundSize="",t.style.backgroundRepeat="",t.style.backgroundAttachment="",t.style.backgroundPosition="",localStorage.setItem(K,e);return}if(e==="none")t.style.backgroundImage="",t.style.backgroundSize="",t.style.backgroundRepeat="",t.style.backgroundAttachment="",t.style.backgroundPosition="";else if(e==="custom"){const s=Lt();s?(t.style.backgroundImage=`url(${s})`,t.style.backgroundSize="cover",t.style.backgroundRepeat="no-repeat",t.style.backgroundAttachment="fixed",t.style.backgroundPosition="center"):t.style.backgroundImage=""}else{const s=`/${xe[e]}`;t.style.backgroundImage=`url(${s})`,t.style.backgroundSize="cover",t.style.backgroundRepeat="no-repeat",t.style.backgroundAttachment="fixed",t.style.backgroundPosition="center"}localStorage.setItem(K,e)}function Wt(e){localStorage.setItem(fe,e),we("custom")}function Ot(){const t=At()??(Rt()?"dark":"light");Tt(t);const o=$t()??"indigo";ye(o);const s=Dt()??"none";we(s)}function ve(e){let t=e.trim();if(t.startsWith("#")||(t=`#${t}`),t.length===4){const o=t[1],s=t[2],a=t[3];t=`#${o}${o}${s}${s}${a}${a}`}return t}function Bt(e,t){const o=ve(e).slice(1),s=parseInt(o,16);let a=s>>16&255,c=s>>8&255,i=s&255;a=Math.max(0,Math.min(255,Math.round(a+255*t))),c=Math.max(0,Math.min(255,Math.round(c+255*t))),i=Math.max(0,Math.min(255,Math.round(i+255*t)));const d=l=>l.toString(16).padStart(2,"0");return`#${d(a)}${d(c)}${d(i)}`}Ot();at();F.createRoot(document.getElementById("root")).render(n.jsx(m.StrictMode,{children:n.jsx(Ct,{})}));export{gt as a,$t as b,We as c,Ut as d,He as e,Xe as f,ft as g,Ze as h,Vt as i,n as j,et as k,G as l,nt as m,ot as n,Tt as o,Ye as p,qe as q,Ke as r,Rt as s,Qe as t,Yt as u,Ve as v,we as w,Wt as x,ye as y};
