const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-D3M4KRql.js","assets/react-vendor-DTkXckhQ.js","assets/icons-BPBp9R4S.js","assets/VoteWidget-DnR_Zsv8.js","assets/asset-DcY8ABMN.js","assets/WhatsNew-D6wi8qwF.js","assets/DiffPage-dfPfPUkX.js","assets/LiquidGlassShowcase-DGijY1f1.js","assets/PrintSheet-TD-hwg8c.js","assets/RolePage-Df_8hPZ6.js","assets/FavStar-BXxg1jM6.js","assets/LawPage-BT3kYhmM.js","assets/VuPage-DWZVLKLY.js","assets/SettingsPage-DKKS-l-U.js","assets/FavoritesPage-DJJLGnGO.js"])))=>i.map(i=>d[i]);
import{r as pe,a as He,u as Xe,L as N,R as u,b as Q,B as Je,c as Qe,d as k}from"./react-vendor-DTkXckhQ.js";import{A as Ze,E as et,I as xe,C as tt,Q as st,R as nt,B as q,S as Z,H as rt,U as ee,a as te,X as fe,b as se,c as ne,F as at,L as it,d as ot,M as ge,e as lt,f as ct,g as dt,h as ut}from"./icons-BPBp9R4S.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function n(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(a){if(a.ep)return;a.ep=!0;const l=n(a);fetch(a.href,l)}})();var be={exports:{}},W={};/**
 * @license React
...
![Территория красной зоны воинской части](${_}img/red-zone.png)
Территория КПП-1
![Территория КПП-1](${_}img/cpp.png)
Территория КПП-2
![Территория КПП-2](${_}img/cpp2.png)
...
![Территория военного грузового поезда](${_}img/poezd.jpg)
...
Служебные территории:
Правительство
![Правительство2](${_}img/pravo2.png)
![Правительство](${_}img/pravo.png)
...
`,Et=[{id:"gov",title:"Внутренний устав Правительства",text:St,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],je="ui:density",we="ui:font",It="ui:features",ve="ui:shadow",ke="ui:radius",Ne="ui:glass",ze="ui:readw";function _t(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),localStorage.setItem(je,t)}function Pt(){return localStorage.getItem(je)==="compact"?"compact":"standard"}function At(t){const s=Math.max(.9,Math.min(1.3,t)),n=16*s;document.documentElement.style.setProperty("--font-size",`${n}px`),localStorage.setItem(we,String(s))}function Ct(){const t=parseFloat(localStorage.getItem(we)||"1");return isFinite(t)&&t>.6&&t<2?t:1}function Lt(t,s=!0){const n=Mt();return t in n?!!n[t]:s}function Mt(){try{const t=localStorage.getItem(It);return t?JSON.parse(t):{}}catch{return{}}}function Rt(t){let s="none";t==="soft"&&(s="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(s="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",s),localStorage.setItem(ve,t)}function $t(){const t=localStorage.getItem(ve);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function Ft(t){let s=8,n=16,r=20;t==="subtle"&&(s=6,n=10,r=14),t==="rounded"&&(s=12,n=18,r=24),document.documentElement.style.setProperty("--radius-lg",s+"px"),document.documentElement.style.setProperty("--radius-2xl",n+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),localStorage.setItem(ke,t)}function Dt(){const t=localStorage.getItem(ke);return t==="subtle"||t==="rounded"?t:"standard"}function Tt(t){const s=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",s+"px"),localStorage.setItem(Ne,String(s))}function Bt(){const t=parseInt(localStorage.getItem(Ne)||"6",10);return isFinite(t)?t:6}function Ot(t){const s=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",s+"ch"),localStorage.setItem(ze,String(s))}function Kt(){const t=parseInt(localStorage.getItem(ze)||"78",10);return isFinite(t)?t:78}function Vt(){try{_t(Pt()),At(Ct()),Rt($t()),Ft(Dt()),Tt(Bt()),Ot(Kt())}catch{}}const A={blur:24,tint:"8 8 12",opacity:.14,gloss:.8,border:.45,interactive:!0,animate:!1,elevation:1};function Se(...t){return t.filter(Boolean).join(" ")}function Ee(){const[t,s]=u.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return u.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const n=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>s(a.matches);return s(n.matches),typeof n.addEventListener=="function"?(n.addEventListener("change",r),()=>n.removeEventListener("change",r)):typeof n.addListener=="function"?(n.addListener(r),()=>n.removeListener(r)):()=>{}},[]),t}function Ie(t,s){u.useEffect(()=>{const n=t.current;if(!n)return;if(!s){n.style.setProperty("--lg-x","50%"),n.style.setProperty("--lg-y","50%");return}let r=0,a=50,l=50;const i=()=>{r=0;const f=t.current;f&&(f.style.setProperty("--lg-x",`${a}%`),f.style.setProperty("--lg-y",`${l}%`))},d=f=>{const p=t.current;if(!p)return;const y=p.getBoundingClientRect(),w=(f.clientX-y.left)/y.width*100,j=(f.clientY-y.top)/y.height*100;a=Math.max(0,Math.min(100,w)),l=Math.max(0,Math.min(100,j)),r||(r=window.requestAnimationFrame(i))},c=()=>{a=50,l=50,r||(r=window.requestAnimationFrame(i))},h=t.current;return h.addEventListener("pointermove",d,{passive:!0}),h.addEventListener("pointerdown",d,{passive:!0}),h.addEventListener("pointerenter",d,{passive:!0}),h.addEventListener("pointerleave",c),()=>{r&&window.cancelAnimationFrame(r),h.removeEventListener("pointermove",d),h.removeEventListener("pointerdown",d),h.removeEventListener("pointerenter",d),h.removeEventListener("pointerleave",c)}},[t,s])}function _e(t,s){const n={...t??{}};return n["--lg-blur"]=`${s.blur}px`,n["--lg-tint"]=s.tint,n["--lg-opacity"]=`${s.opacity}`,n["--lg-gloss"]=`${s.gloss}`,n["--lg-border"]=`${s.border}`,n["--lg-elev"]=`${s.elevation}`,n}const Pe=u.forwardRef((t,s)=>{const{blur:n=A.blur,tint:r=A.tint,opacity:a=A.opacity,gloss:l=A.gloss,border:i=A.border,interactive:d=A.interactive,animate:c=A.animate,elevation:h=A.elevation,className:f,style:p,children:y,...w}=t,j=Ee(),z=(c??!1)&&!j,g=d&&!j,o=u.useRef(null),x=u.useCallback(m=>{o.current=m,typeof s=="function"?s(m):s&&(s.current=m),m&&(m.style.setProperty("--lg-x","50%"),m.style.setProperty("--lg-y","50%"))},[s]);Ie(o,g);const E=u.useMemo(()=>_e(p,{blur:n,tint:r,opacity:a,gloss:l,border:i,elevation:h}),[p,n,r,a,l,i,h]);return e.jsx("div",{ref:x,className:Se("liquid-glass",f),"data-animate":z?"true":"false","data-interactive":g?"true":"false",style:E,...w,children:y})});Pe.displayName="LiquidGlass";const Ae=u.forwardRef((t,s)=>{const{className:n,style:r,children:a,type:l,blur:i,tint:d,opacity:c,gloss:h,border:f,interactive:p,animate:y,elevation:w,...j}=t,z=i??18,g=d??"12 12 18",o=c??.2,x=h??1,E=f??.4,m=p??!0,b=y??!1,U=w??1.2,K=Ee(),L=b&&!K,v=m&&!K,M=u.useRef(null),G=u.useCallback(I=>{M.current=I,typeof s=="function"?s(I):s&&(s.current=I),I&&(I.style.setProperty("--lg-x","50%"),I.style.setProperty("--lg-y","50%"))},[s]);Ie(M,v);const P=u.useMemo(()=>_e(r,{blur:z,tint:g,opacity:o,gloss:x,border:E,elevation:U}),[r,z,g,o,x,E,U]);return e.jsx("button",{ref:G,type:l??"button",className:Se("liquid-glass liquid-glass__button",n),"data-animate":L?"true":"false","data-interactive":v?"true":"false",style:P,...j,children:a})});Ae.displayName="LiquidGlass.Button";const O=Pe;O.Button=Ae;const Ce="theme",Le="accent",Me="accent_custom",Re="bg",qt="bg_custom",$e="ui:style-mode",Fe={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var me,he;const H=((he=(me=import.meta)==null?void 0:me.env)==null?void 0:he.BASE_URL)??"/",T=t=>{const s=t.replace(/^\/+/,"");return(H.endsWith("/")?H:H+"/")+s},De={bg1:T("img/bg1.png"),bg2:T("img/bg2.png"),bg3:T("img/bg3.png"),bg4:T("img/bg4.png"),bg5:T("img/bg5.png")};function Wt(){const t=localStorage.getItem(Ce);return t==="light"||t==="dark"?t:null}function Ut(){const t=localStorage.getItem(Le);return t?t==="custom"?"custom":t in Fe?t:null:null}function Gt(){return localStorage.getItem(Me)}function Te(){const t=localStorage.getItem(Re);return t&&(t==="none"||t==="custom"||t in De)?t:null}function Yt(){return localStorage.getItem(qt)}function Be(){const t=localStorage.getItem($e);return t==="classic"||t==="liquid"?t:null}function Oe(t){const s=document.documentElement;if(s.classList.toggle("theme-liquid",t==="liquid"),s.dataset.styleMode=t,t==="liquid")try{const n=document.body;n.style.removeProperty("background"),n.style.removeProperty("background-size"),n.style.removeProperty("background-repeat"),n.style.removeProperty("background-attachment"),n.style.removeProperty("background-position")}catch{}else try{const n=Te()??"none";Ve(n)}catch{}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}try{localStorage.setItem($e,t)}catch{}}function Ht(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function Xt(t){const s=document.documentElement;t==="dark"?s.classList.add("dark"):s.classList.remove("dark"),localStorage.setItem(Ce,t);const n=t==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",n);try{s.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function Ke(t){if(t==="custom"){const s=Gt()||"#6366F1";document.documentElement.style.setProperty("--accent",s);const n=Qt(s,-.15);document.documentElement.style.setProperty("--accent-600",n)}else{const s=Fe[t];document.documentElement.style.setProperty("--accent",s[500]),document.documentElement.style.setProperty("--accent-600",s[600])}localStorage.setItem(Le,t)}function Es(t){localStorage.setItem(Me,qe(t)),Ke("custom")}function Ve(t){const s=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")s.style.backgroundImage="",s.style.backgroundSize="",s.style.backgroundRepeat="",s.style.backgroundAttachment="",s.style.backgroundPosition="";else if(t==="custom"){const a=Yt();a?(s.style.backgroundImage=`url(${a})`,s.style.backgroundSize="cover",s.style.backgroundRepeat="no-repeat",s.style.backgroundAttachment=r,s.style.backgroundPosition="center"):s.style.backgroundImage=""}else{const a=De[t];s.style.backgroundImage=`url(${a})`,s.style.backgroundSize="cover",s.style.backgroundRepeat="no-repeat",s.style.backgroundAttachment=r,s.style.backgroundPosition="center"}localStorage.setItem(Re,t)}function Jt(){const s=Wt()??(Ht()?"dark":"light");Xt(s);const n=Ut()??"indigo";Ke(n);const r=Te()??"none";Ve(r);const a=Be()??"classic";Oe(a)}function qe(t){let s=t.trim();if(s.startsWith("#")||(s=`#${s}`),s.length===4){const n=s[1],r=s[2],a=s[3];s=`#${n}${n}${r}${r}${a}${a}`}return s}function Qt(t,s){const n=qe(t).slice(1),r=parseInt(n,16);let a=r>>16&255,l=r>>8&255,i=r&255;a=Math.max(0,Math.min(255,Math.round(a+255*s))),l=Math.max(0,Math.min(255,Math.round(l+255*s))),i=Math.max(0,Math.min(255,Math.round(i+255*s)));const d=c=>c.toString(16).padStart(2,"0");return`#${d(a)}${d(l)}${d(i)}`}function ce(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid")return t}try{return Be()??"classic"}catch{return"classic"}}function re(){const[t,s]=u.useState(()=>ce());u.useEffect(()=>{const r=()=>{const i=ce();s(d=>d===i?d:i)},a=i=>{const d=i.detail;d==="classic"||d==="liquid"?s(d):r()};window.addEventListener("stylemodechange",a);const l=new MutationObserver(r);return l.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",a),l.disconnect()}},[]);const n=u.useCallback(r=>{Oe(r),s(r)},[]);return[t,n]}function C(t){return`${"/".replace(/\/$/,"")}${t}`}function Zt(){if(!Lt("cmd_palette",!0))return null;const[s]=re(),[n,r]=u.useState(!1),[a,l]=u.useState(""),[i,d]=u.useState(0),[c,h]=u.useState(()=>localStorage.getItem("cp_filter")||"all");u.useEffect(()=>{try{localStorage.setItem("cp_filter",c)}catch{}},[c]),u.useEffect(()=>{function o(x){(x.ctrlKey||x.metaKey)&&x.key.toLowerCase()==="k"&&(x.preventDefault(),r(!0),l(""),d(0)),n&&x.key==="Escape"&&r(!1)}return window.addEventListener("keydown",o),window.openCommandPalette=()=>{r(!0),l(""),d(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",o)}},[n]);const p=u.useMemo(()=>{const o=[];o.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Страница",url:C("/favorites")}),o.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Страница",url:C("/settings")});for(const m of zt)o.push({kind:"role",id:m.id,title:m.role,subtitle:"Раздел",url:C(`/roles/${m.id}`)});for(const m of le)o.push({kind:"law",id:m.slug,title:m.title,subtitle:"Закон",url:C(`/laws/${m.slug}`)});for(const m of Et)o.push({kind:"vu",id:m.id,title:m.title,subtitle:"ВУ",url:C(`/vu/${m.id}`)});const x=a.trim().toLowerCase();return x&&o.push(...w(x).slice(0,60)),x?(c==="all"?o:o.filter(m=>m.kind===c)).map(m=>({r:m,score:y(`${m.title} ${m.subtitle||""}`.toLowerCase(),x)+(m.__boost||0)})).filter(m=>m.score>0).sort((m,b)=>b.score-m.score).slice(0,30).map(m=>m.r):o.slice(0,20)},[a,c]);function y(o,x){return x.split(/\s+/).filter(Boolean).reduce((m,b)=>m+(o.includes(b)?1:0),0)}function w(o){const x=[],E=b=>b.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const b of le){const K=(b.content||"").replace(/\r\n?/g,`
`).split(`
`);let L="",v="";const M=new Set;for(const G of K){const P=G.trim(),I=/^(#{2,6})\s*(.+)$/.exec(P);if(I){L=I[2].trim(),v=E(L)||"";const R=L.toLowerCase();if(v&&R.includes(o)){const D=`${b.slug}#${v}`;if(!M.has(D)){const V={kind:"law",id:D,title:`${b.title} — ${L}`,subtitle:"Заголовок",url:C(`/laws/${b.slug}?q=${encodeURIComponent(o)}#${v}`)};V.__boost=R.startsWith(o)?8:6,x.push(V),M.add(D)}}continue}if(P&&P.toLowerCase().includes(o)){const R=v?`${b.slug}#${v}`:b.slug;if(!M.has(R)){const D=P.length>140?P.slice(0,137)+"…":P,V=v?`${b.title} — ${L}`:b.title,Ye=C(v?`/laws/${b.slug}?q=${encodeURIComponent(o)}#${v}`:`/laws/${b.slug}?q=${encodeURIComponent(o)}`),ae={kind:"law",id:R,title:V,subtitle:D||"Контекст",url:Ye};ae.__boost=5,x.push(ae),M.add(R)}}}}const m=new Set;return x.filter(b=>m.has(b.id)?!1:(m.add(b.id),!0))}function j(o){r(!1);try{window.location.href=o}catch{location.assign(o)}}function z(o){p.length&&(o.key==="ArrowDown"&&(o.preventDefault(),d(x=>Math.min(x+1,p.length-1))),o.key==="ArrowUp"&&(o.preventDefault(),d(x=>Math.max(x-1,0))),o.key==="Enter"&&(o.preventDefault(),j(p[i].url)))}const g=({children:o})=>s==="liquid"?e.jsx(O,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:o}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:o});return e.jsx(e.Fragment,{children:n?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Поиск",children:e.jsxs(g,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(te,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:a,onChange:o=>{l(o.target.value),d(0)},onKeyDown:z,placeholder:"Поиск: закон, роль, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"Закрыть",children:e.jsx(fe,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(o=>e.jsx("button",{onClick:()=>{h(o.k),d(0)},className:`chip ${c===o.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:o.label},o.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!p.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),p.map((o,x)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${x===i?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>d(x),onClick:()=>j(o.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[o.kind==="law"&&e.jsx(q,{className:"h-4 w-4"}),o.kind==="role"&&e.jsx(ee,{className:"h-4 w-4"}),o.kind==="vu"&&e.jsx(Z,{className:"h-4 w-4"}),o.kind==="page"&&(o.id==="settings"?e.jsx(se,{className:"h-4 w-4"}):e.jsx(ne,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:o.title})]}),o.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:o.subtitle})]},`${o.kind}:${o.id}`))]})]})}):null})}const F={},es=(F==null?void 0:F.VITE_API_BASE)||(F==null?void 0:F.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function ts(){try{const t="anon_uid";let s=localStorage.getItem(t);return s||(s=crypto.randomUUID(),localStorage.setItem(t,s)),s}catch{return"na"}}function ss(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:ts()}}function ns(t,s){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const n=JSON.stringify({event:t,...ss(),data:s}),r=`${es}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([n],{type:"application/json"});if(navigator.sendBeacon(r,a))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:n})}catch{}}const de="recent:items";function rs(t,s){try{const n=localStorage.getItem(de),r=n?JSON.parse(n):[],a={url:t,title:s,ts:Date.now()};if(r.length&&r[0].url===t)return;const l=r.filter(c=>c.url!==t);l.unshift(a);const i=[],d=new Set;for(const c of l)d.has(c.url)||(d.add(c.url),i.push(c));for(;i.length>15;)i.pop();localStorage.setItem(de,JSON.stringify(i))}catch{}}const We=[{label:"Повышение",icon:e.jsx(ee,{className:"h-4 w-4"}),id:"roles"},{label:"Шаблоны",icon:e.jsx(at,{className:"h-4 w-4"}),id:"templates"},{label:"Посты",icon:e.jsx(it,{className:"h-4 w-4"}),id:"posts"},{label:"Процедуры",icon:e.jsx(ot,{className:"h-4 w-4"}),id:"procedures"},{label:"Взаимодействия",icon:e.jsx(ge,{className:"h-4 w-4"}),id:"interactions"},{label:"Проверки",icon:e.jsx(lt,{className:"h-4 w-4"}),id:"checks"},{label:"Лекции",icon:e.jsx(q,{className:"h-4 w-4"}),id:"lectures"},{label:"ВУ",icon:e.jsx(Z,{className:"h-4 w-4"}),id:"vu"},{label:"Законы",icon:e.jsx(q,{className:"h-4 w-4"}),id:"laws"}];function as(){const[t,s]=u.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),n=Q(),[r]=re(),a=u.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),l=u.useMemo(()=>{const o=(new URLSearchParams(n.search||"").get("tab")||"").toLowerCase(),x=(n.hash||"").replace(/^#/,"").toLowerCase();return o||x||""},[n.search,n.hash]),i=u.useCallback(g=>l===g,[l]);u.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const o=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=o}}},[t]),u.useEffect(()=>{function g(){typeof window>"u"||s(window.innerWidth>=1024)}return window.addEventListener("resize",g),()=>window.removeEventListener("resize",g)},[]),u.useEffect(()=>{const g=document.documentElement;t?g.classList.add("has-sidebar"):g.classList.remove("has-sidebar")},[t]);const c=u.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[])?"⌘ K":"Ctrl K",h=r==="liquid"?"inline-flex items-center rounded-md border border-white/20 bg-white/10 px-1.5 py-0.5 text-[10px] font-medium text-white/80 shadow-[0_8px_20px_-12px_rgba(80,120,255,0.75)]":"inline-flex items-center rounded-md border border-zinc-300 bg-white/90 px-1.5 py-0.5 text-[10px] font-medium text-zinc-800 shadow-sm dark:border-zinc-700 dark:bg-zinc-800/90 dark:text-zinc-100 dark:shadow-none",f=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",p=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",y=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",w=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",j=g=>{const o=`?tab=${encodeURIComponent(g)}`;return a?{pathname:"/",search:o}:{pathname:"/",search:o,hash:`#${g}`}},z=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(N,{to:"/",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[We.map(g=>{const o=i(g.id);return e.jsx("li",{children:e.jsxs(N,{to:j(g.id),className:[f,o?p:""].filter(Boolean).join(" "),"aria-current":o?"page":void 0,"aria-label":g.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&s(!1)},children:[g.icon,e.jsx("span",{className:"truncate",children:g.label})]})},g.id)}),e.jsx("li",{children:e.jsxs(N,{to:"/about",className:f,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&s(!1)},children:[e.jsx(xe,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})})]})}),e.jsxs("div",{className:y,children:["Подсказка: нажмите ",e.jsx("kbd",{className:h,children:c}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>s(g=>!g),"aria-label":"Открыть меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Основная навигация",className:w,children:r==="liquid"?e.jsx(O,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:z}):z})]})}const is={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},Ue={entities:is};function os(t){var n;return((n=Ue.entities)==null?void 0:n[t])||null}function Is(t,s=30){const n=os(t);if(!(n!=null&&n.updated_at))return{recent:!1};const r=new Date(n.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=s,date:n.updated_at}}function _s(t,s){const n=t.split(/\r?\n/),r=s.split(/\r?\n/),a=n.length,l=r.length,i=Array.from({length:a+1},()=>Array(l+1).fill(0));for(let f=a-1;f>=0;f--)for(let p=l-1;p>=0;p--)i[f][p]=n[f]===r[p]?i[f+1][p+1]+1:Math.max(i[f+1][p],i[f][p+1]);const d=[];let c=0,h=0;for(;c<a&&h<l;)n[c]===r[h]?(d.push(B(n[c])),c++,h++):i[c+1][h]>=i[c][h+1]?(d.push(`<del>${B(n[c])}</del>`),c++):(d.push(`<ins>${B(r[h])}</ins>`),h++);for(;c<a;)d.push(`<del>${B(n[c++])}</del>`);for(;h<l;)d.push(`<ins>${B(r[h++])}</ins>`);return d.join(`
`)}function B(t){return t.replace(/[&<>]/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[s])}function ls(){var n;const t=[],s=Ue.entities||{};for(const[r,a]of Object.entries(s)){const l=(n=a.changelog)==null?void 0:n[0];l&&t.push({id:r,version:l.version,date:l.date,summary:l.summary,details:l.details})}return t.sort((r,a)=>r.date<a.date?1:-1),t}function cs(){const[t]=re(),s=u.useMemo(()=>{try{const i=ls()[0];if(!i)return!1;const d=new Date(i.date+"T00:00:00Z");return(Date.now()-d.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function n(){const i=window.openCommandPalette;if(typeof i=="function")try{i();return}catch{}const d=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!d,metaKey:d}))}const r="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",a=t==="liquid"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",l=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var i;return(i=window.openMobileMenu)==null?void 0:i.call(window)},"aria-label":"Меню",children:e.jsx(ct,{className:"h-4 w-4"})}),e.jsx(dt,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:n,"aria-label":"Поиск",children:[e.jsx(te,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(N,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(N,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(ne,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(N,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(se,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(ge,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]});return e.jsx("div",{className:a,children:t==="liquid"?e.jsx(O,{className:`${r} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,children:l}):e.jsx("div",{className:r,children:l})})}const X={},ds=(X==null?void 0:X.VITE_NOTIF_URL)||void 0||"/api/notifications",ue="notif:lastSeen";function us(){const[t,s]=u.useState(!1),[n,r]=u.useState([]),[a,l]=u.useState(0);async function i(){try{const c=await fetch(ds,{cache:"no-store"});if(!c.ok)return;const h=await c.json(),f=Array.isArray(h)?h:h.items||[];f.sort((j,z)=>new Date(z.date||0).getTime()-new Date(j.date||0).getTime()),r(f);const p=localStorage.getItem(ue)||"",y=p?f.findIndex(j=>j.id===p):-1,w=y===-1?f.length:y;l(Math.max(0,w))}catch{}}u.useEffect(()=>{i()},[]);function d(){if(s(c=>!c),!t&&n.length)try{localStorage.setItem(ue,n[0].id),l(0)}catch{}}return e.jsxs("div",{className:"relative",children:[e.jsxs("button",{className:"btn btn-secondary relative",onClick:d,"aria-label":"РЈРІРµРґРѕРјР»РµРЅРёСЏ",children:[e.jsx(ut,{className:"h-4 w-4"}),a>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),t&&e.jsxs(O,{className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"РЈРІРµРґРѕРјР»РµРЅРёСЏ"}),n.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:n.map(c=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block",href:c.url||"#",target:c.url?"_blank":void 0,rel:c.url?"noreferrer":void 0,children:[c.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:c.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:c.text}),c.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:new Date(c.date).toLocaleString()})]})},c.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"РџРѕРєР° РЅРµС‚ СѓРІРµРґРѕРјР»РµРЅРёР№"})]})]})}function ms(){const[t,s]=u.useState(!1),n=Q();u.useEffect(()=>(window.openMobileMenu=()=>s(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),u.useEffect(()=>{if(!t)return;const i=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=i}},[t]);const r=u.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),a=i=>{const d=new URLSearchParams(n.search||"");d.set("tab",i);const c=`?${d.toString()}`;return r?{pathname:"/",search:c}:{pathname:"/",search:c,hash:`#${i}`}};function l(){const i=window.openCommandPalette;if(typeof i=="function")try{i()}catch{}s(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>s(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:l,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(te,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>s(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(fe,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:We.map(i=>e.jsx("li",{children:e.jsxs(N,{to:a(i.id),className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>s(!1),children:[i.icon,e.jsx("span",{className:"truncate",children:i.label})]})},i.id))}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(N,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(ne,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(N,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(se,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const hs=u.lazy(()=>S(()=>import("./GovCheatsheetSky-D3M4KRql.js"),__vite__mapDeps([0,1,2,3,4]))),ps=u.lazy(()=>S(()=>import("./WhatsNew-D6wi8qwF.js"),__vite__mapDeps([5,1,2]))),xs=u.lazy(()=>S(()=>import("./DiffPage-dfPfPUkX.js"),__vite__mapDeps([6,1,2]))),fs=u.lazy(()=>S(()=>import("./LiquidGlassShowcase-DGijY1f1.js"),__vite__mapDeps([7,1,2]))),gs=u.lazy(()=>S(()=>import("./PrintSheet-TD-hwg8c.js"),__vite__mapDeps([8,1,2]))),bs=u.lazy(()=>S(()=>import("./RolePage-Df_8hPZ6.js"),__vite__mapDeps([9,1,3,2,10]))),ys=u.lazy(()=>S(()=>import("./LawPage-BT3kYhmM.js"),__vite__mapDeps([11,1,10,2]))),js=u.lazy(()=>S(()=>import("./VuPage-DWZVLKLY.js"),__vite__mapDeps([12,1,2]))),ws=u.lazy(()=>S(()=>import("./SettingsPage-DKKS-l-U.js"),__vite__mapDeps([13,1,4,2]))),vs=u.lazy(()=>S(()=>import("./FavoritesPage-DJJLGnGO.js"),__vite__mapDeps([14,1,10,2])));function ks(){const t=Q();return pe.useEffect(()=>{ns("page_view");try{rs(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function Ns(){return e.jsxs(Je,{basename:"/",children:[e.jsx(Zt,{}),e.jsx(as,{}),e.jsx(cs,{}),e.jsx(ms,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[90] sm:top-2",children:e.jsx(us,{})}),e.jsx(ks,{}),e.jsx(u.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-500",children:"Р—Р°РіСЂСѓР·РєР°вЂ¦"}),children:e.jsxs(Qe,{children:[e.jsx(k,{path:"/",element:e.jsx(hs,{})}),e.jsx(k,{path:"/whats-new",element:e.jsx(ps,{})}),e.jsx(k,{path:"/diff/:id",element:e.jsx(xs,{})}),e.jsx(k,{path:"/print",element:e.jsx(gs,{})}),e.jsx(k,{path:"/roles/:id",element:e.jsx(bs,{})}),e.jsx(k,{path:"/laws/:slug",element:e.jsx(ys,{})}),e.jsx(k,{path:"/vu/:id",element:e.jsx(js,{})}),e.jsx(k,{path:"/recorders/:id",element:e.jsx(vt,{})}),e.jsx(k,{path:"/about",element:e.jsx(Nt,{})}),e.jsx(k,{path:"/style/liquid",element:e.jsx(fs,{})}),e.jsx(k,{path:"/settings",element:e.jsx(ws,{})}),e.jsx(k,{path:"/favorites",element:e.jsx(vs,{})})]})})]})}(function(){try{const s="app:version",n=localStorage.getItem(s),r="1758205440194";if(n&&n!==r){"caches"in window?caches.keys().then(a=>Promise.all(a.map(l=>caches.delete(l)))).finally(()=>{localStorage.setItem(s,r),location.reload()}):(localStorage.setItem(s,r),location.reload());return}localStorage.setItem(s,r)}catch{}})();Jt();Vt();function Ge(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}Ge();window.addEventListener("resize",Ge,{passive:!0});J.createRoot(document.getElementById("root")).render(e.jsx(u.StrictMode,{children:e.jsx(Ns,{})}));export{Fe as A,Tt as B,kt as C,De as D,O as L,zt as a,os as b,Ut as c,_s as d,Be as e,Pt as f,ls as g,Ct as h,Is as i,e as j,$t as k,le as l,Dt as m,Bt as n,Xt as o,Oe as p,Ke as q,jt as r,Ht as s,Es as t,re as u,Et as v,_t as w,At as x,Rt as y,Ft as z};
