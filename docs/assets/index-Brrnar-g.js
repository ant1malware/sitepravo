const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-C3yVRO13.js","assets/react-vendor-DTkXckhQ.js","assets/icons-CC9EosDR.js","assets/VoteWidget-CVUUv45I.js","assets/asset-ClJDRudC.js","assets/WhatsNew-EfNabzK_.js","assets/DiffPage-BeTeVa6I.js","assets/LiquidGlassShowcase-DvDbU-kD.js","assets/PrintSheet-Cf-48EkU.js","assets/RolePage-CM6PIMNl.js","assets/FavStar-C53Svt1l.js","assets/LawPage-D45kLFop.js","assets/VuPage-Ca1noMk3.js","assets/BuddyPlayground-DwOn3uni.js","assets/HomePage-CSTDaDHb.js","assets/ForumPage-CCvzLiHu.js","assets/SettingsPage-BYNPrIdS.js","assets/FavoritesPage-C2wdYF_c.js"])))=>i.map(i=>d[i]);
import{r as Ee,a as pt,u as ht,L,R as d,b as V,B as gt,c as ft,d as _}from"./react-vendor-DTkXckhQ.js";import{A as xt,E as bt,I as ze,C as yt,Q as vt,R as wt,B as Y,S as ie,H as jt,U as oe,a as le,X as _e,b as ce,c as de,L as Ie,G as kt,M as se,F as Nt,d as St,e as Et,f as zt,g as _t,h as It,i as Lt}from"./icons-CC9EosDR.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const c of i)if(c.type==="childList")for(const u of c.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function s(i){const c={};return i.integrity&&(c.integrity=i.integrity),i.referrerPolicy&&(c.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?c.credentials="include":i.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(i){if(i.ep)return;i.ep=!0;const c=s(i);fetch(i.href,c)}})();var Le={exports:{}},H={};/**
 * @license React
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],Re="ui:density",Pe="ui:font",Ut="ui:features",Ae="ui:shadow",Ce="ui:radius",$e="ui:glass",Te="ui:readw",Fe="ui:anim";function Yt(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),localStorage.setItem(Re,t)}function Ht(){return localStorage.getItem(Re)==="compact"?"compact":"standard"}function Xt(t){const n=Math.max(.9,Math.min(1.3,t)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),localStorage.setItem(Pe,String(n))}function Jt(){const t=parseFloat(localStorage.getItem(Pe)||"1");return isFinite(t)&&t>.6&&t<2?t:1}function Qt(t,n=!0){const s=Zt();return t in s?!!s[t]:n}function Zt(){try{const t=localStorage.getItem(Ut);return t?JSON.parse(t):{}}catch{return{}}}function en(t){let n="none";t==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),localStorage.setItem(Ae,t)}function tn(){const t=localStorage.getItem(Ae);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function nn(t){let n=8,s=16,r=20;t==="subtle"&&(n=6,s=10,r=14),t==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),localStorage.setItem(Ce,t)}function sn(){const t=localStorage.getItem(Ce);return t==="subtle"||t==="rounded"?t:"standard"}function rn(t){const n=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",n+"px"),localStorage.setItem($e,String(n))}function an(){const t=parseInt(localStorage.getItem($e)||"6",10);return isFinite(t)?t:6}function on(t){const n=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",n+"ch"),localStorage.setItem(Te,String(n))}function ln(){const t=parseInt(localStorage.getItem(Te)||"78",10);return isFinite(t)?t:78}function cn(){try{Yt(Ht()),Xt(Jt()),en(tn()),nn(sn()),rn(an()),on(ln()),dn(un())}catch{}}function dn(t){document.documentElement.classList.toggle("anim-off",!t);try{localStorage.setItem(Fe,t?"1":"0")}catch{}}function un(){try{return localStorage.getItem(Fe)!=="0"}catch{return!0}}const De={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},I={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function Be(...t){return t.filter(Boolean).join(" ")}function Oe(){const[t,n]=d.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return d.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=i=>n(i.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),t}function qe(t,n){d.useEffect(()=>{const s=t.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,i=72,c=18;const u=()=>{r=0;const h=t.current;h&&(h.style.setProperty("--lg-x",`${i}%`),h.style.setProperty("--lg-y",`${c}%`))},o=h=>{const x=t.current;if(!x)return;const p=x.getBoundingClientRect(),w=(h.clientX-p.left)/p.width*100,N=(h.clientY-p.top)/p.height*100;i=Math.max(0,Math.min(100,w)),c=Math.max(0,Math.min(100,N)),r||(r=window.requestAnimationFrame(u))},l=()=>{i=72,c=18,r||(r=window.requestAnimationFrame(u))};return s.addEventListener("pointermove",o,{passive:!0}),s.addEventListener("pointerdown",o,{passive:!0}),s.addEventListener("pointerenter",o,{passive:!0}),s.addEventListener("pointerleave",l),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",o),s.removeEventListener("pointerdown",o),s.removeEventListener("pointerenter",o),s.removeEventListener("pointerleave",l)}},[t,n])}function fe(t){if(!t)return[255,255,255];const n=t.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function U(t){return`${t[0]} ${t[1]} ${t[2]}`}function Q(t,n,s){return Math.round(t+(n-t)*s)}function xe(t,n){return[Q(t[0],n>=0?255:0,Math.abs(n)),Q(t[1],n>=0?255:0,Math.abs(n)),Q(t[2],n>=0?255:0,Math.abs(n))]}function mn(t,n,s){const r=t?De[t]:n??I.tint,i=s??I.accent,c=fe(r),u=fe(i),o=xe(u,.25),l=xe(u,-.55);return{tintRgb:U(c),accentRgb:U(u),accentSoftRgb:U(o),accentDeepRgb:U(l)}}function Ke(t,n){const s={...t??{}},{tintRgb:r,accentRgb:i,accentSoftRgb:c,accentDeepRgb:u}=mn(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=i,s["--lg-accent-soft"]=c,s["--lg-accent-deep"]=u,s}const Ve=d.forwardRef((t,n)=>{const{blur:s=I.blur,tint:r=I.tint,opacity:i=I.opacity,gloss:c=I.gloss,border:u=I.border,glints:o=I.glints,interactive:l=I.interactive,animate:h=I.animate,elevation:x=I.elevation,tone:p,accent:w=I.accent,className:N,style:f,children:b,...v}=t,a=Oe(),m=l&&!a,j=d.useRef(null),g=d.useCallback(k=>{j.current=k,typeof n=="function"?n(k):n&&(n.current=k),k&&(k.style.setProperty("--lg-x","72%"),k.style.setProperty("--lg-y","18%"))},[n]);qe(j,m);const y=d.useMemo(()=>Ke(f,{blur:s,tint:r,opacity:i,gloss:c,border:u,elevation:x,glints:o,tone:p,accent:w}),[f,s,r,i,c,u,x,o,p,w]),z={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
      ...
      `})]})});We.displayName="LiquidGlass.Button";const W=Ve;W.Button=We;const Ge="theme",Ue="accent",Ye="accent_custom",He="bg",pn="bg_custom",Xe="ui:style-mode",Z="ui:liquid:prev-theme",Je="ui:liquid:tone",Qe={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var Ne,Se;const ee=((Se=(Ne=import.meta)==null?void 0:Ne.env)==null?void 0:Se.BASE_URL)??"/",q=t=>{const n=t.replace(/^\/+/,"");return(ee.endsWith("/")?ee:ee+"/")+n},Ze={bg1:q("img/bg1.png"),bg2:q("img/bg2.png"),bg3:q("img/bg3.png"),bg4:q("img/bg4.png"),bg5:q("img/bg5.png")};function et(){const t=localStorage.getItem(Ge);return t==="light"||t==="dark"?t:null}function hn(){const t=localStorage.getItem(Ue);return t?t==="custom"?"custom":t in Qe?t:null:null}function gn(){return localStorage.getItem(Ye)}function tt(){const t=localStorage.getItem(He);return t&&(t==="none"||t==="custom"||t in Ze)?t:null}function fn(){return localStorage.getItem(pn)}function nt(){const t=localStorage.getItem(Xe);return t==="classic"||t==="liquid"||t==="beta"?t:null}function xn(){return(localStorage.getItem(Je)||"dark")==="light"?"light":"dark"}function bn(t){try{localStorage.setItem(Je,t)}catch{}const n=document.documentElement;if(n.classList.toggle("liquid-light",t==="light"),n.classList.toggle("liquid-dark",t!=="light"),n.classList.contains("theme-liquid"))try{ue(t==="light"?"light":"dark")}catch{}}function st(t){const n=document.documentElement;if(n.classList.toggle("theme-liquid",t==="liquid"),n.classList.toggle("theme-beta",t==="beta"),n.dataset.styleMode=t,t==="liquid"||t==="beta"){try{const s=et()??(rt()?"dark":"light");localStorage.setItem(Z,s);const r=xn();bn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=localStorage.getItem(Z);(s==="light"||s==="dark")&&ue(s),localStorage.removeItem(Z)}catch{}try{const s=tt()??"none";it(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}try{localStorage.setItem(Xe,t)}catch{}}function rt(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function ue(t){const n=document.documentElement;t==="dark"?n.classList.add("dark"):n.classList.remove("dark"),localStorage.setItem(Ge,t);const s=t==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function at(t){if(t==="custom"){const n=gn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=vn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=Qe[t];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}localStorage.setItem(Ue,t)}function ts(t){localStorage.setItem(Ye,ot(t)),at("custom")}function it(t){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(t==="custom"){const i=fn();i?(n.style.backgroundImage=`url(${i})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const i=Ze[t];n.style.backgroundImage=`url(${i})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}localStorage.setItem(He,t)}function yn(){const n=et()??(rt()?"dark":"light");ue(n);const s=hn()??"indigo";at(s);const r=tt()??"none";it(r);const i=nt()??"classic";st(i)}function ot(t){let n=t.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],i=n[3];n=`#${s}${s}${r}${r}${i}${i}`}return n}function vn(t,n){const s=ot(t).slice(1),r=parseInt(s,16);let i=r>>16&255,c=r>>8&255,u=r&255;i=Math.max(0,Math.min(255,Math.round(i+255*n))),c=Math.max(0,Math.min(255,Math.round(c+255*n))),u=Math.max(0,Math.min(255,Math.round(u+255*n)));const o=l=>l.toString(16).padStart(2,"0");return`#${o(i)}${o(c)}${o(u)}`}function be(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid"||t==="beta")return t}try{return nt()??"classic"}catch{return"classic"}}function X(){const[t,n]=d.useState(()=>be());d.useEffect(()=>{const r=()=>{const u=be();n(o=>o===u?o:u)},i=u=>{const o=u.detail;o==="classic"||o==="liquid"||o==="beta"?n(o):r()};window.addEventListener("stylemodechange",i);const c=new MutationObserver(r);return c.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",i),c.disconnect()}},[]);const s=d.useCallback(r=>{st(r),n(r)},[]);return[t,s]}function T(t){return`${"/betatestik/".replace(/\/$/,"")}${t}`}function wn(){if(!Qt("cmd_palette",!0))return null;const[n]=X(),[s,r]=d.useState(!1),[i,c]=d.useState(""),[u,o]=d.useState(0),[l,h]=d.useState(()=>localStorage.getItem("cp_filter")||"all");d.useEffect(()=>{try{localStorage.setItem("cp_filter",l)}catch{}},[l]),d.useEffect(()=>{function a(m){(m.ctrlKey||m.metaKey)&&m.key.toLowerCase()==="k"&&(m.preventDefault(),r(!0),c(""),o(0)),s&&m.key==="Escape"&&r(!1)}return window.addEventListener("keydown",a),window.openCommandPalette=()=>{r(!0),c(""),o(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",a)}},[s]);const p=d.useMemo(()=>{const a=[];a.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Страница",url:T("/favorites")}),a.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Страница",url:T("/settings")});for(const g of Vt)a.push({kind:"role",id:g.id,title:g.role,subtitle:"Раздел",url:T(`/roles/${g.id}`)});for(const g of ge)a.push({kind:"law",id:g.slug,title:g.title,subtitle:"Закон",url:T(`/laws/${g.slug}`)});for(const g of Gt)a.push({kind:"vu",id:g.id,title:g.title,subtitle:"ВУ",url:T(`/vu/${g.id}`)});const m=i.trim().toLowerCase();return m&&a.push(...N(m).slice(0,60)),m?(l==="all"?a:a.filter(g=>g.kind===l)).map(g=>({r:g,score:w(`${g.title} ${g.subtitle||""}`.toLowerCase(),m)+(g.__boost||0)})).filter(g=>g.score>0).sort((g,y)=>y.score-g.score).slice(0,30).map(g=>g.r):a.slice(0,20)},[i,l]);function w(a,m){return m.split(/\s+/).filter(Boolean).reduce((g,y)=>g+(a.includes(y)?1:0),0)}function N(a){const m=[],j=y=>y.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const y of ge){const k=(y.content||"").replace(/\r\n?/g,`
`).split(`
`);let R="",S="";const P=new Set;for(const D of k){const A=D.trim(),G=/^(#{2,6})\s*(.+)$/.exec(A);if(G){R=G[2].trim(),S=j(R)||"";const $=R.toLowerCase();if(S&&$.includes(a)){const F=`${y.slug}#${S}`;if(!P.has(F)){const E={kind:"law",id:F,title:`${y.title} — ${R}`,subtitle:"Заголовок",url:T(`/laws/${y.slug}?q=${encodeURIComponent(a)}#${S}`)};E.__boost=$.startsWith(a)?8:6,m.push(E),P.add(F)}}continue}if(A&&A.toLowerCase().includes(a)){const $=S?`${y.slug}#${S}`:y.slug;if(!P.has($)){const F=A.length>140?A.slice(0,137)+"…":A,E=S?`${y.title} — ${R}`:y.title,mt=T(S?`/laws/${y.slug}?q=${encodeURIComponent(a)}#${S}`:`/laws/${y.slug}?q=${encodeURIComponent(a)}`),me={kind:"law",id:$,title:E,subtitle:F||"Контекст",url:mt};me.__boost=5,m.push(me),P.add($)}}}}const g=new Set;return m.filter(y=>g.has(y.id)?!1:(g.add(y.id),!0))}function f(a){r(!1);try{window.location.href=a}catch{location.assign(a)}}function b(a){p.length&&(a.key==="ArrowDown"&&(a.preventDefault(),o(m=>Math.min(m+1,p.length-1))),a.key==="ArrowUp"&&(a.preventDefault(),o(m=>Math.max(m-1,0))),a.key==="Enter"&&(a.preventDefault(),f(p[u].url)))}const v=({children:a})=>n==="liquid"?e.jsx(W,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:a}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:a});return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Поиск",children:e.jsxs(v,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(le,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:i,onChange:a=>{c(a.target.value),o(0)},onKeyDown:b,placeholder:"Поиск: закон, роль, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"Закрыть",children:e.jsx(_e,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(a=>e.jsx("button",{onClick:()=>{h(a.k),o(0)},className:`chip ${l===a.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:a.label},a.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!p.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),p.map((a,m)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${m===u?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>o(m),onClick:()=>f(a.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[a.kind==="law"&&e.jsx(Y,{className:"h-4 w-4"}),a.kind==="role"&&e.jsx(oe,{className:"h-4 w-4"}),a.kind==="vu"&&e.jsx(ie,{className:"h-4 w-4"}),a.kind==="page"&&(a.id==="settings"?e.jsx(ce,{className:"h-4 w-4"}):e.jsx(de,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:a.title})]}),a.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:a.subtitle})]},`${a.kind}:${a.id}`))]})]})}):null})}const O={},jn=(O==null?void 0:O.VITE_API_BASE)||(O==null?void 0:O.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function kn(){try{const t="anon_uid";let n=localStorage.getItem(t);return n||(n=crypto.randomUUID(),localStorage.setItem(t,n)),n}catch{return"na"}}function Nn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:kn()}}function Sn(t,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const i=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(i)==="1"||String(i)==="yes")return}catch{}const s=JSON.stringify({event:t,...Nn(),data:n}),r=`${jn}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const i=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,i))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const ye="recent:items";function En(t,n){try{const s=localStorage.getItem(ye),r=s?JSON.parse(s):[],i={url:t,title:n,ts:Date.now()};if(r.length&&r[0].url===t)return;const c=r.filter(l=>l.url!==t);c.unshift(i);const u=[],o=new Set;for(const l of c)o.has(l.url)||(o.add(l.url),u.push(l));for(;u.length>15;)u.pop();localStorage.setItem(ye,JSON.stringify(u))}catch{}}const ve="forum:auth:session",ae="forum:session-change";function we(t){if(!t)return null;try{const n=JSON.parse(t);if(!n||typeof n!="object")return null;const s=typeof n.userId=="string"?n.userId:"";if(!s)return null;const r=!!n.remember,i=typeof n.lastLogin=="string"&&n.lastLogin?n.lastLogin:new Date().toISOString();return{userId:s,remember:r,lastLogin:i}}catch{return null}}function je(){if(typeof window>"u")return null;const t=window.localStorage.getItem(ve),n=window.sessionStorage.getItem(ve);return we(t)??we(n)}function ns(t){if(!(typeof window>"u"))try{window.dispatchEvent(new CustomEvent(ae,{detail:{session:t}}))}catch{}}function lt(){const[t,n]=d.useState(()=>{try{return je()}catch{return null}});return d.useEffect(()=>{const s=()=>{try{n(je())}catch{n(null)}};return window.addEventListener("storage",s),window.addEventListener(ae,s),()=>{window.removeEventListener("storage",s),window.removeEventListener(ae,s)}},[]),t}const ct=[{key:"forum",type:"route",label:"Форум",icon:e.jsx(se,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(oe,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(Nt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(St,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx(Et,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(se,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(zt,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(Y,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(ie,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(Y,{className:"h-4 w-4"}),id:"laws"}];function zn(){const[t,n]=d.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=V(),[r]=X(),c=!lt(),u=d.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),o=d.useMemo(()=>{const m=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),j=(s.hash||"").replace(/^#/,"").toLowerCase();return m||j||""},[s.search,s.hash]),l=d.useCallback(a=>o===a,[o]);d.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const m=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=m}}},[t]),d.useEffect(()=>{function a(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)},[]),d.useEffect(()=>{const a=document.documentElement;t?a.classList.add("has-sidebar"):a.classList.remove("has-sidebar")},[t]);const h=d.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),x=h?"⌘ K":"Ctrl K",p=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",w=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",N=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",f=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",b=a=>{const m=`?tab=${encodeURIComponent(a)}`;return u?{pathname:"/",search:m}:{pathname:"/",search:m,hash:`#${a}`}},v=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(L,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[ct.map(a=>{const m=a.type==="route"?s.pathname===a.to:l(a.id),j=a.type==="route"?a.to:b(a.id);return e.jsx("li",{children:e.jsxs(L,{to:j,className:[p,m?w:""].filter(Boolean).join(" "),"aria-current":m?"page":void 0,"aria-label":a.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[a.icon,e.jsx("span",{className:"truncate",children:a.label}),a.key==="forum"&&c&&e.jsx(Ie,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},a.key)}),e.jsx("li",{children:e.jsxs(L,{to:"/about",className:p,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(ze,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(L,{to:"/buddy",className:p,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(kt,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:N,children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:x}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(a=>!a),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:f,children:r==="liquid"?e.jsx(W,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:v}):v})]})}const _n={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},dt={entities:_n};function In(t){var s;return((s=dt.entities)==null?void 0:s[t])||null}function ss(t,n=30){const s=In(t);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function rs(t,n){const s=t.split(/\r?\n/),r=n.split(/\r?\n/),i=s.length,c=r.length,u=Array.from({length:i+1},()=>Array(c+1).fill(0));for(let x=i-1;x>=0;x--)for(let p=c-1;p>=0;p--)u[x][p]=s[x]===r[p]?u[x+1][p+1]+1:Math.max(u[x+1][p],u[x][p+1]);const o=[];let l=0,h=0;for(;l<i&&h<c;)s[l]===r[h]?(o.push(K(s[l])),l++,h++):u[l+1][h]>=u[l][h+1]?(o.push(`<del>${K(s[l])}</del>`),l++):(o.push(`<ins>${K(r[h])}</ins>`),h++);for(;l<i;)o.push(`<del>${K(s[l++])}</del>`);for(;h<c;)o.push(`<ins>${K(r[h++])}</ins>`);return o.join(`
`)}function K(t){return t.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function Ln(){var s;const t=[],n=dt.entities||{};for(const[r,i]of Object.entries(n)){const c=(s=i.changelog)==null?void 0:s[0];c&&t.push({id:r,version:c.version,date:c.date,summary:c.summary,details:c.details})}return t.sort((r,i)=>r.date<i.date?1:-1),t}function Mn(){const[t]=X(),n=V(),s=d.useMemo(()=>{try{const o=Ln()[0];if(!o)return!1;const l=new Date(o.date+"T00:00:00Z");return(Date.now()-l.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const o=window.openCommandPalette;if(typeof o=="function")try{o();return}catch{}const l=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!l,metaKey:l}))}const i="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",c=t==="liquid"||t==="beta"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",u=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var o;return(o=window.openMobileMenu)==null?void 0:o.call(window)},"aria-label":"Меню",children:e.jsx(_t,{className:"h-4 w-4"})}),e.jsx(It,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[e.jsx(le,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(L,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(L,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(de,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(L,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(ce,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(se,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]});return n.pathname.startsWith("/forum")?null:e.jsx("div",{className:c,children:t==="liquid"?e.jsx(W,{className:`${i} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:u}):e.jsx("div",{className:i,children:u})})}const Rn="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",te="notif:lastSeen",ke="notifications-panel";function Pn(){const[t,n]=d.useState(!1),[s,r]=d.useState([]),[i,c]=d.useState(0),[u,o]=d.useState(!1),[l,h]=d.useState(null),x=d.useRef(null),p=d.useCallback(async()=>{const f=new AbortController;o(!0),h(null);try{const b=await fetch(Rn,{cache:"no-store",signal:f.signal});if(!b.ok)throw new Error(`HTTP ${b.status}`);const v=await b.json(),a=Array.isArray(v)?v:v.items||[],m=z=>z?new Date(z).getTime():0;a.sort((z,k)=>m(k.date)-m(z.date)),r(a);const j=typeof localStorage<"u"&&localStorage.getItem(te)||"",g=j?a.findIndex(z=>z.id===j):-1,y=g===-1?a.length:g;c(Math.max(0,y))}catch(b){(b==null?void 0:b.name)!=="AbortError"&&h("Не удалось загрузить уведомления")}finally{o(!1)}return()=>f.abort()},[]);d.useEffect(()=>{p()},[p]),d.useEffect(()=>{if(t&&s.length)try{localStorage.setItem(te,s[0].id),c(0)}catch{}},[t,s]),d.useEffect(()=>{if(!t)return;const f=v=>{x.current&&(x.current.contains(v.target)||n(!1))},b=v=>{v.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",f),document.addEventListener("keydown",b),()=>{document.removeEventListener("mousedown",f),document.removeEventListener("keydown",b)}},[t]);const w=()=>n(f=>!f),N=f=>f?new Date(f).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:x,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:w,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":ke,children:[e.jsx(Lt,{className:"h-4 w-4"}),i>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:i})]}),t&&e.jsxs(W,{id:ke,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),u?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):l?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:l}):s.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(f=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:f.url||"#",target:f.url?"_blank":void 0,rel:f.url?"noreferrer":void 0,onClick:()=>{var b;try{(b=s[0])!=null&&b.id&&localStorage.setItem(te,s[0].id),c(0)}catch{}},children:[f.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:f.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:f.text}),f.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:N(f.date)})]})},f.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function An(){const[t,n]=d.useState(!1),s=V(),i=!lt();d.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),d.useEffect(()=>{if(!t)return;const l=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=l}},[t]);const c=d.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),u=l=>{const h=new URLSearchParams(s.search||"");h.set("tab",l);const x=`?${h.toString()}`;return c?{pathname:"/",search:x}:{pathname:"/",search:x,hash:`#${l}`}};function o(){const l=window.openCommandPalette;if(typeof l=="function")try{l()}catch{}n(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:o,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(le,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(_e,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:ct.map(l=>{const h=l.type==="route"?l.to:u(l.id);return e.jsx("li",{children:e.jsxs(L,{to:h,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[l.icon,e.jsx("span",{className:"truncate",children:l.label}),l.key==="forum"&&i&&e.jsx(Ie,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},l.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(L,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(de,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(L,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(ce,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const ne=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!"];function Cn(){const[t,n]=d.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return d.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=i=>n(i.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",r):s.addListener&&s.addListener(r),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",r):s.removeListener&&s.removeListener(r)}},[]),t}function $n(){const[t,n]=d.useState(null),s=d.useRef(Math.floor(Math.random()*ne.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches)return null;const r=Cn(),i=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),c=!r&&!i,u=d.useRef(null),o=d.useRef(null);d.useEffect(()=>{const w=u.current;if(!w)return;let N=0,f=performance.now(),b=Math.random()*(window.innerWidth-64)+16,v=Math.random()*(window.innerHeight-120)+60,a=(Math.random()*60+30)*(Math.random()>.5?1:-1),m=(Math.random()*40+20)*(Math.random()>.5?1:-1);const j=y=>{const z=Math.min(.05,(y-f)/1e3);if(f=y,c){b+=a*z,v+=m*z;const k=16,R=window.innerWidth,S=window.innerHeight,P=48,D=48;b<k&&(b=k,a=Math.abs(a)),b>R-P-k&&(b=R-P-k,a=-Math.abs(a)),v<60&&(v=60,m=Math.abs(m)),v>S-D-k&&(v=S-D-k,m=-Math.abs(m)),a+=(Math.random()-.5)*4,m+=(Math.random()-.5)*4}w.style.transform=`translate3d(${Math.round(b)}px, ${Math.round(v)}px, 0)`,N=requestAnimationFrame(j)};N=requestAnimationFrame(j);const g=()=>{f=performance.now()};return window.addEventListener("resize",g),()=>{cancelAnimationFrame(N),window.removeEventListener("resize",g)}},[c]);function l(w){const N=w??ne[s.current++%ne.length];n(N),window.clearTimeout(l._t),l._t=window.setTimeout(()=>n(null),3e3)}function h(w){l()}function x(){o.current&&window.clearTimeout(o.current),o.current=window.setTimeout(()=>l("Просто нажми, чтобы я говорил!"),600)}function p(){o.current&&(window.clearTimeout(o.current),o.current=null)}return e.jsx("div",{ref:u,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:h,onPointerDown:x,onPointerUp:p,onPointerLeave:p,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:"#bcd3ff",stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:"#6a79ff",stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}const Tn=d.lazy(()=>M(()=>import("./GovCheatsheetSky-C3yVRO13.js"),__vite__mapDeps([0,1,2,3,4]))),Fn=d.lazy(()=>M(()=>import("./WhatsNew-EfNabzK_.js"),__vite__mapDeps([5,1,2]))),Dn=d.lazy(()=>M(()=>import("./DiffPage-BeTeVa6I.js"),__vite__mapDeps([6,1,2]))),Bn=d.lazy(()=>M(()=>import("./LiquidGlassShowcase-DvDbU-kD.js"),__vite__mapDeps([7,1,2]))),On=d.lazy(()=>M(()=>import("./PrintSheet-Cf-48EkU.js"),__vite__mapDeps([8,1,2]))),qn=d.lazy(()=>M(()=>import("./RolePage-CM6PIMNl.js"),__vite__mapDeps([9,1,3,2,10]))),Kn=d.lazy(()=>M(()=>import("./LawPage-D45kLFop.js"),__vite__mapDeps([11,1,10,2]))),Vn=d.lazy(()=>M(()=>import("./VuPage-Ca1noMk3.js"),__vite__mapDeps([12,1,2]))),Wn=d.lazy(()=>M(()=>import("./BuddyPlayground-DwOn3uni.js"),__vite__mapDeps([13,1,2]))),Gn=d.lazy(()=>M(()=>import("./HomePage-CSTDaDHb.js"),__vite__mapDeps([14,1,2]))),Un=d.lazy(()=>M(()=>import("./ForumPage-CCvzLiHu.js"),__vite__mapDeps([15,1,2]))),Yn=d.lazy(()=>M(()=>import("./SettingsPage-BYNPrIdS.js"),__vite__mapDeps([16,1,4,2]))),Hn=d.lazy(()=>M(()=>import("./FavoritesPage-C2wdYF_c.js"),__vite__mapDeps([17,1,10,2])));function Xn(){const t=V();return Ee.useEffect(()=>{Sn("page_view");try{En(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function Jn(){return(V().pathname||"").startsWith("/buddy")?null:e.jsx($n,{})}function Qn(){const[t]=X();return e.jsxs("div",{className:"min-h-dvh w-full",children:[(t==="liquid"||t==="beta")&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:t==="beta"?"radial-gradient(900px 600px at 10% -5%, rgba(0,255,240,.16), transparent 60%),radial-gradient(1100px 780px at 92% 8%, rgba(168,85,247,.18), transparent 65%),linear-gradient(180deg, rgba(255,255,255,.03), rgba(0,0,0,.45))":"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:t==="beta"?.02:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(gt,{basename:"/betatestik/",children:[e.jsx(wn,{}),e.jsx(zn,{}),e.jsx(Mn,{}),e.jsx(An,{}),e.jsx(Jn,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(Pn,{})}),e.jsx(Xn,{}),e.jsx(d.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Загрузка…"}),children:e.jsxs(ft,{children:[e.jsx(_,{path:"/",element:e.jsx(Tn,{})}),e.jsx(_,{path:"/home",element:e.jsx(Gn,{})}),e.jsx(_,{path:"/forum",element:e.jsx(Un,{})}),e.jsx(_,{path:"/whats-new",element:e.jsx(Fn,{})}),e.jsx(_,{path:"/diff/:id",element:e.jsx(Dn,{})}),e.jsx(_,{path:"/print",element:e.jsx(On,{})}),e.jsx(_,{path:"/roles/:id",element:e.jsx(qn,{})}),e.jsx(_,{path:"/laws/:slug",element:e.jsx(Kn,{})}),e.jsx(_,{path:"/vu/:id",element:e.jsx(Vn,{})}),e.jsx(_,{path:"/recorders/:id",element:e.jsx(Ot,{})}),e.jsx(_,{path:"/about",element:e.jsx(Kt,{})}),e.jsx(_,{path:"/style/liquid",element:e.jsx(Bn,{})}),e.jsx(_,{path:"/buddy",element:e.jsx(Wn,{})}),e.jsx(_,{path:"/settings",element:e.jsx(Yn,{})}),e.jsx(_,{path:"/favorites",element:e.jsx(Hn,{})})]})})]})]})}(function(){try{const n="app:version",s=localStorage.getItem(n),r="1758390376112";if(s&&s!==r){"caches"in window?caches.keys().then(i=>Promise.all(i.map(c=>caches.delete(c)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();yn();cn();function ut(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}ut();window.addEventListener("resize",ut,{passive:!0});re.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(Qn,{})}));export{Qe as A,ts as B,qt as C,Yt as D,en as E,ve as F,nn as G,Ze as H,Xt as I,rn as J,W as L,Vt as a,In as b,ns as c,rs as d,hn as e,nt as f,Ln as g,Ht as h,ss as i,e as j,Jt as k,ge as l,tn as m,sn as n,an as o,un as p,xn as q,Dt as r,ue as s,rt as t,X as u,Gt as v,st as w,dn as x,bn as y,at as z};
