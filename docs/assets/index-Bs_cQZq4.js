const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-B7V9Xkuq.js","assets/react-vendor-DTkXckhQ.js","assets/icons-DSUe5z8e.js","assets/VoteWidget-CMpyB-To.js","assets/asset-ClJDRudC.js","assets/WhatsNew-kw8bJsGx.js","assets/DiffPage-C42zdPQU.js","assets/LiquidGlassShowcase-CZuGt2ds.js","assets/PrintSheet-D5LmRHou.js","assets/RolePage-B8tj-Bnh.js","assets/FavStar-XM6uYlbt.js","assets/LawPage-YEClWK51.js","assets/VuPage-1MtZT-zh.js","assets/BuddyPlayground-DDH8kGCC.js","assets/HomePage-Ci0erhma.js","assets/ForumPage-Du2MZ5_N.js","assets/SettingsPage-D7Un76xp.js","assets/FavoritesPage-C4qg5ZFY.js"])))=>i.map(i=>d[i]);
import{r as Ee,a as pt,u as ht,L,R as d,b as V,B as gt,c as ft,d as _}from"./react-vendor-DTkXckhQ.js";import{A as xt,E as bt,I as ze,C as yt,Q as vt,R as wt,B as Y,S as ie,H as jt,U as oe,a as le,X as _e,b as ce,c as de,L as Ie,G as kt,M as se,F as Nt,d as St,e as Et,f as zt,g as _t,h as It,i as Lt}from"./icons-DSUe5z8e.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const c of i)if(c.type==="childList")for(const u of c.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function s(i){const c={};return i.integrity&&(c.integrity=i.integrity),i.referrerPolicy&&(c.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?c.credentials="include":i.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(i){if(i.ep)return;i.ep=!0;const c=s(i);fetch(i.href,c)}})();var Le={exports:{}},H={};/**
 * @license React
