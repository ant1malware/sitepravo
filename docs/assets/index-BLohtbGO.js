const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-DJvQIOrz.js","assets/react-vendor-DTkXckhQ.js","assets/icons-mdlXgeZ1.js","assets/VoteWidget-TSsB4WNQ.js","assets/asset-ZvONeEnI.js","assets/WhatsNew-6utgrzvo.js","assets/DiffPage-C_3xVvxu.js","assets/PrintSheet-C5xyavLr.js","assets/RolePage-CMOWgyYb.js","assets/FavStar-pOW1aKKU.js","assets/LawPage-S6LfuFJC.js","assets/VuPage-wgyXIKWW.js","assets/SettingsPage-5FRiE__j.js","assets/FavoritesPage-CtQ0cohO.js"])))=>i.map(i=>d[i]);
import{r as ie,a as Pe,u as Ce,L as j,R as m,b as W,B as $e,c as Re,d as w}from"./react-vendor-DTkXckhQ.js";import{A as Le,E as Me,I as oe,C as De,Q as Te,R as Fe,B as F,S as U,H as Oe,U as G,a as Y,X as ce,b as H,c as X,F as Be,L as Ve,d as Ke,M as le,e as We,f as Ue,g as Ge,h as Ye}from"./icons-mdlXgeZ1.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(r){if(r.ep)return;r.ep=!0;const l=n(r);fetch(r.href,l)}})();var de={exports:{}},O={};/**
 * @license React
...
![Территория красной зоны воинской части](${b}img/red-zone.png)
Территория КПП-1
![Территория КПП-1](${b}img/cpp.png)
Территория КПП-2
![Территория КПП-2](${b}img/cpp2.png)
...
![Территория военного грузового поезда](${b}img/poezd.jpg)
![Территория военного грузового поезда](${b}/img/poezd.jpg)
...
Служебные территории:
Правительство
![Правительство2](${b}img/pravo2.png)
![Правительство](${b}img/pravo.png)
...
`,lt=[{id:"gov",title:"Внутренний устав Правительства",text:ct,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],me="ui:density",he="ui:font",dt="ui:features",pe="ui:shadow",xe="ui:radius",fe="ui:glass",ge="ui:readw";function ut(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),localStorage.setItem(me,t)}function mt(){return localStorage.getItem(me)==="compact"?"compact":"standard"}function ht(t){const s=Math.max(.9,Math.min(1.3,t)),n=16*s;document.documentElement.style.setProperty("--font-size",`${n}px`),localStorage.setItem(he,String(s))}function pt(){const t=parseFloat(localStorage.getItem(he)||"1");return isFinite(t)&&t>.6&&t<2?t:1}function xt(t,s=!0){const n=ft();return t in n?!!n[t]:s}function ft(){try{const t=localStorage.getItem(dt);return t?JSON.parse(t):{}}catch{return{}}}function gt(t){let s="none";t==="soft"&&(s="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(s="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",s),localStorage.setItem(pe,t)}function bt(){const t=localStorage.getItem(pe);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function jt(t){let s=8,n=16,a=20;t==="subtle"&&(s=6,n=10,a=14),t==="rounded"&&(s=12,n=18,a=24),document.documentElement.style.setProperty("--radius-lg",s+"px"),document.documentElement.style.setProperty("--radius-2xl",n+"px"),document.documentElement.style.setProperty("--radius-3xl",a+"px"),localStorage.setItem(xe,t)}function wt(){const t=localStorage.getItem(xe);return t==="subtle"||t==="rounded"?t:"standard"}function yt(t){const s=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",s+"px"),localStorage.setItem(fe,String(s))}function vt(){const t=parseInt(localStorage.getItem(fe)||"6",10);return isFinite(t)?t:6}function kt(t){const s=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",s+"ch"),localStorage.setItem(ge,String(s))}function Nt(){const t=parseInt(localStorage.getItem(ge)||"78",10);return isFinite(t)?t:78}function zt(){try{ut(mt()),ht(pt()),gt(bt()),jt(wt()),yt(vt()),kt(Nt())}catch{}}function N(t){return`${"/pravo/".replace(/\/$/,"")}${t}`}function St(){if(!xt("cmd_palette",!0))return null;const[s,n]=m.useState(!1),[a,r]=m.useState(""),[l,i]=m.useState(0),[u,c]=m.useState(()=>localStorage.getItem("cp_filter")||"all");m.useEffect(()=>{try{localStorage.setItem("cp_filter",u)}catch{}},[u]),m.useEffect(()=>{function o(x){(x.ctrlKey||x.metaKey)&&x.key.toLowerCase()==="k"&&(x.preventDefault(),n(!0),r(""),i(0)),s&&x.key==="Escape"&&n(!1)}return window.addEventListener("keydown",o),window.openCommandPalette=()=>{n(!0),r(""),i(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",o)}},[s]);const d=m.useMemo(()=>{const o=[];o.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Сервис",url:N("/favorites")}),o.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Сервис",url:N("/settings")});for(const p of ot)o.push({kind:"role",id:p.id,title:p.role,subtitle:"Роль",url:N(`/roles/${p.id}`)});for(const p of te)o.push({kind:"law",id:p.slug,title:p.title,subtitle:"Закон",url:N(`/laws/${p.slug}`)});for(const p of lt)o.push({kind:"vu",id:p.id,title:p.title,subtitle:"ВУ",url:N(`/vu/${p.id}`)});const x=a.trim().toLowerCase();return x&&o.push(...k(x).slice(0,60)),x?(u==="all"?o:o.filter(p=>p.kind===u)).map(p=>({r:p,score:h(`${p.title} ${p.subtitle||""}`.toLowerCase(),x)+(p.__boost||0)})).filter(p=>p.score>0).sort((p,I)=>I.score-p.score).slice(0,30).map(p=>p.r):o.slice(0,20)},[a,u]);function h(o,x){return x.split(/\s+/).filter(Boolean).reduce((p,I)=>p+(o.includes(I)?1:0),0)}function k(o){const x=[],M=g=>g.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80),p=(()=>{const g=o.match(/\bст(атья|\.)?\s*(\d{1,3})\b/i);return g?g[2]:null})();for(const g of te){const _e=(g.content||"").replace(/\r\n?/g,`
`).split(`
`);let C="",y="";const D=new Set;for(const Ae of _e){const E=Ae.trim(),q=/^(#{2,6})\s*(.+)$/.exec(E);if(q){C=q[2].trim(),y=M(C)||"";const z=C.toLowerCase();if(y&&(z.includes(o)||p&&z.match(new RegExp(`(^|s)ст(атья|.)?s*${p}\b`)))){const $=`${g.slug}#${y}`;if(!D.has($)){const T={kind:"law",id:$,title:`${g.title} — ${C}`,subtitle:"Раздел закона",url:N(`/laws/${g.slug}?q=${encodeURIComponent(o)}#${y}`)};T.__boost=z.startsWith(o)?8:6,x.push(T),D.add($)}}continue}if(E&&E.toLowerCase().includes(o)){const z=y?`${g.slug}#${y}`:g.slug;if(!D.has(z)){const J=E.length>140?E.slice(0,137)+"…":E,$=y?`${g.title} — ${C}`:g.title,T=N(y?`/laws/${g.slug}?q=${encodeURIComponent(o)}#${y}`:`/laws/${g.slug}?q=${encodeURIComponent(o)}`),Q={kind:"law",id:z,title:$,subtitle:J||"Совпадение в тексте",url:T};Q.__boost=5,x.push(Q),D.add(z)}}}}const I=new Set;return x.filter(g=>I.has(g.id)?!1:(I.add(g.id),!0))}function S(o){n(!1);try{window.location.href=o}catch{location.assign(o)}}function P(o){d.length&&(o.key==="ArrowDown"&&(o.preventDefault(),i(x=>Math.min(x+1,d.length-1))),o.key==="ArrowUp"&&(o.preventDefault(),i(x=>Math.max(x-1,0))),o.key==="Enter"&&(o.preventDefault(),S(d[l].url)))}return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Палитра команд",children:e.jsxs("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(Y,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:a,onChange:o=>{r(o.target.value),i(0)},onKeyDown:P,placeholder:"Роль, закон, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>n(!1),"aria-label":"Закрыть палитру",children:e.jsx(ce,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(o=>e.jsx("button",{onClick:()=>{c(o.k),i(0)},className:`chip ${u===o.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:o.label},o.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!d.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),d.map((o,x)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${x===l?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>i(x),onClick:()=>S(o.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[o.kind==="law"&&e.jsx(F,{className:"h-4 w-4"}),o.kind==="role"&&e.jsx(G,{className:"h-4 w-4"}),o.kind==="vu"&&e.jsx(U,{className:"h-4 w-4"}),o.kind==="page"&&(o.id==="settings"?e.jsx(H,{className:"h-4 w-4"}):e.jsx(X,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:o.title})]}),o.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:o.subtitle})]},`${o.kind}:${o.id}`))]})]})}):null})}const A={},It=(A==null?void 0:A.VITE_API_BASE)||(A==null?void 0:A.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function Et(){try{const t="anon_uid";let s=localStorage.getItem(t);return s||(s=crypto.randomUUID(),localStorage.setItem(t,s)),s}catch{return"na"}}function _t(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:Et()}}function At(t,s){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const r=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(r)==="1"||String(r)==="yes")return}catch{}const n=JSON.stringify({event:t,..._t(),data:s}),a=`${It}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const r=new Blob([n],{type:"application/json"});if(navigator.sendBeacon(a,r))return}catch{}try{fetch(a,{method:"POST",headers:{"content-type":"application/json"},body:n})}catch{}}const se="recent:items";function Pt(t,s){try{const n=localStorage.getItem(se),a=n?JSON.parse(n):[],r={url:t,title:s,ts:Date.now()};if(a.length&&a[0].url===t)return;const l=a.filter(c=>c.url!==t);l.unshift(r);const i=[],u=new Set;for(const c of l)u.has(c.url)||(u.add(c.url),i.push(c));for(;i.length>15;)i.pop();localStorage.setItem(se,JSON.stringify(i))}catch{}}const be=[{label:"Повышение",icon:e.jsx(G,{className:"h-4 w-4"}),id:"roles"},{label:"Шаблоны",icon:e.jsx(Be,{className:"h-4 w-4"}),id:"templates"},{label:"Посты",icon:e.jsx(Ve,{className:"h-4 w-4"}),id:"posts"},{label:"Процедуры",icon:e.jsx(Ke,{className:"h-4 w-4"}),id:"procedures"},{label:"Взаимодействия",icon:e.jsx(le,{className:"h-4 w-4"}),id:"interactions"},{label:"Проверки",icon:e.jsx(We,{className:"h-4 w-4"}),id:"checks"},{label:"Лекции",icon:e.jsx(F,{className:"h-4 w-4"}),id:"lectures"},{label:"ВУ",icon:e.jsx(U,{className:"h-4 w-4"}),id:"vu"},{label:"Законы",icon:e.jsx(F,{className:"h-4 w-4"}),id:"laws"}];function Ct(){const[t,s]=m.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),n=W(),a=m.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),r=m.useMemo(()=>{const h=(new URLSearchParams(n.search||"").get("tab")||"").toLowerCase(),k=(n.hash||"").replace(/^#/,"").toLowerCase();return h||k||""},[n.search,n.hash]),l=d=>r===d;m.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const h=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=h}}},[t]),m.useEffect(()=>{function d(){typeof window<"u"&&s(window.innerWidth>=1024)}return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]),m.useEffect(()=>{const d=document.documentElement;t?d.classList.add("has-sidebar"):d.classList.remove("has-sidebar")},[t]);const u=m.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[])?"⌘ K":"Ctrl K",c="inline-flex items-center rounded-md border px-1.5 py-0.5 text-[10px] font-medium shadow-sm border-zinc-300 bg-white/90 text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/90 dark:text-zinc-100 dark:shadow-none",f=d=>{const h=`?tab=${encodeURIComponent(d)}`;return a?{pathname:"/",search:h}:{pathname:"/",search:h,hash:`#${d}`}};return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>s(d=>!d),"aria-label":"Открыть меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsxs("aside",{id:"app-sidebar","aria-label":"Навигация",className:"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",children:[e.jsx("div",{className:"mb-3 flex items-center justify-start",children:e.jsx(j,{to:"/",className:`rounded font-semibold no-underline focus:outline-none focus:ring-2 focus:ring-zinc-400\r
                       text-zinc-900 hover:underline hover:text-zinc-900\r
                       dark:text-zinc-100 dark:hover:text-white`,"aria-label":"Главная",children:"Главная"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-140px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[be.map(d=>{const h=l(d.id);return e.jsx("li",{children:e.jsxs(j,{to:f(d.id),className:["flex items-center gap-2 rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-zinc-400","text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",h?"bg-zinc-100 dark:bg-zinc-800":""].join(" "),"aria-current":h?"page":void 0,"aria-label":d.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&s(!1)},children:[d.icon,e.jsx("span",{className:"truncate",children:d.label})]})},d.id)}),e.jsx("li",{children:e.jsxs(j,{to:"/about",className:["flex items-center gap-2 rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-zinc-400","text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",""].join(" "),"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&s(!1)},children:[e.jsx(oe,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})})]})}),e.jsxs("div",{className:"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",children:["Подсказка: нажмите ",e.jsx("kbd",{className:c,children:u})," для быстрого поиска"]})]})]})}const $t={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},je={entities:$t};function Rt(t){var n;return((n=je.entities)==null?void 0:n[t])||null}function us(t,s=30){const n=Rt(t);if(!(n!=null&&n.updated_at))return{recent:!1};const a=new Date(n.updated_at+"T00:00:00Z");return{recent:(Date.now()-a.getTime())/(1e3*60*60*24)<=s,date:n.updated_at}}function ms(t,s){const n=t.split(/\r?\n/),a=s.split(/\r?\n/),r=n.length,l=a.length,i=Array.from({length:r+1},()=>Array(l+1).fill(0));for(let d=r-1;d>=0;d--)for(let h=l-1;h>=0;h--)i[d][h]=n[d]===a[h]?i[d+1][h+1]+1:Math.max(i[d+1][h],i[d][h+1]);const u=[];let c=0,f=0;for(;c<r&&f<l;)n[c]===a[f]?(u.push(R(n[c])),c++,f++):i[c+1][f]>=i[c][f+1]?(u.push(`<del>${R(n[c])}</del>`),c++):(u.push(`<ins>${R(a[f])}</ins>`),f++);for(;c<r;)u.push(`<del>${R(n[c++])}</del>`);for(;f<l;)u.push(`<ins>${R(a[f++])}</ins>`);return u.join(`
`)}function R(t){return t.replace(/[&<>]/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[s])}function Lt(){var n;const t=[],s=je.entities||{};for(const[a,r]of Object.entries(s)){const l=(n=r.changelog)==null?void 0:n[0];l&&t.push({id:a,version:l.version,date:l.date,summary:l.summary,details:l.details})}return t.sort((a,r)=>a.date<r.date?1:-1),t}function Mt(){const t=m.useMemo(()=>{try{const n=Lt()[0];if(!n)return!1;const a=new Date(n.date+"T00:00:00Z");return(Date.now()-a.getTime())/864e5<=14}catch{return!1}},[]);function s(){const n=window.openCommandPalette;if(typeof n=="function")try{n();return}catch{}const a=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!a,metaKey:a}))}return e.jsx("div",{className:"sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",children:e.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var n;return(n=window.openMobileMenu)==null?void 0:n.call(window)},"aria-label":"Меню",children:e.jsx(Ue,{className:"h-4 w-4"})}),e.jsx(Ge,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:s,"aria-label":"Поиск",children:[e.jsx(Y,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(j,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),t&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(j,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(X,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(j,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(H,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(le,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]})})}const Dt="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",ne="notif:lastSeen";function Tt(){const[t,s]=m.useState(!1),[n,a]=m.useState([]),[r,l]=m.useState(0);async function i(){try{const c=await fetch(Dt,{cache:"no-store"});if(!c.ok)return;const f=await c.json(),d=Array.isArray(f)?f:f.items||[];d.sort((P,o)=>new Date(o.date||0).getTime()-new Date(P.date||0).getTime()),a(d);const h=localStorage.getItem(ne)||"",k=h?d.findIndex(P=>P.id===h):-1,S=k===-1?d.length:k;l(Math.max(0,S))}catch{}}m.useEffect(()=>{i()},[]);function u(){if(s(c=>!c),!t&&n.length)try{localStorage.setItem(ne,n[0].id),l(0)}catch{}}return e.jsxs("div",{className:"relative",children:[e.jsxs("button",{className:"btn btn-secondary relative",onClick:u,"aria-label":"Уведомления",children:[e.jsx(Ye,{className:"h-4 w-4"}),r>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:r})]}),t&&e.jsxs("div",{className:"absolute right-0 mt-2 w-80 rounded-2xl border border-zinc-200 bg-white p-2 text-sm shadow-soft dark:border-zinc-700 dark:bg-zinc-900",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),n.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:n.map(c=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block",href:c.url||"#",target:c.url?"_blank":void 0,rel:c.url?"noreferrer":void 0,children:[c.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:c.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:c.text}),c.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:new Date(c.date).toLocaleString()})]})},c.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function Ft(){const[t,s]=m.useState(!1),n=W();m.useEffect(()=>(window.openMobileMenu=()=>s(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),m.useEffect(()=>{if(!t)return;const i=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=i}},[t]);const a=m.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),r=i=>{const u=new URLSearchParams(n.search||"");u.set("tab",i);const c=`?${u.toString()}`;return a?{pathname:"/",search:c}:{pathname:"/",search:c,hash:`#${i}`}};function l(){const i=window.openCommandPalette;if(typeof i=="function")try{i()}catch{}s(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>s(!1),"aria-hidden":!0}),e.jsxs("div",{className:"absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:l,"aria-label":"Поиск",children:[e.jsx(Y,{className:"h-4 w-4"})," ",e.jsx("span",{children:"Поиск"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"Меню"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>s(!1),"aria-label":"Закрыть",children:e.jsx(ce,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:be.map(i=>e.jsx("li",{children:e.jsxs(j,{to:r(i.id),className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>s(!1),children:[i.icon,e.jsx("span",{className:"truncate",children:i.label})]})},i.id))}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(j,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(X,{className:"h-4 w-4"})," Избранное"]}),e.jsxs(j,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(H,{className:"h-4 w-4"})," Настройки"]})]})]})]})]}):null}const Ot=m.lazy(()=>v(()=>import("./GovCheatsheetSky-DJvQIOrz.js"),__vite__mapDeps([0,1,2,3,4]))),Bt=m.lazy(()=>v(()=>import("./WhatsNew-6utgrzvo.js"),__vite__mapDeps([5,1,2]))),Vt=m.lazy(()=>v(()=>import("./DiffPage-C_3xVvxu.js"),__vite__mapDeps([6,1,2]))),Kt=m.lazy(()=>v(()=>import("./PrintSheet-C5xyavLr.js"),__vite__mapDeps([7,1,2]))),Wt=m.lazy(()=>v(()=>import("./RolePage-CMOWgyYb.js"),__vite__mapDeps([8,1,3,2,9]))),Ut=m.lazy(()=>v(()=>import("./LawPage-S6LfuFJC.js"),__vite__mapDeps([10,1,9,2]))),Gt=m.lazy(()=>v(()=>import("./VuPage-wgyXIKWW.js"),__vite__mapDeps([11,1,2]))),Yt=m.lazy(()=>v(()=>import("./SettingsPage-5FRiE__j.js"),__vite__mapDeps([12,1,4,2]))),Ht=m.lazy(()=>v(()=>import("./FavoritesPage-CtQ0cohO.js"),__vite__mapDeps([13,1,9,2])));function Xt(){const t=W();return ie.useEffect(()=>{At("page_view");try{Pt(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function qt(){return e.jsxs($e,{basename:"/pravo/",children:[e.jsx(St,{}),e.jsx(Ct,{}),e.jsx(Mt,{}),e.jsx(Ft,{}),e.jsx("div",{className:"fixed right-2 top-16 z-40 sm:top-2",children:e.jsx(Tt,{})}),e.jsx(Xt,{}),e.jsx(m.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-500",children:"Загрузка…"}),children:e.jsxs(Re,{children:[e.jsx(w,{path:"/",element:e.jsx(Ot,{})}),e.jsx(w,{path:"/whats-new",element:e.jsx(Bt,{})}),e.jsx(w,{path:"/diff/:id",element:e.jsx(Vt,{})}),e.jsx(w,{path:"/print",element:e.jsx(Kt,{})}),e.jsx(w,{path:"/roles/:id",element:e.jsx(Wt,{})}),e.jsx(w,{path:"/laws/:slug",element:e.jsx(Ut,{})}),e.jsx(w,{path:"/vu/:id",element:e.jsx(Gt,{})}),e.jsx(w,{path:"/recorders/:id",element:e.jsx(at,{})}),e.jsx(w,{path:"/about",element:e.jsx(it,{})}),e.jsx(w,{path:"/settings",element:e.jsx(Yt,{})}),e.jsx(w,{path:"/favorites",element:e.jsx(Ht,{})})]})})]})}const we="theme",ye="accent",ve="accent_custom",ke="bg",Jt="bg_custom",Ne={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var ae,re;const V=((re=(ae=import.meta)==null?void 0:ae.env)==null?void 0:re.BASE_URL)??"/",L=t=>{const s=t.replace(/^\/+/,"");return(V.endsWith("/")?V:V+"/")+s},ze={bg1:L("img/bg1.png"),bg2:L("img/bg2.png"),bg3:L("img/bg3.png"),bg4:L("img/bg4.png"),bg5:L("img/bg5.png")};function Qt(){const t=localStorage.getItem(we);return t==="light"||t==="dark"?t:null}function Zt(){const t=localStorage.getItem(ye);return t?t==="custom"?"custom":t in Ne?t:null:null}function es(){return localStorage.getItem(ve)}function ts(){const t=localStorage.getItem(ke);return t&&(t==="none"||t==="custom"||t in ze)?t:null}function ss(){return localStorage.getItem(Jt)}function ns(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function as(t){const s=document.documentElement;t==="dark"?s.classList.add("dark"):s.classList.remove("dark"),localStorage.setItem(we,t);const n=t==="dark"?"#0a0a0a":"#fafafa";let a=document.querySelector('meta[name="theme-color"]');a||(a=document.createElement("meta"),a.name="theme-color",document.head.appendChild(a)),a.setAttribute("content",n);try{s.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function Se(t){if(t==="custom"){const s=es()||"#6366F1";document.documentElement.style.setProperty("--accent",s);const n=os(s,-.15);document.documentElement.style.setProperty("--accent-600",n)}else{const s=Ne[t];document.documentElement.style.setProperty("--accent",s[500]),document.documentElement.style.setProperty("--accent-600",s[600])}localStorage.setItem(ye,t)}function hs(t){localStorage.setItem(ve,Ie(t)),Se("custom")}function rs(t){const s=document.body,a=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")s.style.backgroundImage="",s.style.backgroundSize="",s.style.backgroundRepeat="",s.style.backgroundAttachment="",s.style.backgroundPosition="";else if(t==="custom"){const r=ss();r?(s.style.backgroundImage=`url(${r})`,s.style.backgroundSize="cover",s.style.backgroundRepeat="no-repeat",s.style.backgroundAttachment=a,s.style.backgroundPosition="center"):s.style.backgroundImage=""}else{const r=ze[t];s.style.backgroundImage=`url(${r})`,s.style.backgroundSize="cover",s.style.backgroundRepeat="no-repeat",s.style.backgroundAttachment=a,s.style.backgroundPosition="center"}localStorage.setItem(ke,t)}function is(){const s=Qt()??(ns()?"dark":"light");as(s);const n=Zt()??"indigo";Se(n);const a=ts()??"none";rs(a)}function Ie(t){let s=t.trim();if(s.startsWith("#")||(s=`#${s}`),s.length===4){const n=s[1],a=s[2],r=s[3];s=`#${n}${n}${a}${a}${r}${r}`}return s}function os(t,s){const n=Ie(t).slice(1),a=parseInt(n,16);let r=a>>16&255,l=a>>8&255,i=a&255;r=Math.max(0,Math.min(255,Math.round(r+255*s))),l=Math.max(0,Math.min(255,Math.round(l+255*s))),i=Math.max(0,Math.min(255,Math.round(i+255*s)));const u=c=>c.toString(16).padStart(2,"0");return`#${u(r)}${u(l)}${u(i)}`}(function(){try{const s="app:version",n=localStorage.getItem(s),a="1757884997781";if(n&&n!==a){"caches"in window?caches.keys().then(r=>Promise.all(r.map(l=>caches.delete(l)))).finally(()=>{localStorage.setItem(s,a),location.reload()}):(localStorage.setItem(s,a),location.reload());return}localStorage.setItem(s,a)}catch{}})();is();zt();function Ee(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}Ee();window.addEventListener("resize",Ee,{passive:!0});K.createRoot(document.getElementById("root")).render(e.jsx(m.StrictMode,{children:e.jsx(qt,{})}));export{Ne as A,ze as B,rt as C,ot as a,Rt as b,Zt as c,ms as d,mt as e,pt as f,Lt as g,bt as h,us as i,e as j,wt as k,te as l,vt as m,as as n,Se as o,hs as p,gt as q,st as r,ns as s,jt as t,yt as u,lt as v,ut as w,ht as x};
