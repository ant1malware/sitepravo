const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-BwuWWL3r.js","assets/react-vendor-DTkXckhQ.js","assets/icons-DpAAz4P9.js","assets/VoteWidget-DsFPnaAp.js","assets/asset-ClJDRudC.js","assets/WhatsNew-DAK9y172.js","assets/DiffPage-C1WjqM4K.js","assets/LiquidGlassShowcase-NyCVt1dh.js","assets/PrintSheet-BDQlWPhD.js","assets/RolePage-C08uCMxD.js","assets/FavStar-Bqf_6E-c.js","assets/LawPage-DCGPGxXA.js","assets/VuPage-0y-dYuiC.js","assets/BuddyPlayground-BA4Sehas.js","assets/HomePage-B4oAVIso.js","assets/SettingsPage-D7efyZrR.js","assets/FavoritesPage-BeF2wsTn.js"])))=>i.map(i=>d[i]);
import{r as we,a as ot,u as lt,L as M,R as d,b as Y,B as ct,c as dt,d as I}from"./react-vendor-DTkXckhQ.js";import{A as ut,E as mt,I as je,C as pt,Q as ht,R as gt,B as U,S as ae,H as xt,U as re,a as ie,X as ke,b as oe,c as le,G as ft,d as bt,F as yt,L as vt,e as wt,M as Ne,f as jt,g as kt,h as Nt,i as St}from"./icons-DpAAz4P9.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(r){if(r.ep)return;r.ep=!0;const l=s(r);fetch(r.href,l)}})();var Se={exports:{}},H={};/**
 * @license React
...
`,Ot=[{id:"gov",title:"Внутренний устав Правительства",text:Ft,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],ze="ui:density",_e="ui:font",qt="ui:features",Ie="ui:shadow",Me="ui:radius",Le="ui:glass",Pe="ui:readw",Re="ui:anim";function Kt(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),localStorage.setItem(ze,t)}function Vt(){return localStorage.getItem(ze)==="compact"?"compact":"standard"}function Wt(t){const n=Math.max(.9,Math.min(1.3,t)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),localStorage.setItem(_e,String(n))}function Gt(){const t=parseFloat(localStorage.getItem(_e)||"1");return isFinite(t)&&t>.6&&t<2?t:1}function Ut(t,n=!0){const s=Yt();return t in s?!!s[t]:n}function Yt(){try{const t=localStorage.getItem(qt);return t?JSON.parse(t):{}}catch{return{}}}function Ht(t){let n="none";t==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),localStorage.setItem(Ie,t)}function Xt(){const t=localStorage.getItem(Ie);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function Qt(t){let n=8,s=16,a=20;t==="subtle"&&(n=6,s=10,a=14),t==="rounded"&&(n=12,s=18,a=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",a+"px"),localStorage.setItem(Me,t)}function Jt(){const t=localStorage.getItem(Me);return t==="subtle"||t==="rounded"?t:"standard"}function Zt(t){const n=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",n+"px"),localStorage.setItem(Le,String(n))}function en(){const t=parseInt(localStorage.getItem(Le)||"6",10);return isFinite(t)?t:6}function tn(t){const n=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",n+"ch"),localStorage.setItem(Pe,String(n))}function nn(){const t=parseInt(localStorage.getItem(Pe)||"78",10);return isFinite(t)?t:78}function sn(){try{Kt(Vt()),Wt(Gt()),Ht(Xt()),Qt(Jt()),Zt(en()),tn(nn()),an(rn())}catch{}}function an(t){document.documentElement.classList.toggle("anim-off",!t);try{localStorage.setItem(Re,t?"1":"0")}catch{}}function rn(){try{return localStorage.getItem(Re)!=="0"}catch{return!0}}const Ae={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},_={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function Ce(...t){return t.filter(Boolean).join(" ")}function $e(){const[t,n]=d.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return d.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),a=r=>n(r.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",a),()=>s.removeEventListener("change",a)):typeof s.addListener=="function"?(s.addListener(a),()=>s.removeListener(a)):()=>{}},[]),t}function Te(t,n){d.useEffect(()=>{const s=t.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let a=0,r=72,l=18;const i=()=>{a=0;const x=t.current;x&&(x.style.setProperty("--lg-x",`${r}%`),x.style.setProperty("--lg-y",`${l}%`))},o=x=>{const v=t.current;if(!v)return;const p=v.getBoundingClientRect(),w=(x.clientX-p.left)/p.width*100,k=(x.clientY-p.top)/p.height*100;r=Math.max(0,Math.min(100,w)),l=Math.max(0,Math.min(100,k)),a||(a=window.requestAnimationFrame(i))},u=()=>{r=72,l=18,a||(a=window.requestAnimationFrame(i))};return s.addEventListener("pointermove",o,{passive:!0}),s.addEventListener("pointerdown",o,{passive:!0}),s.addEventListener("pointerenter",o,{passive:!0}),s.addEventListener("pointerleave",u),()=>{a&&window.cancelAnimationFrame(a),s.removeEventListener("pointermove",o),s.removeEventListener("pointerdown",o),s.removeEventListener("pointerenter",o),s.removeEventListener("pointerleave",u)}},[t,n])}function he(t){if(!t)return[255,255,255];const n=t.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function G(t){return`${t[0]} ${t[1]} ${t[2]}`}function J(t,n,s){return Math.round(t+(n-t)*s)}function ge(t,n){return[J(t[0],n>=0?255:0,Math.abs(n)),J(t[1],n>=0?255:0,Math.abs(n)),J(t[2],n>=0?255:0,Math.abs(n))]}function on(t,n,s){const a=t?Ae[t]:n??_.tint,r=s??_.accent,l=he(a),i=he(r),o=ge(i,.25),u=ge(i,-.55);return{tintRgb:G(l),accentRgb:G(i),accentSoftRgb:G(o),accentDeepRgb:G(u)}}function De(t,n){const s={...t??{}},{tintRgb:a,accentRgb:r,accentSoftRgb:l,accentDeepRgb:i}=on(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=a,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=r,s["--lg-accent-soft"]=l,s["--lg-accent-deep"]=i,s}const Be=d.forwardRef((t,n)=>{const{blur:s=_.blur,tint:a=_.tint,opacity:r=_.opacity,gloss:l=_.gloss,border:i=_.border,glints:o=_.glints,interactive:u=_.interactive,animate:x=_.animate,elevation:v=_.elevation,tone:p,accent:w=_.accent,className:k,style:f,children:m,...b}=t,c=$e(),h=u&&!c,E=d.useRef(null),g=d.useCallback(j=>{E.current=j,typeof n=="function"?n(j):n&&(n.current=j),j&&(j.style.setProperty("--lg-x","72%"),j.style.setProperty("--lg-y","18%"))},[n]);Te(E,h);const y=d.useMemo(()=>De(f,{blur:s,tint:a,opacity:r,gloss:l,border:i,elevation:v,glints:o,tone:p,accent:w}),[f,s,a,r,l,i,v,o,p,w]),z={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*v}px ${50*v}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return e.jsxs("div",{ref:g,className:Ce("liquid-glass",k),"data-animate":x?"true":"false","data-interactive":h?"true":"false",style:{...z,...y},...b,children:[e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),o&&e.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),e.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),h&&e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),e.jsx("div",{style:{position:"relative",zIndex:10},children:m}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:i,pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Be.displayName="LiquidGlass";const Fe=d.forwardRef((t,n)=>{const{className:s,style:a,children:r,type:l,blur:i,tint:o,opacity:u,gloss:x,border:v,glints:p,interactive:w,animate:k,elevation:f,tone:m,accent:b=_.accent,...c}=t,h=i??_.blur,E=m?Ae[m]:o??_.tint,g=u??.16,y=x??.9,z=v??.6,j=p??!1,P=w??!0,N=f??1,R=$e(),B=P&&!R,A=d.useRef(null),W=d.useCallback(S=>{A.current=S,typeof n=="function"?n(S):n&&(n.current=S),S&&(S.style.setProperty("--lg-x","70%"),S.style.setProperty("--lg-y","16%"))},[n]);Te(A,B);const $=d.useMemo(()=>De(a,{blur:h,tint:E,opacity:g,gloss:y,border:z,glints:j,elevation:N,tone:m,accent:b}),[a,h,E,g,y,z,j,N,m,b]),D={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*N}px ${18*N}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return e.jsxs("button",{ref:W,type:l??"button",className:Ce("liquid-glass liquid-glass__button",s),style:{...D,...$},...c,onMouseDown:S=>{S.currentTarget.style.transform="scale(0.985)"},onMouseUp:S=>{S.currentTarget.style.transform=""},onMouseLeave:S=>{S.currentTarget.style.transform=""},children:[e.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[e.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),e.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),e.jsx("span",{style:{position:"relative",zIndex:1},children:r}),e.jsx("style",{children:`
      ...
      `})]})});Fe.displayName="LiquidGlass.Button";const V=Be;V.Button=Fe;const Oe="theme",qe="accent",Ke="accent_custom",Ve="bg",ln="bg_custom",We="ui:style-mode",Z="ui:liquid:prev-theme",Ge="ui:liquid:tone",Ue={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var ye,ve;const ee=((ve=(ye=import.meta)==null?void 0:ye.env)==null?void 0:ve.BASE_URL)??"/",q=t=>{const n=t.replace(/^\/+/,"");return(ee.endsWith("/")?ee:ee+"/")+n},Ye={bg1:q("img/bg1.png"),bg2:q("img/bg2.png"),bg3:q("img/bg3.png"),bg4:q("img/bg4.png"),bg5:q("img/bg5.png")};function He(){const t=localStorage.getItem(Oe);return t==="light"||t==="dark"?t:null}function cn(){const t=localStorage.getItem(qe);return t?t==="custom"?"custom":t in Ue?t:null:null}function dn(){return localStorage.getItem(Ke)}function Xe(){const t=localStorage.getItem(Ve);return t&&(t==="none"||t==="custom"||t in Ye)?t:null}function un(){return localStorage.getItem(ln)}function Qe(){const t=localStorage.getItem(We);return t==="classic"||t==="liquid"||t==="beta"?t:null}function mn(){return(localStorage.getItem(Ge)||"dark")==="light"?"light":"dark"}function pn(t){try{localStorage.setItem(Ge,t)}catch{}const n=document.documentElement;if(n.classList.toggle("liquid-light",t==="light"),n.classList.toggle("liquid-dark",t!=="light"),n.classList.contains("theme-liquid"))try{ce(t==="light"?"light":"dark")}catch{}}function Je(t){const n=document.documentElement;if(n.classList.toggle("theme-liquid",t==="liquid"),n.classList.toggle("theme-beta",t==="beta"),n.dataset.styleMode=t,t==="liquid"||t==="beta"){try{const s=He()??(Ze()?"dark":"light");localStorage.setItem(Z,s);const a=mn();pn(a)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=localStorage.getItem(Z);(s==="light"||s==="dark")&&ce(s),localStorage.removeItem(Z)}catch{}try{const s=Xe()??"none";tt(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}try{localStorage.setItem(We,t)}catch{}}function Ze(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function ce(t){const n=document.documentElement;t==="dark"?n.classList.add("dark"):n.classList.remove("dark"),localStorage.setItem(Oe,t);const s=t==="dark"?"#0a0a0a":"#fafafa";let a=document.querySelector('meta[name="theme-color"]');a||(a=document.createElement("meta"),a.name="theme-color",document.head.appendChild(a)),a.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function et(t){if(t==="custom"){const n=dn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=gn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=Ue[t];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}localStorage.setItem(qe,t)}function Hn(t){localStorage.setItem(Ke,nt(t)),et("custom")}function tt(t){const n=document.body,a=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(t==="custom"){const r=un();r?(n.style.backgroundImage=`url(${r})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=a,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const r=Ye[t];n.style.backgroundImage=`url(${r})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=a,n.style.backgroundPosition="center"}localStorage.setItem(Ve,t)}function hn(){const n=He()??(Ze()?"dark":"light");ce(n);const s=cn()??"indigo";et(s);const a=Xe()??"none";tt(a);const r=Qe()??"classic";Je(r)}function nt(t){let n=t.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],a=n[2],r=n[3];n=`#${s}${s}${a}${a}${r}${r}`}return n}function gn(t,n){const s=nt(t).slice(1),a=parseInt(s,16);let r=a>>16&255,l=a>>8&255,i=a&255;r=Math.max(0,Math.min(255,Math.round(r+255*n))),l=Math.max(0,Math.min(255,Math.round(l+255*n))),i=Math.max(0,Math.min(255,Math.round(i+255*n)));const o=u=>u.toString(16).padStart(2,"0");return`#${o(r)}${o(l)}${o(i)}`}function xe(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid"||t==="beta")return t}try{return Qe()??"classic"}catch{return"classic"}}function X(){const[t,n]=d.useState(()=>xe());d.useEffect(()=>{const a=()=>{const i=xe();n(o=>o===i?o:i)},r=i=>{const o=i.detail;o==="classic"||o==="liquid"||o==="beta"?n(o):a()};window.addEventListener("stylemodechange",r);const l=new MutationObserver(a);return l.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",r),l.disconnect()}},[]);const s=d.useCallback(a=>{Je(a),n(a)},[]);return[t,s]}function T(t){return`${"/betatestik/".replace(/\/$/,"")}${t}`}function xn(){if(!Ut("cmd_palette",!0))return null;const[n]=X(),[s,a]=d.useState(!1),[r,l]=d.useState(""),[i,o]=d.useState(0),[u,x]=d.useState(()=>localStorage.getItem("cp_filter")||"all");d.useEffect(()=>{try{localStorage.setItem("cp_filter",u)}catch{}},[u]),d.useEffect(()=>{function c(h){(h.ctrlKey||h.metaKey)&&h.key.toLowerCase()==="k"&&(h.preventDefault(),a(!0),l(""),o(0)),s&&h.key==="Escape"&&a(!1)}return window.addEventListener("keydown",c),window.openCommandPalette=()=>{a(!0),l(""),o(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",c)}},[s]);const p=d.useMemo(()=>{const c=[];c.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Страница",url:T("/favorites")}),c.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Страница",url:T("/settings")});for(const g of Bt)c.push({kind:"role",id:g.id,title:g.role,subtitle:"Раздел",url:T(`/roles/${g.id}`)});for(const g of pe)c.push({kind:"law",id:g.slug,title:g.title,subtitle:"Закон",url:T(`/laws/${g.slug}`)});for(const g of Ot)c.push({kind:"vu",id:g.id,title:g.title,subtitle:"ВУ",url:T(`/vu/${g.id}`)});const h=r.trim().toLowerCase();return h&&c.push(...k(h).slice(0,60)),h?(u==="all"?c:c.filter(g=>g.kind===u)).map(g=>({r:g,score:w(`${g.title} ${g.subtitle||""}`.toLowerCase(),h)+(g.__boost||0)})).filter(g=>g.score>0).sort((g,y)=>y.score-g.score).slice(0,30).map(g=>g.r):c.slice(0,20)},[r,u]);function w(c,h){return h.split(/\s+/).filter(Boolean).reduce((g,y)=>g+(c.includes(y)?1:0),0)}function k(c){const h=[],E=y=>y.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const y of pe){const j=(y.content||"").replace(/\r\n?/g,`
`).split(`
`);let P="",N="";const R=new Set;for(const B of j){const A=B.trim(),W=/^(#{2,6})\s*(.+)$/.exec(A);if(W){P=W[2].trim(),N=E(P)||"";const $=P.toLowerCase();if(N&&$.includes(c)){const D=`${y.slug}#${N}`;if(!R.has(D)){const S={kind:"law",id:D,title:`${y.title} — ${P}`,subtitle:"Заголовок",url:T(`/laws/${y.slug}?q=${encodeURIComponent(c)}#${N}`)};S.__boost=$.startsWith(c)?8:6,h.push(S),R.add(D)}}continue}if(A&&A.toLowerCase().includes(c)){const $=N?`${y.slug}#${N}`:y.slug;if(!R.has($)){const D=A.length>140?A.slice(0,137)+"…":A,S=N?`${y.title} — ${P}`:y.title,it=T(N?`/laws/${y.slug}?q=${encodeURIComponent(c)}#${N}`:`/laws/${y.slug}?q=${encodeURIComponent(c)}`),de={kind:"law",id:$,title:S,subtitle:D||"Контекст",url:it};de.__boost=5,h.push(de),R.add($)}}}}const g=new Set;return h.filter(y=>g.has(y.id)?!1:(g.add(y.id),!0))}function f(c){a(!1);try{window.location.href=c}catch{location.assign(c)}}function m(c){p.length&&(c.key==="ArrowDown"&&(c.preventDefault(),o(h=>Math.min(h+1,p.length-1))),c.key==="ArrowUp"&&(c.preventDefault(),o(h=>Math.max(h-1,0))),c.key==="Enter"&&(c.preventDefault(),f(p[i].url)))}const b=({children:c})=>n==="liquid"?e.jsx(V,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:c}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:c});return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Поиск",children:e.jsxs(b,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(ie,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:r,onChange:c=>{l(c.target.value),o(0)},onKeyDown:m,placeholder:"Поиск: закон, роль, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>a(!1),"aria-label":"Закрыть",children:e.jsx(ke,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(c=>e.jsx("button",{onClick:()=>{x(c.k),o(0)},className:`chip ${u===c.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:c.label},c.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!p.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),p.map((c,h)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${h===i?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>o(h),onClick:()=>f(c.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[c.kind==="law"&&e.jsx(U,{className:"h-4 w-4"}),c.kind==="role"&&e.jsx(re,{className:"h-4 w-4"}),c.kind==="vu"&&e.jsx(ae,{className:"h-4 w-4"}),c.kind==="page"&&(c.id==="settings"?e.jsx(oe,{className:"h-4 w-4"}):e.jsx(le,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:c.title})]}),c.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:c.subtitle})]},`${c.kind}:${c.id}`))]})]})}):null})}const O={},fn=(O==null?void 0:O.VITE_API_BASE)||(O==null?void 0:O.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function bn(){try{const t="anon_uid";let n=localStorage.getItem(t);return n||(n=crypto.randomUUID(),localStorage.setItem(t,n)),n}catch{return"na"}}function yn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:bn()}}function vn(t,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const r=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(r)==="1"||String(r)==="yes")return}catch{}const s=JSON.stringify({event:t,...yn(),data:n}),a=`${fn}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const r=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(a,r))return}catch{}try{fetch(a,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const fe="recent:items";function wn(t,n){try{const s=localStorage.getItem(fe),a=s?JSON.parse(s):[],r={url:t,title:n,ts:Date.now()};if(a.length&&a[0].url===t)return;const l=a.filter(u=>u.url!==t);l.unshift(r);const i=[],o=new Set;for(const u of l)o.has(u.url)||(o.add(u.url),i.push(u));for(;i.length>15;)i.pop();localStorage.setItem(fe,JSON.stringify(i))}catch{}}const st=[{key:"home",type:"route",label:"Главная",icon:e.jsx(bt,{className:"h-4 w-4"}),to:"/home"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(re,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(yt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(vt,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx(wt,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(Ne,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(jt,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(U,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(ae,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(U,{className:"h-4 w-4"}),id:"laws"}];function jn(){const[t,n]=d.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=Y(),[a]=X(),r=d.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),l=d.useMemo(()=>{const b=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),c=(s.hash||"").replace(/^#/,"").toLowerCase();return b||c||""},[s.search,s.hash]),i=d.useCallback(m=>l===m,[l]);d.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const b=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=b}}},[t]),d.useEffect(()=>{function m(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[]),d.useEffect(()=>{const m=document.documentElement;t?m.classList.add("has-sidebar"):m.classList.remove("has-sidebar")},[t]);const o=d.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),u=o?"⌘ K":"Ctrl K",x=a==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",v=a==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",p=a==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",w=a==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",k=m=>{const b=`?tab=${encodeURIComponent(m)}`;return r?{pathname:"/",search:b}:{pathname:"/",search:b,hash:`#${m}`}},f=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(M,{to:"/home",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[st.map(m=>{const b=m.type==="route"?s.pathname===m.to:i(m.id),c=m.type==="route"?m.to:k(m.id);return e.jsx("li",{children:e.jsxs(M,{to:c,className:[x,b?v:""].filter(Boolean).join(" "),"aria-current":b?"page":void 0,"aria-label":m.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[m.icon,e.jsx("span",{className:"truncate",children:m.label})]})},m.key)}),e.jsx("li",{children:e.jsxs(M,{to:"/about",className:x,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(je,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(M,{to:"/buddy",className:x,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(ft,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:p,children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:u}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(m=>!m),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:w,children:a==="liquid"?e.jsx(V,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:f}):f})]})}const kn={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},at={entities:kn};function Nn(t){var s;return((s=at.entities)==null?void 0:s[t])||null}function Xn(t,n=30){const s=Nn(t);if(!(s!=null&&s.updated_at))return{recent:!1};const a=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-a.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function Qn(t,n){const s=t.split(/\r?\n/),a=n.split(/\r?\n/),r=s.length,l=a.length,i=Array.from({length:r+1},()=>Array(l+1).fill(0));for(let v=r-1;v>=0;v--)for(let p=l-1;p>=0;p--)i[v][p]=s[v]===a[p]?i[v+1][p+1]+1:Math.max(i[v+1][p],i[v][p+1]);const o=[];let u=0,x=0;for(;u<r&&x<l;)s[u]===a[x]?(o.push(K(s[u])),u++,x++):i[u+1][x]>=i[u][x+1]?(o.push(`<del>${K(s[u])}</del>`),u++):(o.push(`<ins>${K(a[x])}</ins>`),x++);for(;u<r;)o.push(`<del>${K(s[u++])}</del>`);for(;x<l;)o.push(`<ins>${K(a[x++])}</ins>`);return o.join(`
`)}function K(t){return t.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function Sn(){var s;const t=[],n=at.entities||{};for(const[a,r]of Object.entries(n)){const l=(s=r.changelog)==null?void 0:s[0];l&&t.push({id:a,version:l.version,date:l.date,summary:l.summary,details:l.details})}return t.sort((a,r)=>a.date<r.date?1:-1),t}function En(){const[t]=X(),n=d.useMemo(()=>{try{const i=Sn()[0];if(!i)return!1;const o=new Date(i.date+"T00:00:00Z");return(Date.now()-o.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function s(){const i=window.openCommandPalette;if(typeof i=="function")try{i();return}catch{}const o=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!o,metaKey:o}))}const a="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",r=t==="liquid"||t==="beta"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",l=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var i;return(i=window.openMobileMenu)==null?void 0:i.call(window)},"aria-label":"Меню",children:e.jsx(kt,{className:"h-4 w-4"})}),e.jsx(Nt,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:s,"aria-label":"Поиск",children:[e.jsx(ie,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(M,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),n&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(M,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(le,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(M,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(oe,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(Ne,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]});return e.jsx("div",{className:r,children:t==="liquid"?e.jsx(V,{className:`${a} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:l}):e.jsx("div",{className:a,children:l})})}const zn="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",te="notif:lastSeen",be="notifications-panel";function _n(){const[t,n]=d.useState(!1),[s,a]=d.useState([]),[r,l]=d.useState(0),[i,o]=d.useState(!1),[u,x]=d.useState(null),v=d.useRef(null),p=d.useCallback(async()=>{const f=new AbortController;o(!0),x(null);try{const m=await fetch(zn,{cache:"no-store",signal:f.signal});if(!m.ok)throw new Error(`HTTP ${m.status}`);const b=await m.json(),c=Array.isArray(b)?b:b.items||[],h=z=>z?new Date(z).getTime():0;c.sort((z,j)=>h(j.date)-h(z.date)),a(c);const E=typeof localStorage<"u"&&localStorage.getItem(te)||"",g=E?c.findIndex(z=>z.id===E):-1,y=g===-1?c.length:g;l(Math.max(0,y))}catch(m){(m==null?void 0:m.name)!=="AbortError"&&x("Не удалось загрузить уведомления")}finally{o(!1)}return()=>f.abort()},[]);d.useEffect(()=>{p()},[p]),d.useEffect(()=>{if(t&&s.length)try{localStorage.setItem(te,s[0].id),l(0)}catch{}},[t,s]),d.useEffect(()=>{if(!t)return;const f=b=>{v.current&&(v.current.contains(b.target)||n(!1))},m=b=>{b.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",f),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",f),document.removeEventListener("keydown",m)}},[t]);const w=()=>n(f=>!f),k=f=>f?new Date(f).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:v,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:w,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":be,children:[e.jsx(St,{className:"h-4 w-4"}),r>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:r})]}),t&&e.jsxs(V,{id:be,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),i?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):u?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:u}):s.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(f=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:f.url||"#",target:f.url?"_blank":void 0,rel:f.url?"noreferrer":void 0,onClick:()=>{var m;try{(m=s[0])!=null&&m.id&&localStorage.setItem(te,s[0].id),l(0)}catch{}},children:[f.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:f.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:f.text}),f.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:k(f.date)})]})},f.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function In(){const[t,n]=d.useState(!1),s=Y();d.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),d.useEffect(()=>{if(!t)return;const i=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=i}},[t]);const a=d.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),r=i=>{const o=new URLSearchParams(s.search||"");o.set("tab",i);const u=`?${o.toString()}`;return a?{pathname:"/",search:u}:{pathname:"/",search:u,hash:`#${i}`}};function l(){const i=window.openCommandPalette;if(typeof i=="function")try{i()}catch{}n(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:l,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(ie,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(ke,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:st.map(i=>{const o=i.type==="route"?i.to:r(i.id);return e.jsx("li",{children:e.jsxs(M,{to:o,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[i.icon,e.jsx("span",{className:"truncate",children:i.label})]})},i.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(M,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(le,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(M,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(oe,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const ne=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!"];function Mn(){const[t,n]=d.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return d.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),a=r=>n(r.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",a):s.addListener&&s.addListener(a),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",a):s.removeListener&&s.removeListener(a)}},[]),t}function Ln(){const[t,n]=d.useState(null),s=d.useRef(Math.floor(Math.random()*ne.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches)return null;const a=Mn(),r=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),l=!a&&!r,i=d.useRef(null),o=d.useRef(null);d.useEffect(()=>{const w=i.current;if(!w)return;let k=0,f=performance.now(),m=Math.random()*(window.innerWidth-64)+16,b=Math.random()*(window.innerHeight-120)+60,c=(Math.random()*60+30)*(Math.random()>.5?1:-1),h=(Math.random()*40+20)*(Math.random()>.5?1:-1);const E=y=>{const z=Math.min(.05,(y-f)/1e3);if(f=y,l){m+=c*z,b+=h*z;const j=16,P=window.innerWidth,N=window.innerHeight,R=48,B=48;m<j&&(m=j,c=Math.abs(c)),m>P-R-j&&(m=P-R-j,c=-Math.abs(c)),b<60&&(b=60,h=Math.abs(h)),b>N-B-j&&(b=N-B-j,h=-Math.abs(h)),c+=(Math.random()-.5)*4,h+=(Math.random()-.5)*4}w.style.transform=`translate3d(${Math.round(m)}px, ${Math.round(b)}px, 0)`,k=requestAnimationFrame(E)};k=requestAnimationFrame(E);const g=()=>{f=performance.now()};return window.addEventListener("resize",g),()=>{cancelAnimationFrame(k),window.removeEventListener("resize",g)}},[l]);function u(w){const k=w??ne[s.current++%ne.length];n(k),window.clearTimeout(u._t),u._t=window.setTimeout(()=>n(null),3e3)}function x(w){u()}function v(){o.current&&window.clearTimeout(o.current),o.current=window.setTimeout(()=>u("Просто нажми, чтобы я говорил!"),600)}function p(){o.current&&(window.clearTimeout(o.current),o.current=null)}return e.jsx("div",{ref:i,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:x,onPointerDown:v,onPointerUp:p,onPointerLeave:p,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:"#bcd3ff",stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:"#6a79ff",stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}const Pn=d.lazy(()=>L(()=>import("./GovCheatsheetSky-BwuWWL3r.js"),__vite__mapDeps([0,1,2,3,4]))),Rn=d.lazy(()=>L(()=>import("./WhatsNew-DAK9y172.js"),__vite__mapDeps([5,1,2]))),An=d.lazy(()=>L(()=>import("./DiffPage-C1WjqM4K.js"),__vite__mapDeps([6,1,2]))),Cn=d.lazy(()=>L(()=>import("./LiquidGlassShowcase-NyCVt1dh.js"),__vite__mapDeps([7,1,2]))),$n=d.lazy(()=>L(()=>import("./PrintSheet-BDQlWPhD.js"),__vite__mapDeps([8,1,2]))),Tn=d.lazy(()=>L(()=>import("./RolePage-C08uCMxD.js"),__vite__mapDeps([9,1,3,2,10]))),Dn=d.lazy(()=>L(()=>import("./LawPage-DCGPGxXA.js"),__vite__mapDeps([11,1,10,2]))),Bn=d.lazy(()=>L(()=>import("./VuPage-0y-dYuiC.js"),__vite__mapDeps([12,1,2]))),Fn=d.lazy(()=>L(()=>import("./BuddyPlayground-BA4Sehas.js"),__vite__mapDeps([13,1,2]))),On=d.lazy(()=>L(()=>import("./HomePage-B4oAVIso.js"),__vite__mapDeps([14,1,2]))),qn=d.lazy(()=>L(()=>import("./SettingsPage-D7efyZrR.js"),__vite__mapDeps([15,1,4,2]))),Kn=d.lazy(()=>L(()=>import("./FavoritesPage-BeF2wsTn.js"),__vite__mapDeps([16,1,10,2])));function Vn(){const t=Y();return we.useEffect(()=>{vn("page_view");try{wn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function Wn(){return(Y().pathname||"").startsWith("/buddy")?null:e.jsx(Ln,{})}function Gn(){const[t]=X();return e.jsxs("div",{className:"min-h-dvh w-full",children:[(t==="liquid"||t==="beta")&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:t==="beta"?"radial-gradient(900px 600px at 10% -5%, rgba(0,255,240,.16), transparent 60%),radial-gradient(1100px 780px at 92% 8%, rgba(168,85,247,.18), transparent 65%),linear-gradient(180deg, rgba(255,255,255,.03), rgba(0,0,0,.45))":"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:t==="beta"?.02:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(ct,{basename:"/betatestik/",children:[e.jsx(xn,{}),e.jsx(jn,{}),e.jsx(En,{}),e.jsx(In,{}),e.jsx(Wn,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(_n,{})}),e.jsx(Vn,{}),e.jsx(d.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Загрузка…"}),children:e.jsxs(dt,{children:[e.jsx(I,{path:"/",element:e.jsx(Pn,{})}),e.jsx(I,{path:"/home",element:e.jsx(On,{})}),e.jsx(I,{path:"/whats-new",element:e.jsx(Rn,{})}),e.jsx(I,{path:"/diff/:id",element:e.jsx(An,{})}),e.jsx(I,{path:"/print",element:e.jsx($n,{})}),e.jsx(I,{path:"/roles/:id",element:e.jsx(Tn,{})}),e.jsx(I,{path:"/laws/:slug",element:e.jsx(Dn,{})}),e.jsx(I,{path:"/vu/:id",element:e.jsx(Bn,{})}),e.jsx(I,{path:"/recorders/:id",element:e.jsx($t,{})}),e.jsx(I,{path:"/about",element:e.jsx(Dt,{})}),e.jsx(I,{path:"/style/liquid",element:e.jsx(Cn,{})}),e.jsx(I,{path:"/buddy",element:e.jsx(Fn,{})}),e.jsx(I,{path:"/settings",element:e.jsx(qn,{})}),e.jsx(I,{path:"/favorites",element:e.jsx(Kn,{})})]})})]})]})}(function(){try{const n="app:version",s=localStorage.getItem(n),a="1758310606466";if(s&&s!==a){"caches"in window?caches.keys().then(r=>Promise.all(r.map(l=>caches.delete(l)))).finally(()=>{localStorage.setItem(n,a),location.reload()}):(localStorage.setItem(n,a),location.reload());return}localStorage.setItem(n,a)}catch{}})();hn();sn();function rt(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}rt();window.addEventListener("resize",rt,{passive:!0});se.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(Gn,{})}));export{Ue as A,Kt as B,Tt as C,Ht as D,Qt as E,Ye as F,Wt as G,Zt as H,V as L,Bt as a,Nn as b,cn as c,Qn as d,Qe as e,Vt as f,Sn as g,Gt as h,Xn as i,e as j,Xt as k,pe as l,Jt as m,en as n,rn as o,mn as p,ce as q,At as r,Ze as s,Je as t,X as u,Ot as v,an as w,pn as x,et as y,Hn as z};
