const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-V8f61geN.js","assets/react-vendor-Bk42iPUi.js","assets/icons-C6Och3e7.js","assets/VoteWidget-Lt13C65R.js","assets/asset-ClJDRudC.js","assets/WhatsNew-CmviengH.js","assets/DiffPage-cEb4gq1D.js","assets/LiquidGlassShowcase-RIPXf7C9.js","assets/PrintSheet-BzPA3sr8.js","assets/RolePage-CEtF4n8H.js","assets/FavStar-rsv2t63b.js","assets/LawPage-BzJqTzbp.js","assets/VuPage-BlLYhSZS.js","assets/BuddyPlayground-BROqjSRy.js","assets/ForumPage-DeVoCUTY.js","assets/SettingsPage-C5VMEtyz.js","assets/FavoritesPage-B30McqBZ.js"])))=>i.map(i=>d[i]);
import{r as Se,a as ut,u as mt,L as M,R as d,b as V,B as pt,c as ht,d as _,N as gt}from"./react-vendor-Bk42iPUi.js";import{A as xt,E as ft,I as Ee,C as bt,Q as yt,R as vt,B as Y,S as re,H as wt,U as ie,a as oe,X as ze,b as le,c as ce,G as jt,d as kt,F as Nt,L as St,e as Et,M as _e,f as zt,g as _t,h as It,i as Mt,j as Lt}from"./icons-C6Och3e7.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const u of o.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&a(u)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();var Ie={exports:{}},H={};/**
 * @license React
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],Le="ui:density",Re="ui:font",Yt="ui:features",Pe="ui:shadow",Ae="ui:radius",Ce="ui:glass",$e="ui:readw",Te="ui:anim";function Ht(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),localStorage.setItem(Le,t)}function Xt(){return localStorage.getItem(Le)==="compact"?"compact":"standard"}function Jt(t){const n=Math.max(.9,Math.min(1.3,t)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),localStorage.setItem(Re,String(n))}function Qt(){const t=parseFloat(localStorage.getItem(Re)||"1");return isFinite(t)&&t>.6&&t<2?t:1}function Zt(t,n=!0){const s=en();return t in s?!!s[t]:n}function en(){try{const t=localStorage.getItem(Yt);return t?JSON.parse(t):{}}catch{return{}}}function tn(t){let n="none";t==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),localStorage.setItem(Pe,t)}function nn(){const t=localStorage.getItem(Pe);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function sn(t){let n=8,s=16,a=20;t==="subtle"&&(n=6,s=10,a=14),t==="rounded"&&(n=12,s=18,a=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",a+"px"),localStorage.setItem(Ae,t)}function an(){const t=localStorage.getItem(Ae);return t==="subtle"||t==="rounded"?t:"standard"}function rn(t){const n=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",n+"px"),localStorage.setItem(Ce,String(n))}function on(){const t=parseInt(localStorage.getItem(Ce)||"6",10);return isFinite(t)?t:6}function ln(t){const n=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",n+"ch"),localStorage.setItem($e,String(n))}function cn(){const t=parseInt(localStorage.getItem($e)||"78",10);return isFinite(t)?t:78}function dn(){try{Ht(Xt()),Jt(Qt()),tn(nn()),sn(an()),rn(on()),ln(cn()),un(mn())}catch{}}function un(t){document.documentElement.classList.toggle("anim-off",!t);try{localStorage.setItem(Te,t?"1":"0")}catch{}}function mn(){try{return localStorage.getItem(Te)!=="0"}catch{return!0}}const Fe={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},I={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function De(...t){return t.filter(Boolean).join(" ")}function Be(){const[t,n]=d.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return d.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),a=r=>n(r.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",a),()=>s.removeEventListener("change",a)):typeof s.addListener=="function"?(s.addListener(a),()=>s.removeListener(a)):()=>{}},[]),t}function Oe(t,n){d.useEffect(()=>{const s=t.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let a=0,r=72,o=18;const u=()=>{a=0;const p=t.current;p&&(p.style.setProperty("--lg-x",`${r}%`),p.style.setProperty("--lg-y",`${o}%`))},c=p=>{const b=t.current;if(!b)return;const h=b.getBoundingClientRect(),w=(p.clientX-h.left)/h.width*100,k=(p.clientY-h.top)/h.height*100;r=Math.max(0,Math.min(100,w)),o=Math.max(0,Math.min(100,k)),a||(a=window.requestAnimationFrame(u))},i=()=>{r=72,o=18,a||(a=window.requestAnimationFrame(u))};return s.addEventListener("pointermove",c,{passive:!0}),s.addEventListener("pointerdown",c,{passive:!0}),s.addEventListener("pointerenter",c,{passive:!0}),s.addEventListener("pointerleave",i),()=>{a&&window.cancelAnimationFrame(a),s.removeEventListener("pointermove",c),s.removeEventListener("pointerdown",c),s.removeEventListener("pointerenter",c),s.removeEventListener("pointerleave",i)}},[t,n])}function ge(t){if(!t)return[255,255,255];const n=t.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function U(t){return`${t[0]} ${t[1]} ${t[2]}`}function Q(t,n,s){return Math.round(t+(n-t)*s)}function xe(t,n){return[Q(t[0],n>=0?255:0,Math.abs(n)),Q(t[1],n>=0?255:0,Math.abs(n)),Q(t[2],n>=0?255:0,Math.abs(n))]}function pn(t,n,s){const a=t?Fe[t]:n??I.tint,r=s??I.accent,o=ge(a),u=ge(r),c=xe(u,.25),i=xe(u,-.55);return{tintRgb:U(o),accentRgb:U(u),accentSoftRgb:U(c),accentDeepRgb:U(i)}}function qe(t,n){const s={...t??{}},{tintRgb:a,accentRgb:r,accentSoftRgb:o,accentDeepRgb:u}=pn(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=a,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=r,s["--lg-accent-soft"]=o,s["--lg-accent-deep"]=u,s}const Ke=d.forwardRef((t,n)=>{const{blur:s=I.blur,tint:a=I.tint,opacity:r=I.opacity,gloss:o=I.gloss,border:u=I.border,glints:c=I.glints,interactive:i=I.interactive,animate:p=I.animate,elevation:b=I.elevation,tone:h,accent:w=I.accent,className:k,style:f,children:m,...y}=t,l=Be(),g=i&&!l,E=d.useRef(null),x=d.useCallback(j=>{E.current=j,typeof n=="function"?n(j):n&&(n.current=j),j&&(j.style.setProperty("--lg-x","72%"),j.style.setProperty("--lg-y","18%"))},[n]);Oe(E,g);const v=d.useMemo(()=>qe(f,{blur:s,tint:a,opacity:r,gloss:o,border:u,elevation:b,glints:c,tone:h,accent:w}),[f,s,a,r,o,u,b,c,h,w]),z={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*b}px ${50*b}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return e.jsxs("div",{ref:x,className:De("liquid-glass",k),"data-animate":p?"true":"false","data-interactive":g?"true":"false",style:{...z,...v},...y,children:[e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),c&&e.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),e.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),g&&e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),e.jsx("div",{style:{position:"relative",zIndex:10},children:m}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:u,pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Ke.displayName="LiquidGlass";const Ve=d.forwardRef((t,n)=>{const{className:s,style:a,children:r,type:o,blur:u,tint:c,opacity:i,gloss:p,border:b,glints:h,interactive:w,animate:k,elevation:f,tone:m,accent:y=I.accent,...l}=t,g=u??I.blur,E=m?Fe[m]:c??I.tint,x=i??.16,v=p??.9,z=b??.6,j=h??!1,R=w??!0,N=f??1,P=Be(),D=R&&!P,A=d.useRef(null),G=d.useCallback(S=>{A.current=S,typeof n=="function"?n(S):n&&(n.current=S),S&&(S.style.setProperty("--lg-x","70%"),S.style.setProperty("--lg-y","16%"))},[n]);Oe(A,D);const $=d.useMemo(()=>qe(a,{blur:g,tint:E,opacity:x,gloss:v,border:z,glints:j,elevation:N,tone:m,accent:y}),[a,g,E,x,v,z,j,N,m,y]),F={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*N}px ${18*N}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return e.jsxs("button",{ref:G,type:o??"button",className:De("liquid-glass liquid-glass__button",s),style:{...F,...$},...l,onMouseDown:S=>{S.currentTarget.style.transform="scale(0.985)"},onMouseUp:S=>{S.currentTarget.style.transform=""},onMouseLeave:S=>{S.currentTarget.style.transform=""},children:[e.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[e.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),e.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),e.jsx("span",{style:{position:"relative",zIndex:1},children:r}),e.jsx("style",{children:`
      ...
      `})]})});Ve.displayName="LiquidGlass.Button";const W=Ke;W.Button=Ve;const We="theme",Ge="accent",Ue="accent_custom",Ye="bg",hn="bg_custom",He="ui:style-mode",Z="ui:liquid:prev-theme",Xe="ui:liquid:tone",Je={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var ke,Ne;const ee=((Ne=(ke=import.meta)==null?void 0:ke.env)==null?void 0:Ne.BASE_URL)??"/",q=t=>{const n=t.replace(/^\/+/,"");return(ee.endsWith("/")?ee:ee+"/")+n},Qe={bg1:q("img/bg1.png"),bg2:q("img/bg2.png"),bg3:q("img/bg3.png"),bg4:q("img/bg4.png"),bg5:q("img/bg5.png")};function Ze(){const t=localStorage.getItem(We);return t==="light"||t==="dark"?t:null}function gn(){const t=localStorage.getItem(Ge);return t?t==="custom"?"custom":t in Je?t:null:null}function xn(){return localStorage.getItem(Ue)}function et(){const t=localStorage.getItem(Ye);return t&&(t==="none"||t==="custom"||t in Qe)?t:null}function fn(){return localStorage.getItem(hn)}function tt(){const t=localStorage.getItem(He);return t==="classic"||t==="liquid"||t==="beta"?t:null}function bn(){return(localStorage.getItem(Xe)||"dark")==="light"?"light":"dark"}function yn(t){try{localStorage.setItem(Xe,t)}catch{}const n=document.documentElement;if(n.classList.toggle("liquid-light",t==="light"),n.classList.toggle("liquid-dark",t!=="light"),n.classList.contains("theme-liquid"))try{de(t==="light"?"light":"dark")}catch{}}function nt(t){const n=document.documentElement;if(n.classList.toggle("theme-liquid",t==="liquid"),n.classList.toggle("theme-beta",t==="beta"),n.dataset.styleMode=t,t==="liquid"||t==="beta"){try{const s=Ze()??(st()?"dark":"light");localStorage.setItem(Z,s);const a=bn();yn(a)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=localStorage.getItem(Z);(s==="light"||s==="dark")&&de(s),localStorage.removeItem(Z)}catch{}try{const s=et()??"none";rt(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}try{localStorage.setItem(He,t)}catch{}}function st(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function de(t){const n=document.documentElement;t==="dark"?n.classList.add("dark"):n.classList.remove("dark"),localStorage.setItem(We,t);const s=t==="dark"?"#0a0a0a":"#fafafa";let a=document.querySelector('meta[name="theme-color"]');a||(a=document.createElement("meta"),a.name="theme-color",document.head.appendChild(a)),a.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function at(t){if(t==="custom"){const n=xn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=wn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=Je[t];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}localStorage.setItem(Ge,t)}function ns(t){localStorage.setItem(Ue,it(t)),at("custom")}function rt(t){const n=document.body,a=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(t==="custom"){const r=fn();r?(n.style.backgroundImage=`url(${r})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=a,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const r=Qe[t];n.style.backgroundImage=`url(${r})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=a,n.style.backgroundPosition="center"}localStorage.setItem(Ye,t)}function vn(){const n=Ze()??(st()?"dark":"light");de(n);const s=gn()??"indigo";at(s);const a=et()??"none";rt(a);const r=tt()??"classic";nt(r)}function it(t){let n=t.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],a=n[2],r=n[3];n=`#${s}${s}${a}${a}${r}${r}`}return n}function wn(t,n){const s=it(t).slice(1),a=parseInt(s,16);let r=a>>16&255,o=a>>8&255,u=a&255;r=Math.max(0,Math.min(255,Math.round(r+255*n))),o=Math.max(0,Math.min(255,Math.round(o+255*n))),u=Math.max(0,Math.min(255,Math.round(u+255*n)));const c=i=>i.toString(16).padStart(2,"0");return`#${c(r)}${c(o)}${c(u)}`}function fe(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid"||t==="beta")return t}try{return tt()??"classic"}catch{return"classic"}}function X(){const[t,n]=d.useState(()=>fe());d.useEffect(()=>{const a=()=>{const u=fe();n(c=>c===u?c:u)},r=u=>{const c=u.detail;c==="classic"||c==="liquid"||c==="beta"?n(c):a()};window.addEventListener("stylemodechange",r);const o=new MutationObserver(a);return o.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",r),o.disconnect()}},[]);const s=d.useCallback(a=>{nt(a),n(a)},[]);return[t,s]}function T(t){return`${"/betatestik/".replace(/\/$/,"")}${t}`}function jn(){if(!Zt("cmd_palette",!0))return null;const[n]=X(),[s,a]=d.useState(!1),[r,o]=d.useState(""),[u,c]=d.useState(0),[i,p]=d.useState(()=>localStorage.getItem("cp_filter")||"all");d.useEffect(()=>{try{localStorage.setItem("cp_filter",i)}catch{}},[i]),d.useEffect(()=>{function l(g){(g.ctrlKey||g.metaKey)&&g.key.toLowerCase()==="k"&&(g.preventDefault(),a(!0),o(""),c(0)),s&&g.key==="Escape"&&a(!1)}return window.addEventListener("keydown",l),window.openCommandPalette=()=>{a(!0),o(""),c(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",l)}},[s]);const h=d.useMemo(()=>{const l=[];l.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Страница",url:T("/favorites")}),l.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Страница",url:T("/settings")});for(const x of Wt)l.push({kind:"role",id:x.id,title:x.role,subtitle:"Раздел",url:T(`/roles/${x.id}`)});for(const x of he)l.push({kind:"law",id:x.slug,title:x.title,subtitle:"Закон",url:T(`/laws/${x.slug}`)});for(const x of Ut)l.push({kind:"vu",id:x.id,title:x.title,subtitle:"ВУ",url:T(`/vu/${x.id}`)});const g=r.trim().toLowerCase();return g&&l.push(...k(g).slice(0,60)),g?(i==="all"?l:l.filter(x=>x.kind===i)).map(x=>({r:x,score:w(`${x.title} ${x.subtitle||""}`.toLowerCase(),g)+(x.__boost||0)})).filter(x=>x.score>0).sort((x,v)=>v.score-x.score).slice(0,30).map(x=>x.r):l.slice(0,20)},[r,i]);function w(l,g){return g.split(/\s+/).filter(Boolean).reduce((x,v)=>x+(l.includes(v)?1:0),0)}function k(l){const g=[],E=v=>v.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const v of he){const j=(v.content||"").replace(/\r\n?/g,`
`).split(`
`);let R="",N="";const P=new Set;for(const D of j){const A=D.trim(),G=/^(#{2,6})\s*(.+)$/.exec(A);if(G){R=G[2].trim(),N=E(R)||"";const $=R.toLowerCase();if(N&&$.includes(l)){const F=`${v.slug}#${N}`;if(!P.has(F)){const S={kind:"law",id:F,title:`${v.title} — ${R}`,subtitle:"Заголовок",url:T(`/laws/${v.slug}?q=${encodeURIComponent(l)}#${N}`)};S.__boost=$.startsWith(l)?8:6,g.push(S),P.add(F)}}continue}if(A&&A.toLowerCase().includes(l)){const $=N?`${v.slug}#${N}`:v.slug;if(!P.has($)){const F=A.length>140?A.slice(0,137)+"…":A,S=N?`${v.title} — ${R}`:v.title,dt=T(N?`/laws/${v.slug}?q=${encodeURIComponent(l)}#${N}`:`/laws/${v.slug}?q=${encodeURIComponent(l)}`),ue={kind:"law",id:$,title:S,subtitle:F||"Контекст",url:dt};ue.__boost=5,g.push(ue),P.add($)}}}}const x=new Set;return g.filter(v=>x.has(v.id)?!1:(x.add(v.id),!0))}function f(l){a(!1);try{window.location.href=l}catch{location.assign(l)}}function m(l){h.length&&(l.key==="ArrowDown"&&(l.preventDefault(),c(g=>Math.min(g+1,h.length-1))),l.key==="ArrowUp"&&(l.preventDefault(),c(g=>Math.max(g-1,0))),l.key==="Enter"&&(l.preventDefault(),f(h[u].url)))}const y=({children:l})=>n==="liquid"?e.jsx(W,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:l}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:l});return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Поиск",children:e.jsxs(y,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(oe,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:r,onChange:l=>{o(l.target.value),c(0)},onKeyDown:m,placeholder:"Поиск: закон, роль, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>a(!1),"aria-label":"Закрыть",children:e.jsx(ze,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(l=>e.jsx("button",{onClick:()=>{p(l.k),c(0)},className:`chip ${i===l.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:l.label},l.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!h.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),h.map((l,g)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${g===u?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>c(g),onClick:()=>f(l.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[l.kind==="law"&&e.jsx(Y,{className:"h-4 w-4"}),l.kind==="role"&&e.jsx(ie,{className:"h-4 w-4"}),l.kind==="vu"&&e.jsx(re,{className:"h-4 w-4"}),l.kind==="page"&&(l.id==="settings"?e.jsx(le,{className:"h-4 w-4"}):e.jsx(ce,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:l.title})]}),l.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:l.subtitle})]},`${l.kind}:${l.id}`))]})]})}):null})}const O={},kn=(O==null?void 0:O.VITE_API_BASE)||(O==null?void 0:O.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function Nn(){try{const t="anon_uid";let n=localStorage.getItem(t);return n||(n=crypto.randomUUID(),localStorage.setItem(t,n)),n}catch{return"na"}}function Sn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:Nn()}}function En(t,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const r=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(r)==="1"||String(r)==="yes")return}catch{}const s=JSON.stringify({event:t,...Sn(),data:n}),a=`${kn}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const r=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(a,r))return}catch{}try{fetch(a,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const be="recent:items";function zn(t,n){try{const s=localStorage.getItem(be),a=s?JSON.parse(s):[],r={url:t,title:n,ts:Date.now()};if(a.length&&a[0].url===t)return;const o=a.filter(i=>i.url!==t);o.unshift(r);const u=[],c=new Set;for(const i of o)c.has(i.url)||(c.add(i.url),u.push(i));for(;u.length>15;)u.pop();localStorage.setItem(be,JSON.stringify(u))}catch{}}const ot=[{key:"forum",type:"route",label:"Форум",icon:e.jsx(kt,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(ie,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(Nt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(St,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx(Et,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(_e,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(zt,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(Y,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(re,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(Y,{className:"h-4 w-4"}),id:"laws"}];function _n(){const[t,n]=d.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=V(),[a]=X(),r=d.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),o=d.useMemo(()=>{const y=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),l=(s.hash||"").replace(/^#/,"").toLowerCase();return y||l||""},[s.search,s.hash]),u=d.useCallback(m=>o===m,[o]);d.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const y=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=y}}},[t]),d.useEffect(()=>{function m(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[]),d.useEffect(()=>{const m=document.documentElement;t?m.classList.add("has-sidebar"):m.classList.remove("has-sidebar")},[t]);const c=d.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),i=c?"⌘ K":"Ctrl K",p=a==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",b=a==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",h=a==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",w=a==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",k=m=>{const y=`?tab=${encodeURIComponent(m)}`;return r?{pathname:"/",search:y}:{pathname:"/",search:y,hash:`#${m}`}},f=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(M,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[ot.map(m=>{const y=m.type==="route"?s.pathname===m.to:u(m.id),l=m.type==="route"?m.to:k(m.id);return e.jsx("li",{children:e.jsxs(M,{to:l,className:[p,y?b:""].filter(Boolean).join(" "),"aria-current":y?"page":void 0,"aria-label":m.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[m.icon,e.jsx("span",{className:"truncate",children:m.label})]})},m.key)}),e.jsx("li",{children:e.jsxs(M,{to:"/about",className:p,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(Ee,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(M,{to:"/buddy",className:p,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(jt,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:h,children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:i}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(m=>!m),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:w,children:a==="liquid"?e.jsx(W,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:f}):f})]})}const In={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},lt={entities:In};function Mn(t){var s;return((s=lt.entities)==null?void 0:s[t])||null}function ss(t,n=30){const s=Mn(t);if(!(s!=null&&s.updated_at))return{recent:!1};const a=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-a.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function as(t,n){const s=t.split(/\r?\n/),a=n.split(/\r?\n/),r=s.length,o=a.length,u=Array.from({length:r+1},()=>Array(o+1).fill(0));for(let b=r-1;b>=0;b--)for(let h=o-1;h>=0;h--)u[b][h]=s[b]===a[h]?u[b+1][h+1]+1:Math.max(u[b+1][h],u[b][h+1]);const c=[];let i=0,p=0;for(;i<r&&p<o;)s[i]===a[p]?(c.push(K(s[i])),i++,p++):u[i+1][p]>=u[i][p+1]?(c.push(`<del>${K(s[i])}</del>`),i++):(c.push(`<ins>${K(a[p])}</ins>`),p++);for(;i<r;)c.push(`<del>${K(s[i++])}</del>`);for(;p<o;)c.push(`<ins>${K(a[p++])}</ins>`);return c.join(`
`)}function K(t){return t.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function Ln(){var s;const t=[],n=lt.entities||{};for(const[a,r]of Object.entries(n)){const o=(s=r.changelog)==null?void 0:s[0];o&&t.push({id:a,version:o.version,date:o.date,summary:o.summary,details:o.details})}return t.sort((a,r)=>a.date<r.date?1:-1),t}function Rn(){const n=V().pathname.startsWith("/forum"),[s]=X(),a=d.useMemo(()=>{try{const i=Ln()[0];if(!i)return!1;const p=new Date(i.date+"T00:00:00Z");return(Date.now()-p.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const i=window.openCommandPalette;if(typeof i=="function")try{i();return}catch{}const p=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!p,metaKey:p}))}const o="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",u=s==="liquid"||s==="beta"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",c=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var i;return(i=window.openMobileMenu)==null?void 0:i.call(window)},"aria-label":"Меню",children:e.jsx(_t,{className:"h-4 w-4"})}),e.jsx(It,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[e.jsx(oe,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(M,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),a&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(M,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(ce,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(M,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(le,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(_e,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]});return n?null:e.jsx("div",{className:u,children:s==="liquid"?e.jsx(W,{className:`${o} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:c}):e.jsx("div",{className:o,children:c})})}const Pn="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",te="notif:lastSeen",ye="notifications-panel";function An(){const[t,n]=d.useState(!1),[s,a]=d.useState([]),[r,o]=d.useState(0),[u,c]=d.useState(!1),[i,p]=d.useState(null),b=d.useRef(null),h=d.useCallback(async()=>{const f=new AbortController;c(!0),p(null);try{const m=await fetch(Pn,{cache:"no-store",signal:f.signal});if(!m.ok)throw new Error(`HTTP ${m.status}`);const y=await m.json(),l=Array.isArray(y)?y:y.items||[],g=z=>z?new Date(z).getTime():0;l.sort((z,j)=>g(j.date)-g(z.date)),a(l);const E=typeof localStorage<"u"&&localStorage.getItem(te)||"",x=E?l.findIndex(z=>z.id===E):-1,v=x===-1?l.length:x;o(Math.max(0,v))}catch(m){(m==null?void 0:m.name)!=="AbortError"&&p("Не удалось загрузить уведомления")}finally{c(!1)}return()=>f.abort()},[]);d.useEffect(()=>{h()},[h]),d.useEffect(()=>{if(t&&s.length)try{localStorage.setItem(te,s[0].id),o(0)}catch{}},[t,s]),d.useEffect(()=>{if(!t)return;const f=y=>{b.current&&(b.current.contains(y.target)||n(!1))},m=y=>{y.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",f),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",f),document.removeEventListener("keydown",m)}},[t]);const w=()=>n(f=>!f),k=f=>f?new Date(f).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:b,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:w,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":ye,children:[e.jsx(Mt,{className:"h-4 w-4"}),r>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:r})]}),t&&e.jsxs(W,{id:ye,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),u?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):i?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:i}):s.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(f=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:f.url||"#",target:f.url?"_blank":void 0,rel:f.url?"noreferrer":void 0,onClick:()=>{var m;try{(m=s[0])!=null&&m.id&&localStorage.setItem(te,s[0].id),o(0)}catch{}},children:[f.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:f.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:f.text}),f.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:k(f.date)})]})},f.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}const ve="forum:auth:session",ae="forum:session-change";function we(t){if(!t)return null;try{const n=JSON.parse(t);if(!n||typeof n!="object")return null;const s=typeof n.userId=="string"?n.userId:"";if(!s)return null;const a=!!n.remember,r=typeof n.lastLogin=="string"&&n.lastLogin?n.lastLogin:new Date().toISOString();return{userId:s,remember:a,lastLogin:r}}catch{return null}}function je(){if(typeof window>"u")return null;const t=window.localStorage.getItem(ve),n=window.sessionStorage.getItem(ve);return we(t)??we(n)}function rs(t){if(!(typeof window>"u"))try{window.dispatchEvent(new CustomEvent(ae,{detail:{session:t}}))}catch{}}function Cn(){const[t,n]=d.useState(()=>{try{return je()}catch{return null}});return d.useEffect(()=>{const s=()=>{try{n(je())}catch{n(null)}};return window.addEventListener("storage",s),window.addEventListener(ae,s),()=>{window.removeEventListener("storage",s),window.removeEventListener(ae,s)}},[]),t}function $n(){const[t,n]=d.useState(!1),s=V(),r=!Cn();d.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),d.useEffect(()=>{if(!t)return;const i=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=i}},[t]);const o=d.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),u=i=>{const p=new URLSearchParams(s.search||"");p.set("tab",i);const b=`?${p.toString()}`;return o?{pathname:"/",search:b}:{pathname:"/",search:b,hash:`#${i}`}};function c(){const i=window.openCommandPalette;if(typeof i=="function")try{i()}catch{}n(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:c,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(oe,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(ze,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:ot.map(i=>{const p=i.type==="route"?i.to:u(i.id);return e.jsx("li",{children:e.jsxs(M,{to:p,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[i.icon,e.jsx("span",{className:"truncate",children:i.label}),i.key==="forum"&&r&&e.jsx(Lt,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},i.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(M,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(ce,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(M,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(le,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const ne=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!"];function Tn(){const[t,n]=d.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return d.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),a=r=>n(r.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",a):s.addListener&&s.addListener(a),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",a):s.removeListener&&s.removeListener(a)}},[]),t}function Fn(){const[t,n]=d.useState(null),s=d.useRef(Math.floor(Math.random()*ne.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches)return null;const a=Tn(),r=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),o=!a&&!r,u=d.useRef(null),c=d.useRef(null);d.useEffect(()=>{const w=u.current;if(!w)return;let k=0,f=performance.now(),m=Math.random()*(window.innerWidth-64)+16,y=Math.random()*(window.innerHeight-120)+60,l=(Math.random()*60+30)*(Math.random()>.5?1:-1),g=(Math.random()*40+20)*(Math.random()>.5?1:-1);const E=v=>{const z=Math.min(.05,(v-f)/1e3);if(f=v,o){m+=l*z,y+=g*z;const j=16,R=window.innerWidth,N=window.innerHeight,P=48,D=48;m<j&&(m=j,l=Math.abs(l)),m>R-P-j&&(m=R-P-j,l=-Math.abs(l)),y<60&&(y=60,g=Math.abs(g)),y>N-D-j&&(y=N-D-j,g=-Math.abs(g)),l+=(Math.random()-.5)*4,g+=(Math.random()-.5)*4}w.style.transform=`translate3d(${Math.round(m)}px, ${Math.round(y)}px, 0)`,k=requestAnimationFrame(E)};k=requestAnimationFrame(E);const x=()=>{f=performance.now()};return window.addEventListener("resize",x),()=>{cancelAnimationFrame(k),window.removeEventListener("resize",x)}},[o]);function i(w){const k=w??ne[s.current++%ne.length];n(k),window.clearTimeout(i._t),i._t=window.setTimeout(()=>n(null),3e3)}function p(w){i()}function b(){c.current&&window.clearTimeout(c.current),c.current=window.setTimeout(()=>i("Просто нажми, чтобы я говорил!"),600)}function h(){c.current&&(window.clearTimeout(c.current),c.current=null)}return e.jsx("div",{ref:u,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:p,onPointerDown:b,onPointerUp:h,onPointerLeave:h,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:"#bcd3ff",stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:"#6a79ff",stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}const Dn=d.lazy(()=>L(()=>import("./GovCheatsheetSky-V8f61geN.js"),__vite__mapDeps([0,1,2,3,4]))),Bn=d.lazy(()=>L(()=>import("./WhatsNew-CmviengH.js"),__vite__mapDeps([5,1,2]))),On=d.lazy(()=>L(()=>import("./DiffPage-cEb4gq1D.js"),__vite__mapDeps([6,1,2]))),qn=d.lazy(()=>L(()=>import("./LiquidGlassShowcase-RIPXf7C9.js"),__vite__mapDeps([7,1,2]))),Kn=d.lazy(()=>L(()=>import("./PrintSheet-BzPA3sr8.js"),__vite__mapDeps([8,1,2]))),Vn=d.lazy(()=>L(()=>import("./RolePage-CEtF4n8H.js"),__vite__mapDeps([9,1,3,2,10]))),Wn=d.lazy(()=>L(()=>import("./LawPage-BzJqTzbp.js"),__vite__mapDeps([11,1,10,2]))),Gn=d.lazy(()=>L(()=>import("./VuPage-BlLYhSZS.js"),__vite__mapDeps([12,1,2]))),Un=d.lazy(()=>L(()=>import("./BuddyPlayground-BROqjSRy.js"),__vite__mapDeps([13,1,2]))),Yn=d.lazy(()=>L(()=>import("./ForumPage-DeVoCUTY.js"),__vite__mapDeps([14,1,2]))),Hn=d.lazy(()=>L(()=>import("./SettingsPage-C5VMEtyz.js"),__vite__mapDeps([15,1,4,2]))),Xn=d.lazy(()=>L(()=>import("./FavoritesPage-B30McqBZ.js"),__vite__mapDeps([16,1,10,2])));function Jn(){const t=V();return Se.useEffect(()=>{En("page_view");try{zn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function Qn(){return(V().pathname||"").startsWith("/buddy")?null:e.jsx(Fn,{})}function Zn(){const[t]=X();return e.jsxs("div",{className:"min-h-dvh w-full",children:[(t==="liquid"||t==="beta")&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:t==="beta"?"radial-gradient(900px 600px at 10% -5%, rgba(0,255,240,.16), transparent 60%),radial-gradient(1100px 780px at 92% 8%, rgba(168,85,247,.18), transparent 65%),linear-gradient(180deg, rgba(255,255,255,.03), rgba(0,0,0,.45))":"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:t==="beta"?.02:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(pt,{basename:"/betatestik/",children:[e.jsx(jn,{}),e.jsx(_n,{}),e.jsx(Rn,{}),e.jsx($n,{}),e.jsx(Qn,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(An,{})}),e.jsx(Jn,{}),e.jsx(d.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Загрузка…"}),children:e.jsxs(ht,{children:[e.jsx(_,{path:"/",element:e.jsx(Dn,{})}),e.jsx(_,{path:"/forum",element:e.jsx(Yn,{})}),e.jsx(_,{path:"/home",element:e.jsx(gt,{to:"/forum",replace:!0})}),e.jsx(_,{path:"/whats-new",element:e.jsx(Bn,{})}),e.jsx(_,{path:"/diff/:id",element:e.jsx(On,{})}),e.jsx(_,{path:"/print",element:e.jsx(Kn,{})}),e.jsx(_,{path:"/roles/:id",element:e.jsx(Vn,{})}),e.jsx(_,{path:"/laws/:slug",element:e.jsx(Wn,{})}),e.jsx(_,{path:"/vu/:id",element:e.jsx(Gn,{})}),e.jsx(_,{path:"/recorders/:id",element:e.jsx(qt,{})}),e.jsx(_,{path:"/about",element:e.jsx(Vt,{})}),e.jsx(_,{path:"/style/liquid",element:e.jsx(qn,{})}),e.jsx(_,{path:"/buddy",element:e.jsx(Un,{})}),e.jsx(_,{path:"/settings",element:e.jsx(Hn,{})}),e.jsx(_,{path:"/favorites",element:e.jsx(Xn,{})})]})})]})]})}(function(){try{const n="app:version",s=localStorage.getItem(n),a="1758376896462";if(s&&s!==a){"caches"in window?caches.keys().then(r=>Promise.all(r.map(o=>caches.delete(o)))).finally(()=>{localStorage.setItem(n,a),location.reload()}):(localStorage.setItem(n,a),location.reload());return}localStorage.setItem(n,a)}catch{}})();vn();dn();function ct(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}ct();window.addEventListener("resize",ct,{passive:!0});se.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(Zn,{})}));export{Je as A,ns as B,Kt as C,Ht as D,tn as E,ve as F,sn as G,Qe as H,Jt as I,rn as J,W as L,Wt as a,Mn as b,rs as c,as as d,gn as e,tt as f,Ln as g,Xt as h,ss as i,e as j,Qt as k,he as l,nn as m,an as n,on as o,mn as p,bn as q,Bt as r,de as s,st as t,X as u,Ut as v,nt as w,un as x,yn as y,at as z};
