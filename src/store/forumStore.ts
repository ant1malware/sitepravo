...
function seedDemoData() {
  ...
  const sections: Section[] = [
    {
      ...
      description: "Release notes, hotfixes, infrastructure work, and roadmap teasers.",
      icon: "??",
      createdAt,
      order: 1,
    ...
    },
    {
      id: crypto.randomUUID(),
      title: "Design Lab",
      description: "Visual experiments, UI reviews, and branding explorations from the crew.",
      icon: "??",
      createdAt,
      order: 2,
      moderatorIds: [mod.id],
    ...
    },
    {
      ...
      description: "Introductions, collaborations, and day-to-day chatter with the SKY family.",
      icon: "??",
      createdAt,
      order: 3,
    ...
    },
    {
      id: crypto.randomUUID(),
      title: "Workshop",
      description: "Marketplace for merch drops, digital kits, and bespoke commission offers.",
      icon: "???",
      createdAt,
      order: 4,
      moderatorIds: [admin.id],
  ...
  const topics: Topic[] = [
    ...
    },
    {
      ...
      title: "Liquid glass interface lookbook",
      authorId: mod.id,
      createdAt,
      updatedAt: createdAt,
      pinned: false,
    ...
    },
    {
      ...
      title: "Community launch party recap",
      authorId: vip.id,
      createdAt,
      updatedAt: createdAt,
      pinned: true,
    ...
    },
    {
      ...
      title: "Hand-crafted drops and commission board",
      authorId: admin.id,
      createdAt,
      updatedAt: createdAt,
      pinned: true,
  ...
  const posts: Post[] = [
    {
      ...
      topicId: topics[0].id,
      authorId: admin.id,
      content: "Milestones for 0.9 include the permissions overhaul, a refreshed landing page, and the new notification worker.",
      createdAt,
      likes: [mod.id, vip.id],
    },
    {
      ...
      topicId: topics[0].id,
      authorId: mod.id,
      content: "Pinned the roadmap so testers can follow along. Let us know which items you want prioritized first!",
      createdAt,
      likes: [vip.id],
    },
    {
      ...
      topicId: topics[0].id,
      authorId: vip.id,
      content: "Loving the quality-of-life focus. The new invite flow already feels smoother on mobile.",
      createdAt,
      likes: [admin.id],
    },
    {
      ...
      topicId: topics[1].id,
      authorId: mod.id,
      content: "Uploaded a batch of liquid glass mockups with dynamic lighting. Feedback welcome before we freeze colors.",
      createdAt,
      likes: [admin.id],
    },
    {
      ...
      topicId: topics[1].id,
      authorId: admin.id,
      content: "That neon violet variant is perfect for the beta shell. Let's try it inside the command palette too.",
      createdAt,
      likes: [vip.id],
    },
    {
      ...
      topicId: topics[2].id,
      authorId: vip.id,
      content: "Recap thread is live! Share your favourite photos from the launch party and tag who you met.",
      createdAt,
      likes: [admin.id, mod.id],
    },
    {
      id: crypto.randomUUID(),
      topicId: topics[2].id,
    ...
    },
    {
      ...
      topicId: topics[2].id,
      authorId: admin.id,
      content: "Thanks everyone who joined and helped moderate. This energy is why SKY exists.",
      createdAt,
      likes: [vip.id],
    },
    {
      ...
      topicId: topics[3].id,
      authorId: admin.id,
      content: "Opening the Workshop board with curated artisan drops and safe trading guidelines.",
      createdAt,
      likes: [vip.id],
    },
    {
      ...
      topicId: topics[3].id,
      authorId: mod.id,
      content: "First batch features screen-printed posters, keycaps, and a limited synthwave sticker set.",
      createdAt,
      likes: [admin.id],
    },
  ];
