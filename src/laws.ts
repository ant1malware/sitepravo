...
![Территория красной зоны воинской части](${BASE}img/red-zone.png)
Территория КПП-1
![Территория КПП-1](${BASE}img/cpp.png)
Территория КПП-2
![Территория КПП-2](${BASE}img/cpp2.png)
...
![Территория военного грузового поезда](${BASE}img/poezd.jpg)
...
Служебные территории:
Правительство
![Правительство2](${BASE}img/pravo2.png)
![Правительство](${BASE}img/pravo.png)

ЕСС
![ЕСС](${BASE}img/ess.png)
![ЕСС2](${BASE}img/ess2.png)
...
`
    ...
    slug: "vv",
    abbr: "ФЗоВВ",
    title: "Федеральный закон «О вертикали власти»",
    notes: "Иерархическая структура",
    updated: "2025-02-23",
    content: `# Федеральный закон «О вертикали власти»
