...
export default function Sidebar() {
  ...
  return (
    ...
    {/* Mobile overlay removed — mobile uses MobileMenu component */}
      <aside
        id="app-sidebar"
        aria-label="Навигация"
        className={"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 " +
          "bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80"}
